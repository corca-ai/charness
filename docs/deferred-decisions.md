...
- Current choice: Defer until the next dogfood slice picks the carrier; deterministic no-write inventory is now `charness catalog list --repo-root . --json` ([scripts/capability_catalog.py](../scripts/capability_catalog.py)).
