...
- Impact surfaces: [scripts/artifact_validator.py](../scripts/artifact_validator.py), the debug/critique/retro/ideation/handoff/quality validators, [scripts/run-quality.sh](../scripts/run-quality.sh), [scripts/core/scaffold_artifact_lib.py](../scripts/scaffold_artifact_lib.py) and the five sibling scaffolds.
