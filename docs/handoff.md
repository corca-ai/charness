...
- **Next pickup:** activate the [carry-the-unbuilt-slices goal](../charness-artifacts/goals/2026-08-08-carry-the-unbuilt-slices-guards-and-the-six-filed-issues.md). It is SHAPED and `--pursue-ready` passes, so go straight to `/goal @charness-artifacts/goals/2026-08-08-carry-the-unbuilt-slices-guards-and-the-six-filed-issues.md` — no Before phase needed. Read its `## Active Operating Frame` first; it names the exact next action.
