...
- Refresh kept: #491's carrier `05726f15`, remote CI run `31008443698`, CLOSED readback, the eight-issue unresolved set, and #508's locally validated carrier/claims-review/publish-pending state because each changes the next operator's first move; see the [active goal](../charness-artifacts/goals/2026-08-05-close-all-open-issues-generative-sequence.md).
