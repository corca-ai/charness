...
- Continue the active `achieve` goal: map #599's consumer-discovery premise
  after #588's local-proof carrier and #528's separately owned split.
...
Refresh kept: the active-goal ledger and #599 re-read because they determine the next bounded repair and forbid premature publication.
...
1. Re-read [#599](https://github.com/corca-ai/charness/issues/599) and its comments with the [execution ledger](../charness-artifacts/goals/2026-08-12-open-backlog-execution-ledger.md), then map its current reader classes and removal-proposal validator boundary.
2. After #599 is dispositioned, resume the [remaining execution ledger](../charness-artifacts/goals/2026-08-12-open-backlog-execution-ledger.md); #601 remains a consumer-ergonomics premise.
