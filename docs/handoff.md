...
4. 다음 pickup의 first move는 downstream `scenario propose` consumer 중 아직도 full `proposals` 대신 omission/default-cap intuition에 기대는 곳이 남아 있는지 다시 확인하는 것이다. 현재 issue tracker 상 기준점은 `corca-ai/cautilus#15`의 full-truth-surface migration checklist다.
