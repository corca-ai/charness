...
4. 다음 pickup의 first move는 `quality`/`premortem`/`retro`까지 top-five로 올라왔다는 전제에서, 남은 omitted 후보 중 `find-skills-canonical-artifact-followup`를 먼저 올릴지 아니면 `handoff-workflow-trigger-followup`를 앞세울지 고르는 것이다.
