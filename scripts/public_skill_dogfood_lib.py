...
EVIDENCE_OVERRIDES = {
    ...
    "quality": [
        ...
        "runs `plan_quality_run.py`, reads its `required_reads` / compatibility `required_primer_refs` before broad gates, and treats `gate_packets` as report-first evidence with cost/trust/parallel metadata before fixing",
