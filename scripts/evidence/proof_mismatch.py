...
from scripts.adapters.proof_semantics_adapter_lib import (  # noqa: E402
    acceptance_map_available,
    level_satisfies,
    load_adapter,
    min_level_for_acceptance,
)
from scripts.core.disposition_form import evaluate_residual_disposition_form  # noqa: E402
