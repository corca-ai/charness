...
def _couplings(target_kind: str, skill_kind: str) -> list[dict[str, str]]:
    rows = [
        ...
        },
        {
            ...
            "command": "python3 scripts/gates/check_doc_links.py --repo-root .",
        },
        {
            "id": "skill_ergonomics",
            "message": "Portable-package edits must avoid bare issue anchors, dated incidents, and host-surface references (or declare them).",
            "command": "python3 scripts/gates/validate_skill_ergonomics.py --repo-root .",
        },
        {
            ...
            "command": "python3 scripts/gates/check_skill_ownership_overlap.py --repo-root .",
        },
        {
            "id": "attention_state",
...
def _check_commands(repo_root: Path) -> list[tuple[str, list[str]]]:
    ...
    return [
        ...
        (
            ...
            ["python3", "scripts/gates/validate_skill_ergonomics.py", "--repo-root", root],
        ),
        (
            "check_skill_ownership_overlap",
            ["python3", "scripts/gates/check_skill_ownership_overlap.py", "--repo-root", root],
        ),
        (
        ...
        ("check_doc_links", ["python3", "scripts/gates/check_doc_links.py", "--repo-root", root]),
