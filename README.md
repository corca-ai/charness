...
- [Documentation index](./docs/index.md) — the current owner map.
- [Workflow routes](./docs/workflow-routes.md) — ask in ordinary product language.
- [Development](./docs/development.md) — repo-local work and dogfood.
- [CLI reference](./docs/cli-reference.md) — complete command surface.
- [Host packaging](./docs/host-packaging.md) — install and export layout.

Public skills live under [`skills/public/`](./skills/public/); the index routes
