...
from .quality_bootstrap_support import (
    ...
    _run_quality_init_adapter,
    _run_quality_resolve_adapter,
    seed_quality_repo,
...
def test_quality_bootstrap_adapter_records_installed_and_inferred_fields(tmp_path: Path) -> None:
    ...
    assert payload["field_statuses"] == {
        ...
        "public_spec_section_exemptions": "defaulted",
        "public_spec_implementation_ref_density_floor": "defaulted",
        "public_spec_pointer_proof_markers": "defaulted",
...
def test_quality_bootstrap_adapter_preserves_existing_explicit_commands(tmp_path: Path) -> None:
    ...
    preserved_keys = (
        ...
        "acknowledged_recommendations", "gate_design_review_globs", "canonical_markdown_surfaces",
    ...
    expected_resolved = {
        ...
        "skill_ergonomics_runtime_install_skill_paths": ["packages/official-skills/acme-native/skills"],
