...
def test_setup_pins_live_spawn_first_execution_contract(exported_plugin_tree) -> None:
    ...
    assert (exported_plugin_tree / "skills" / "setup" / "SKILL.md").read_bytes() == (
...
def test_critique_and_debug_share_the_evidence_led_adversarial_route(exported_plugin_tree) -> None:
    critique_reference = (
    ...
    plugin_root = exported_plugin_tree / "skills"
