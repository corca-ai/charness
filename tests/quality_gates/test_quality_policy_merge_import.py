"""`scripts.adapters.quality_policy_merge` must import on its own, in a fresh process.
...
The first person to write a unit test starting `from scripts.adapters.quality_policy_merge
...
@pytest.mark.parametrize(
    "first",
    ["scripts.adapters.quality_policy_merge", "scripts.adapters.quality_policy_defaults"],
)
...
def test_the_reexport_still_resolves_from_either_entry_point() -> None:
    ...
    probe = (
        ...
        "from scripts.adapters.quality_policy_merge import merge_coverage_floor_policy as m; "
