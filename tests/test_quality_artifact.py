    ...
    repo = seed_repo(
        ...
        "\n".join(
            [
                ...
                "- gate",
                "## Runtime Signals",
                "- runtime source: structured metrics from `.charness/quality/runtime-signals.json` rendered by `render_runtime_summary.py` via `scripts/gates_support/record_quality_runtime.py`.",
