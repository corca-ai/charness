...
- GitHub release record: verified URL `https://github.com/corca-ai/charness/releases/tag/v2.3.1`
...
- Channel URL: `https://github.com/corca-ai/charness/releases/tag/v2.3.1`
- HTTP status: `200`
...
- Delivery episode ID: `episode-9846d36fe03a027b9e2ccb8d6a05f859e464a462dac1f0e12f10eabf0523b581`.
- Linked feedback ID: `feedback-f6f6a71f7f59657abe292b0d811f55b572e1432cd7208d1166a1daee2de0f5ae`.
...
- Public release check: `gh release view v2.3.1`.
...
- `fresh_checkout_probes_after_amend`: 2.925s
- `push_create_verify_release`: 65.843s
- `distinct_channel_verification`: 0.583s
- `post_publish_install_refresh`: 8.487s
...
- Just-published version: `2.3.1`.
- Versions claimed by the baton's routing sections: `2.3.0`.
- RECONCILE REQUIRED: Reconcile `docs/handoff.md` (its `## Current State` / `## Next Session` routing sections) to the just-published `2.3.1`, or record an explicit n/a disposition in the release record, before ending the session.
...
- Durable observer record: `charness-artifacts/probe/2026-07-20-v2.3.1-release-observer.json`.
