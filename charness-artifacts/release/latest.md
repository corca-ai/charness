...
Advanced `charness` toward release `8.9.3` (tag `v8.9.3`) through the repo-owned release helper.

## Current Version

- previous version: `8.9.2`
- target version: `8.9.3`
- git branch: `main`
- git remote: `origin`

## Verification

- `./scripts/run-quality.sh --release --read-only` exited 0 in 325.0s at `post-claims-review, pre-push`, measured by this helper (`./scripts/run-quality.sh --release --read-only --receipt-json=/home/hwidong/.cache/tmp/charness/runtime/811b9f8f8a808bfa/scratch/release-prepush-quality/1201125-1789958225824030968/semantic-quality.json`).
- pre-push quality receipt: `charness-artifacts/release/8.9.3-prepush-quality.json` (sha256: `d656e7ec688648100137ede92cd5c8f92d3440347fa6038fe8ef1a9c58aa5318`).
- `current_release.py` reported no version drift across 4 versioned surface(s), with 1 presence-only surface(s) not version-checked against target `8.9.3`, checked at `post-claims-review, pre-push`.
...
- GitHub release record: verified URL `https://github.com/corca-ai/charness/releases/tag/v8.9.3`
...
- Response content checked for: `v8.9.3`
...
- Channel URL: `https://github.com/corca-ai/charness/releases/tag/v8.9.3`
- HTTP status: `200`
...
- Review proof: `charness-artifacts/critique/v893-release-critique.md`.

## Claims Review

- Claims review record: `charness-artifacts/release-review/2026-09-21-v8.9.3-prepared-claims-review.json`.
- Claims review verdict: `pass`.
- Observer distinctness: `separate-agent-context`.
- Recorded signal: ephemeral codex exec read-only session auditing latest.md and versioned surfaces; no repo mutation, fresh context
- Review narrative: `charness-artifacts/release-review/2026-09-21-v8.9.3-claims-review.md`.
- Verdict scope: 244 blocking path(s) gated this tag; 0 advisory path(s) (session narrative) were reviewed but did not.
...
- Public release check: `gh release view v8.9.3`.
...
- `cli_skill_surface_gate`: 2.313s
- `quality_command`: 325.013s
- `fresh_checkout_probes_resume`: 6.261s
- `push_create_verify_release`: 328.408s
- `distinct_channel_verification`: 0.473s
- `published_notes_audit`: 0.412s
- `post_publish_install_refresh`: 8.755s
- `post_publish_installed_readback`: 1.020s
- `release_observer`: 0.000s
- `issue_closeout`: 0.000s

## Release Observer Record

- Durable observer record: `charness-artifacts/probe/2026-09-21-v8.9.3-release-observer.json`.
