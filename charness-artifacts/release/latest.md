...
- GitHub release record: verified URL `https://github.com/corca-ai/charness/releases/tag/v2.1.3`
...
- Channel URL: `https://github.com/corca-ai/charness/releases/tag/v2.1.3`
- HTTP status: `200`
...
- Delivery episode ID: `episode-7c12c65f84e30d40c2f45f07fb8e165b32177baa47ac7ec7bd25520cf69f0a1d`.
- Linked feedback ID: `feedback-e11d2a397e0d51197b9c83c9ee2e935dcb3d3ec9051191cab7275fdd2e075087`.
...
- Public release check: `gh release view v2.1.3`.
...
- `fresh_checkout_probes_after_amend`: 2.744s
- `push_create_verify_release`: 68.572s
- `distinct_channel_verification`: 0.475s
- `issue_closeout`: 0.000s
- `post_publish_install_refresh`: 10.112s
