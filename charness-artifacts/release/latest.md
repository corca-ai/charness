...
Advanced `charness` toward release `2.1.5` (tag `v2.1.5`) through the repo-owned release helper.
...
- GitHub release record: verified URL `https://github.com/corca-ai/charness/releases/tag/v2.1.5`
...
- Channel URL: `https://github.com/corca-ai/charness/releases/tag/v2.1.5`
- HTTP status: `200`
...
- Delivery episode ID: `episode-f0a26f85b0972d9ddf3748baeea112f42cd64bffbfd0d9447645055edf339be1`.
- Linked feedback ID: `feedback-c3bde2c6071d009f219a4095bcfce5acab0c8e71ca631c6708898d20c57958dd`.
...
- Previous release ref: `refs/tags/v2.1.4`
...
- Retro artifact: `charness-artifacts/retro/2026-07-18-v2-1-5-release-auto-retro.md`.
...
- Evaluated changed paths: 134.
  ...
  - `charness-artifacts/critique/2026-07-19-gajae-pattern-adoption-v2-1-5-release.md`
  ...
  - `charness-artifacts/critique/2026-07-19-v2-1-5-release-quality-gate-repair.md`
...
- Review proof: `charness-artifacts/critique/2026-07-19-gajae-pattern-adoption-v2-1-5-release.md`.
...
- Public release check: `gh release view v2.1.5`.
...
- `cli_skill_surface_gate`: 1.909s
- `quality_command`: 87.236s
- `fresh_checkout_probes_initial`: 2.924s
- `fresh_checkout_probes_after_amend`: 2.876s
- `push_create_verify_release`: 58.458s
- `distinct_channel_verification`: 0.548s
- `post_publish_install_refresh`: 8.790s
...
- Just-published version: `2.1.5`.
- Versions claimed by the baton's routing sections: `2.1.5`, `2.1.4`.
...
- Durable observer record: `charness-artifacts/probe/2026-07-18-v2.1.5-release-observer.json`.
