...
- GitHub release record: verified URL `https://github.com/corca-ai/charness/releases/tag/v1.0.3`
...
- Channel URL: `https://github.com/corca-ai/charness/releases/tag/v1.0.3`
- HTTP status: `200`
...
- Public release check: `gh release view v1.0.3`.
...
- `fresh_checkout_probes_after_amend`: 3.015s
- `push_create_verify_release`: 60.951s
- `distinct_channel_verification`: 0.510s
- `issue_closeout`: 0.000s
- `post_publish_install_refresh`: 8.588s
