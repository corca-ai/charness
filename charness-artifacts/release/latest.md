...
Advanced `charness` toward release `0.7.11` (tag `v0.7.11`) through the repo-owned release helper.

## Current Version

- previous version: `0.7.10`
...
- GitHub release record: verified URL `https://github.com/corca-ai/charness/releases/tag/v0.7.11`
...
- Public release check: `gh release view v0.7.11`.
