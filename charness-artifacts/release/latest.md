...
- GitHub release record: verified URL `https://github.com/corca-ai/charness/releases/tag/v4.2.0`
...
- Response content checked for: `v4.2.0`
...
- Channel URL: `https://github.com/corca-ai/charness/releases/tag/v4.2.0`
- HTTP status: `200`
...
- No mutable source-tree pointers found (5752 body bytes).

## Lifecycle Usage Capture

- Lifecycle capture status: `appended`.
- Local telemetry pair appended: `True`.
- Delivery episode ID: `episode-e9c107cb2f5aaf162b1adcbd6c91b35afc2d3df44e3c0f8ae20e79f9bdc324e7`.
- Linked feedback ID: `feedback-233e06fd0aabb45729532053cba2aed6bec8c24dc896b7bf3a1a033720e4efad`.
...
- Public release check: `gh release view v4.2.0`.
...
- `fresh_checkout_probes_after_amend`: 3.935s
- `push_create_verify_release`: 97.029s
- `distinct_channel_verification`: 0.580s
- `published_notes_audit`: 0.785s
- `post_publish_install_refresh`: 8.256s
- `post_publish_installed_readback`: 1.298s
...
- Just-published version: `4.2.0`.
- Versions claimed by the baton's routing sections: `4.1.0`.
- RECONCILE REQUIRED: Reconcile `docs/handoff.md` (its `## Current State` / `## Next Session` routing sections) to the just-published `4.2.0`, or record an explicit n/a disposition in the release record, before ending the session.
...
- Durable observer record: `charness-artifacts/probe/2026-08-09-v4.2.0-release-observer.json`.
