...
Advanced `charness` toward release `8.11.1` (tag `v8.11.1`) through the repo-owned release helper.

## Current Version

- previous version: `8.11.0`
- target version: `8.11.1`
- git branch: `main`
- git remote: `origin`

## Verification

- `./scripts/run-quality.sh --release --read-only` exited 0 in 541.0s at `post-claims-review, pre-push`, measured by this helper (`./scripts/run-quality.sh --release --read-only --receipt-json=/home/hwidong/.cache/tmp/charness/runtime/811b9f8f8a808bfa/scratch/release-prepush-quality/4161414-1790156651419707544/semantic-quality.json`).
- pre-push quality receipt: `charness-artifacts/release/8.11.1-prepush-quality.json` (sha256: `37e4ff80eb80955b7bb324c47935f8aca733015ef72c642d92c9f445155a377a`).
- `current_release.py` reported no version drift across 4 versioned surface(s), with 1 presence-only surface(s) not version-checked against target `8.11.1`, checked at `post-claims-review, pre-push`.
...
- GitHub release record: verified URL `https://github.com/corca-ai/charness/releases/tag/v8.11.1`
...
- Response content checked for: `v8.11.1`
...
- Channel URL: `https://github.com/corca-ai/charness/releases/tag/v8.11.1`
- HTTP status: `200`
...
- Review proof: `charness-artifacts/critique/task-run-834-836-release-critique.md`.

## Claims Review

- Claims review record: `charness-artifacts/release-review/2026-09-23-v8.11.1-prepared-claims-review.json`.
- Claims review verdict: `pass`.
- Observer distinctness: `separate-agent-context`.
- Recorded signal: subagent claims-review-v8111 findings-received task/01a0cd8c-8869-7ac2-bf42-59249fc4db88; parent re-verified scope for 0f81d826a443
- Review narrative: `charness-artifacts/release-review/2026-09-23-v8.11.1-claims-review.md`.
- Verdict scope: 22 blocking path(s) gated this tag; 0 advisory path(s) (session narrative) were reviewed but did not.
- Advisory findings: 3 finding(s) recorded in advisory scope and carried into this release record without gating this tag:
  - tag v8.11.1 named in latest.md but not yet pushed; no consumer should cite it as existing yet
  - publication waits on pytest-release resume; read-only pass is necessary but not sufficient
  - first prepare abandoned unpublished after out-of-order ledger commit; re-prepared cleanly
...
- Public release check: `gh release view v8.11.1`.
...
- `requested_review_gate`: 0.009s
- `cli_skill_surface_gate`: 2.264s
- `quality_command`: 540.978s
- `fresh_checkout_probes_resume`: 6.857s
- `push_create_verify_release`: 584.705s
- `distinct_channel_verification`: 0.585s
- `published_notes_audit`: 0.445s
- `post_publish_install_refresh`: 9.667s
- `post_publish_installed_readback`: 1.232s
- `release_observer`: 0.001s
- `issue_closeout`: 0.000s

## Release Observer Record

- Durable observer record: `charness-artifacts/probe/2026-09-23-v8.11.1-release-observer.json`.
