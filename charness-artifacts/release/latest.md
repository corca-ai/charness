...
- GitHub release record: verified URL `https://github.com/corca-ai/charness/releases/tag/v0.56.7`
...
- Channel URL: `https://github.com/corca-ai/charness/releases/tag/v0.56.7`
- HTTP status: `200`
...
- Public release check: `gh release view v0.56.7`.
...
- `push_create_verify_release`: 42.367s
- `distinct_channel_verification`: 0.534s
- `issue_closeout`: 0.000s
- `post_publish_install_refresh`: 7.955s
