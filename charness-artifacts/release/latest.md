...
- GitHub release record: verified URL `https://github.com/corca-ai/charness/releases/tag/v2.3.0`
...
- Channel URL: `https://github.com/corca-ai/charness/releases/tag/v2.3.0`
- HTTP status: `200`
...
- Delivery episode ID: `episode-77fd4f1dc6fd8b331ef67c738651e1922b4cab8eaf95a28f4328d559364e2068`.
- Linked feedback ID: `feedback-62bceae1992a64e294588514d849cb3d4f7401695d1f59a7bbfc8f086f50f308`.
...
- Public release check: `gh release view v2.3.0`.
...
- `fresh_checkout_probes_after_amend`: 2.903s
- `push_create_verify_release`: 69.050s
- `distinct_channel_verification`: 0.529s
- `post_publish_install_refresh`: 8.891s
- `post_publish_installed_readback`: 1.304s
...
- Versions claimed by the baton's routing sections: `2.2.1`.
- RECONCILE REQUIRED: Reconcile `docs/handoff.md` (its `## Current State` / `## Next Session` routing sections) to the just-published `2.3.0`, or record an explicit n/a disposition in the release record, before ending the session.
...
- Durable observer record: `charness-artifacts/probe/2026-07-20-v2.3.0-release-observer.json`.
