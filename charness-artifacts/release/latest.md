...
Advanced `charness` toward release `0.56.5` (tag `v0.56.5`) through the repo-owned release helper.

## Current Version

- previous version: `0.56.4`
- target version: `0.56.5`
- git branch: `main`
- git remote: `origin`
...
- GitHub release record: verified URL `https://github.com/corca-ai/charness/releases/tag/v0.56.5`
...
- Channel URL: `https://github.com/corca-ai/charness/releases/tag/v0.56.5`
- HTTP status: `200`
...
- Retro artifact: `charness-artifacts/retro/2026-06-26-v0-56-5-release-auto-retro.md`.
...
- Evaluated changed paths: 24.
  ...
  - `charness-artifacts/critique/2026-06-27-release-0-56-5-quality-slice-packet.json`
...
- Review proof: `charness-artifacts/critique/2026-06-27-release-0-56-5-critique.md`.
...
- Public release check: `gh release view v0.56.5`.
...
- `cli_skill_surface_gate`: 1.972s
- `quality_command`: 59.945s
- `fresh_checkout_probes_initial`: 2.774s
- `fresh_checkout_probes_after_amend`: 2.659s
- `push_create_verify_release`: 42.899s
- `distinct_channel_verification`: 0.531s
- `issue_closeout`: 0.000s
- `post_publish_install_refresh`: 8.327s
