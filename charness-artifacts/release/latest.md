...
Advanced `charness` toward release `0.7.5` (tag `v0.7.5`) through the repo-owned release helper.
...
- GitHub release record: verified URL `https://github.com/corca-ai/charness/releases/tag/v0.7.5`
...
- Review proof: `charness-artifacts/critique/2026-05-19-v0.7.5-release-critique.md`.

## Post-Publish Proof

- Public release check: `gh release view v0.7.5`.
