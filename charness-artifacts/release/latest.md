...
- GitHub release record: verified URL `https://github.com/corca-ai/charness/releases/tag/v0.57.0`
...
- Channel URL: `https://github.com/corca-ai/charness/releases/tag/v0.57.0`
- HTTP status: `200`
...
- Public release check: `gh release view v0.57.0`.
...
- `fresh_checkout_probes_after_amend`: 2.835s
- `push_create_verify_release`: 43.276s
- `distinct_channel_verification`: 0.575s
- `issue_closeout`: 0.000s
- `post_publish_install_refresh`: 8.143s
