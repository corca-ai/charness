...
- **Generated**: 2026-08-12T01:10:41Z
- **Prepared for**: contract-register-proof-closeout
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `c913ccf7f7f7cab725d79769cabed577a65d31143b9fb06164e382603db71f93`
- **Reviewed paths**: 9
- **Sections**: 3
- **Overall ok**: True
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/run-quality.sh, scripts/check_contract_register.py, scripts/contract_register_lib.py
  derived matches: plugins/charness/scripts/run-quality.sh, plugins/charness/scripts/check_contract_register.py, plugins/charness/scripts/contract_register_lib.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: docs/conventions/validator-timing-layers.md
