...
- **Generated**: 2026-07-11T11:30:26Z
- **Prepared for**: Slice B explicit campaign coverage anchor propagation
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/mutation_coverage_producer.py, scripts/run_slice_closeout.py, tests/quality_gates/test_mutation_coverage_producer.py, tests/quality_gates/test_run_slice_closeout_surface_obligations.py
  derived matches: plugins/charness/scripts/mutation_coverage_producer.py, plugins/charness/scripts/run_slice_closeout.py
