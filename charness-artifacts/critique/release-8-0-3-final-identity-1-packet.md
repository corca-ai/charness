...
- **Generated**: 2026-09-03T09:53:33Z
- **Prepared for**: release 8.0.3 lock-in, final bytes
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `dcda037e7b317e70e0b57cf7e84e85e7c15727de5604b709570759d480346c59`
- **Reviewed paths**: 54
...
- charness-artifacts/critique/release-8-0-3-repair-verify-1-packet.md
- charness-artifacts/release/2026-09-03-v8.0.3-install-update-rehearsal.md

Owning surfaces:
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/release/v8.0.3-notes.md, docs/development.md, charness-artifacts/critique/release-8-0-3-critique.md, charness-artifacts/critique/release-8-0-3-repair-verify-1-packet.md, charness-artifacts/release/2026-09-03-v8.0.3-install-update-rehearsal.md
...
- operational-evidence-records: Durable issue, quality, and release evidence attachments produced by local planning and closeout workflows.
  source matches: charness-artifacts/release/v8.0.3-notes.md, charness-artifacts/release/2026-09-03-v8.0.3-install-update-rehearsal.md
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/release-8-0-3-critique.md, charness-artifacts/critique/release-8-0-3-repair-verify-1-packet.json, charness-artifacts/critique/release-8-0-3-repair-verify-1-packet.md
