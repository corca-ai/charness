...
- **Generated**: 2026-06-25T06:57:59Z
- **Prepared for**: issue-403-create-closeout-preview
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/issue/SKILL.md, skills/public/issue/references/closeout-discipline.md, skills/public/issue/scripts/issue_create.py
  derived matches: plugins/charness/skills/issue/SKILL.md, plugins/charness/skills/issue/references/closeout-discipline.md, plugins/charness/skills/issue/scripts/issue_create.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: skills/public/issue/SKILL.md, skills/public/issue/references/closeout-discipline.md
  derived matches: plugins/charness/skills/issue/SKILL.md, plugins/charness/skills/issue/references/closeout-discipline.md
