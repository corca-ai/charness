...
- **Generated**: 2026-06-25T21:54:17Z
- **Prepared for**: quality speed and token efficiency slice
...
- plugins/charness/skills/quality/references/prompt-asset-policy.md
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/quality/references/find_inline_prompt_bulk.py, skills/public/quality/references/prompt-asset-policy.md, skills/public/quality/scripts/render_runtime_summary.py, skills/public/quality/scripts/runtime_budget_lib.py
  derived matches: plugins/charness/skills/quality/references/find_inline_prompt_bulk.py, plugins/charness/skills/quality/references/prompt-asset-policy.md, plugins/charness/skills/quality/scripts/render_runtime_summary.py, plugins/charness/skills/quality/scripts/runtime_budget_lib.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/quality/2026-06-25-skill-ergonomics-yaml-summary-quality-review.md, skills/public/quality/references/prompt-asset-policy.md
  derived matches: plugins/charness/skills/quality/references/prompt-asset-policy.md
...
- prompt-behavior-proof: Prompt-affecting instruction surfaces must follow deterministic Cautilus validation and on-demand proof policy.
  source matches: skills/public/quality/references/find_inline_prompt_bulk.py, skills/public/quality/references/prompt-asset-policy.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_runtime_budget_gate.py, tests/test_find_inline_prompt_bulk.py
...
- inference-interpretation-contract: Advisory-interpretation contract meta-validator (#330): the inference-layer surface registry plus every registered Python/prose declaration and its paired consumer reference.
  source matches: skills/public/quality/scripts/render_runtime_summary.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: skills/public/quality/scripts/render_runtime_summary.py, skills/public/quality/scripts/runtime_budget_lib.py
