...
- **Generated**: 2026-06-01T06:26:46Z
- **Prepared for**: HEAD
- **Changed ref**: `HEAD`
...
- plugins/charness/skills/retro/scripts/audit_codex_session.py
- plugins/charness/skills/retro/scripts/probe_host_logs.py
- scripts/codex_session_jsonl_audit.py
...
- tests/quality_gates/test_codex_session_jsonl_audit.py
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/codex_session_jsonl_audit.py, scripts/host_log_probe_lib.py, skills/public/achieve/references/goal-artifact.md, skills/public/achieve/references/lifecycle.md, skills/public/retro/SKILL.md, skills/public/retro/references/phase-aware-efficiency.md, skills/public/retro/scripts/audit_codex_session.py, skills/public/retro/scripts/probe_host_logs.py
  derived matches: plugins/charness/scripts/codex_session_jsonl_audit.py, plugins/charness/scripts/host_log_probe_lib.py, plugins/charness/skills/achieve/references/goal-artifact.md, plugins/charness/skills/achieve/references/lifecycle.md, plugins/charness/skills/retro/SKILL.md, plugins/charness/skills/retro/references/phase-aware-efficiency.md, plugins/charness/skills/retro/scripts/audit_codex_session.py, plugins/charness/skills/retro/scripts/probe_host_logs.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: skills/public/achieve/references/goal-artifact.md, skills/public/achieve/references/lifecycle.md, skills/public/retro/SKILL.md, skills/public/retro/references/phase-aware-efficiency.md
  derived matches: plugins/charness/skills/achieve/references/goal-artifact.md, plugins/charness/skills/achieve/references/lifecycle.md, plugins/charness/skills/retro/SKILL.md, plugins/charness/skills/retro/references/phase-aware-efficiency.md
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/achieve/references/goal-artifact.md, skills/public/achieve/references/lifecycle.md, skills/public/retro/SKILL.md, skills/public/retro/references/phase-aware-efficiency.md, skills/public/retro/scripts/audit_codex_session.py, skills/public/retro/scripts/probe_host_logs.py
...
- public-skill-dogfood: Checked-in consumer dogfood cases for public skills and the validator that keeps them aligned with current skill contracts.
  source matches: docs/public-skill-dogfood.json, skills/public/achieve/references/goal-artifact.md, skills/public/achieve/references/lifecycle.md, skills/public/retro/SKILL.md, skills/public/retro/references/phase-aware-efficiency.md, skills/public/retro/scripts/audit_codex_session.py, skills/public/retro/scripts/probe_host_logs.py
...
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/codex_session_jsonl_audit.py, plugins/charness/scripts/host_log_probe_lib.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_codex_session_jsonl_audit.py, tests/quality_gates/test_goal_artifact_producers.py, tests/quality_gates/test_retro_host_log_probe.py
