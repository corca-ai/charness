...
- **Generated**: 2026-06-17T10:14:56Z
- **Prepared for**: issue-383-achieve-draft-frame-resolution
...
- plugins/charness/skills/achieve/scripts/goal_artifact_draft_frame.py
- skills/public/achieve/scripts/goal_artifact_draft_frame.py
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/achieve/adapter.example.yaml, skills/public/achieve/references/adapter-contract.md, skills/public/achieve/references/goal-artifact.md, skills/public/achieve/scripts/goal_artifact_lib.py, skills/public/achieve/scripts/goal_artifact_scaffold.py, skills/public/achieve/scripts/goal_artifact_draft_frame.py
  derived matches: plugins/charness/skills/achieve/adapter.example.yaml, plugins/charness/skills/achieve/references/adapter-contract.md, plugins/charness/skills/achieve/references/goal-artifact.md, plugins/charness/skills/achieve/scripts/goal_artifact_lib.py, plugins/charness/skills/achieve/scripts/goal_artifact_scaffold.py, plugins/charness/skills/achieve/scripts/goal_artifact_draft_frame.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: skills/public/achieve/references/adapter-contract.md, skills/public/achieve/references/goal-artifact.md
  derived matches: plugins/charness/skills/achieve/references/adapter-contract.md, plugins/charness/skills/achieve/references/goal-artifact.md
...
- public-skill-dogfood: Checked-in consumer dogfood cases for public skills and the validator that keeps them aligned with current skill contracts.
  source matches: docs/public-skill-dogfood.json, skills/public/achieve/adapter.example.yaml, skills/public/achieve/references/adapter-contract.md, skills/public/achieve/references/goal-artifact.md, skills/public/achieve/scripts/goal_artifact_lib.py, skills/public/achieve/scripts/goal_artifact_scaffold.py, skills/public/achieve/scripts/goal_artifact_draft_frame.py
  verify: python3 scripts/validate_public_skill_dogfood.py --repo-root .
- repo-python: Repo-owned Python code and tests.
  source matches: charness, tests/charness_cli/test_goal_helpers.py, tests/quality_gates/test_goal_artifact_lib.py, tests/quality_gates/test_goal_artifact_scaffold.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: skills/public/achieve/scripts/goal_artifact_lib.py, skills/public/achieve/scripts/goal_artifact_scaffold.py, skills/public/achieve/scripts/goal_artifact_draft_frame.py
