...
- **Generated**: 2026-08-04T07:09:08Z
- **Prepared for**: retro goal binding slice
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `ecca398a4dbf347b6c525bc0bf38ad80e0b996f22e0f88deee59dcae243632f0`
- **Reviewed paths**: 10
- **Sections**: 3
- **Overall ok**: True
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/retro_persistence_lib.py, skills/public/retro/references/trigger-and-persistence.md, skills/public/retro/scripts/persist_retro_artifact.py
  derived matches: plugins/charness/scripts/retro_persistence_lib.py, plugins/charness/skills/retro/references/trigger-and-persistence.md, plugins/charness/skills/retro/scripts/persist_retro_artifact.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/debug/latest.md, charness-artifacts/goals/2026-08-04-retro-persistence-goal-aware.md, skills/public/retro/references/trigger-and-persistence.md, charness-artifacts/debug/2026-08-04-debug-review-followup-3.md
  derived matches: plugins/charness/skills/retro/references/trigger-and-persistence.md
...
- prompt-behavior-proof: Prompt-affecting instruction surfaces must follow deterministic Cautilus validation and on-demand proof policy.
  source matches: skills/public/retro/references/trigger-and-persistence.md
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/retro/references/trigger-and-persistence.md, skills/public/retro/scripts/persist_retro_artifact.py
  derived matches: plugins/charness/skills/retro/references/trigger-and-persistence.md, plugins/charness/skills/retro/scripts/persist_retro_artifact.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/retro_persistence_lib.py, tests/quality_gates/test_retro_persistence.py
  derived matches: plugins/charness/scripts/retro_persistence_lib.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: scripts/retro_persistence_lib.py, skills/public/retro/scripts/persist_retro_artifact.py
