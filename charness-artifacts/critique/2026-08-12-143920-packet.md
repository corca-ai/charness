...
- **Generated**: 2026-08-12T14:39:20Z
- **Prepared for**: Issue 597 final evidence fixture repair
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `b06bf97e9286f76dbed91af2dcd7a3721e47ef173f5b44359bac92291174baa2`
- **Reviewed paths**: 7
- **Sections**: 3
- **Overall ok**: True
...
- charness-artifacts/critique/2026-08-12-143830-packet.json
- charness-artifacts/critique/2026-08-12-143830-packet.md
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/check_quality_tool_fixtures.py, scripts/run-quality.sh
  derived matches: plugins/charness/scripts/check_quality_tool_fixtures.py, plugins/charness/scripts/run-quality.sh
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/critique/2026-08-12-143830-packet.md, charness-artifacts/critique/2026-08-12-issue-597-quality-fixture-gate-repair-critique.md, charness-artifacts/debug/2026-08-12-issue-597-quality-fixture-gate-debug.md, charness-artifacts/debug/latest.md
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-08-12-143830-packet.json, charness-artifacts/critique/2026-08-12-143830-packet.md, charness-artifacts/critique/2026-08-12-issue-597-quality-fixture-gate-repair-critique.md
  verify: python3 scripts/validate_critique_artifacts.py --repo-root . --all
- debug-seam-risk-index: Generated source-linked index over debug artifact seam-risk fields.
  source matches: charness-artifacts/debug/2026-08-12-issue-597-quality-fixture-gate-debug.md, charness-artifacts/debug/latest.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/check_quality_tool_fixtures.py, tests/quality_gates/test_quality_tool_fixtures.py
  derived matches: plugins/charness/scripts/check_quality_tool_fixtures.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: scripts/check_quality_tool_fixtures.py
