...
- **Generated**: 2026-08-05T22:57:31Z
- **Prepared for**: issue-512-metric-window-ordering-final
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `e725896886a1c28fbc7fe584c73ab20bd3da45972b530277a0285f2388ea2d30`
- **Reviewed paths**: 5
- **Sections**: 3
- **Overall ok**: True
...
- plugins/charness/skills/achieve/scripts/goal_metric_window_lib.py
...
- charness-artifacts/critique/2026-08-06-issue-512-metric-window-ordering-code-critique.md
- charness-artifacts/critique/2026-08-06-issue-512-ordering-packet.json
- charness-artifacts/critique/2026-08-06-issue-512-ordering-packet.md
- charness-artifacts/debug/2026-08-06-issue-512-metric-window-ordering-debug.md
- charness-artifacts/issue/2026-08-06-issue-512-closeout-commit-message.md
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/achieve/references/goal-artifact.md, skills/public/achieve/scripts/goal_metric_window_lib.py
  derived matches: plugins/charness/skills/achieve/references/goal-artifact.md, plugins/charness/skills/achieve/scripts/goal_metric_window_lib.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: skills/public/achieve/references/goal-artifact.md, charness-artifacts/critique/2026-08-06-issue-512-metric-window-ordering-code-critique.md, charness-artifacts/critique/2026-08-06-issue-512-ordering-packet.md, charness-artifacts/debug/2026-08-06-issue-512-metric-window-ordering-debug.md, charness-artifacts/issue/2026-08-06-issue-512-closeout-commit-message.md
  derived matches: plugins/charness/skills/achieve/references/goal-artifact.md
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-08-06-issue-512-metric-window-ordering-code-critique.md, charness-artifacts/critique/2026-08-06-issue-512-ordering-packet.json, charness-artifacts/critique/2026-08-06-issue-512-ordering-packet.md
  verify: python3 scripts/validate_critique_artifacts.py --repo-root . --all
- debug-seam-risk-index: Generated source-linked index over debug artifact seam-risk fields.
  source matches: charness-artifacts/debug/2026-08-06-issue-512-metric-window-ordering-debug.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_record_metric_window.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: skills/public/achieve/scripts/goal_metric_window_lib.py
