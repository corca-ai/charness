...
- **Generated**: 2026-06-11T12:47:36Z
- **Prepared for**: nose exclude adapter slice
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: integrations/tools/nose.json, skills/public/quality/references/inventory-consumer-fields.json, skills/public/quality/references/inventory-dispatch.md, skills/public/quality/scripts/inventory_nose_clones.py
  derived matches: plugins/charness/integrations/tools/nose.json, plugins/charness/skills/quality/references/inventory-consumer-fields.json, plugins/charness/skills/quality/references/inventory-dispatch.md, plugins/charness/skills/quality/scripts/inventory_nose_clones.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: docs/duplicate-detection-strategy.md, skills/public/quality/references/inventory-dispatch.md
...
- prompt-behavior-proof: Prompt-affecting instruction surfaces must follow deterministic Cautilus validation and on-demand proof policy.
  source matches: skills/public/quality/references/inventory-consumer-fields.json, skills/public/quality/references/inventory-dispatch.md
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/quality/references/inventory-consumer-fields.json, skills/public/quality/references/inventory-dispatch.md, skills/public/quality/scripts/inventory_nose_clones.py
  derived matches: plugins/charness/skills/quality/references/inventory-consumer-fields.json, plugins/charness/skills/quality/references/inventory-dispatch.md, plugins/charness/skills/quality/scripts/inventory_nose_clones.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_quality_nose_advisory.py
