...
- **Generated**: 2026-09-03T23:40:30Z
- **Prepared for**: task-run-790-791-repair
- **Substrate mode**: `committed-ref`
- **Changed ref**: `286a2a745`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `5ade27d84510d40a597d39626f7ad289dd21e1c35b19626da51e04db56599beb`
- **Reviewed paths**: 6
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/task-run-790-791-repair-verify-1-packet.json --packet-sha256 23b8998eef52f1222274c26cc809ec7768fca07a55b4bc52d4e9ccda0949ee7b --identity-sha256 5ade27d84510d40a597d39626f7ad289dd21e1c35b19626da51e04db56599beb
```
...
```text
Changed paths for ref `286a2a745`:
- docs/agent-task-runs.md
- scripts/task_run/task_run.py
- scripts/task_run/task_run_runtime.py
- scripts/task_run/task_run_scope.py
...
- materialized-plugin-export: Materialized plugin export and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/task_run/task_run.py, scripts/task_run/task_run_runtime.py, scripts/task_run/task_run_scope.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/task_run/task_run.py, scripts/task_run/task_run_runtime.py, scripts/task_run/task_run_scope.py, tests/charness_cli/test_task_run_result.py, tests/charness_cli/test_task_run_scope.py
