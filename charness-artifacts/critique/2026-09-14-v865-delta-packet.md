...
- **Generated**: 2026-09-14T04:54:43Z
- **Prepared for**: v8.6.5 delta critique: repo-root discovery hardening and hold-out isolation
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `e61c26453bb6fc0d116e022a417a5a40b513aa810fcdf9a6b17d3cdb4708631a`
- **Reviewed paths**: 5
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/2026-09-14-v865-delta-packet.json --packet-sha256 ff341884c750e47dd3a482918233de1c8563b33b2be5fcac78364fee7bd86f38 --identity-sha256 e61c26453bb6fc0d116e022a417a5a40b513aa810fcdf9a6b17d3cdb4708631a
```
...
- materialized-plugin-export: Materialized plugin export and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/lessons/lesson_ledger_writer_lib.py, scripts/review/reviewed_input_verification.py, skills/public/critique/scripts/run_review_hold_out.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/lessons/lesson_ledger_writer_lib.py, scripts/review/reviewed_input_verification.py, tests/test_lesson_ledger.py, tests/test_run_review_declared_path_resolution.py
