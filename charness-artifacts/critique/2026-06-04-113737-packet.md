...
- **Generated**: 2026-06-04T11:38:06Z
- **Prepared for**: issue-297-reviewer-tier-evidence
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/critique_packet_lib.py, scripts/validate_critique_artifacts.py, scripts/validate_critique_packet.py, skills/public/critique/references/prepare-packet.md, skills/shared/references/fresh-eye-subagent-review.md
  derived matches: plugins/charness/scripts/critique_packet_lib.py, plugins/charness/scripts/validate_critique_artifacts.py, plugins/charness/scripts/validate_critique_packet.py, plugins/charness/shared/references/fresh-eye-subagent-review.md, plugins/charness/skills/critique/references/prepare-packet.md
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/critique/2026-06-04-issue-294-validator-closeout.md, charness-artifacts/critique/2026-06-04-issue-295-closeout-policy.md, skills/public/critique/references/prepare-packet.md, skills/shared/references/fresh-eye-subagent-review.md, charness-artifacts/critique/2026-06-04-113737-packet.md
  derived matches: plugins/charness/shared/references/fresh-eye-subagent-review.md, plugins/charness/skills/critique/references/prepare-packet.md
...
- prompt-behavior-proof: Prompt-affecting instruction surfaces must follow deterministic Cautilus validation and on-demand proof policy.
  source matches: skills/public/critique/references/prepare-packet.md, skills/shared/references/fresh-eye-subagent-review.md
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-06-04-issue-294-validator-closeout.md, charness-artifacts/critique/2026-06-04-issue-295-closeout-policy.md, charness-artifacts/critique/2026-06-04-113737-packet.json, charness-artifacts/critique/2026-06-04-113737-packet.md
  verify: python3 scripts/validate_critique_artifacts.py --repo-root . --all
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/critique_packet_lib.py, plugins/charness/scripts/validate_critique_artifacts.py, plugins/charness/scripts/validate_critique_packet.py
