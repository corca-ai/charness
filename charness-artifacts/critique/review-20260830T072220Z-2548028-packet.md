...
- **Generated**: 2026-08-29T22:22:21Z
- **Prepared for**: ac6e74a04..f449f4a07
- **Substrate mode**: `committed-ref`
- **Changed ref**: `ac6e74a04..f449f4a07`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `e097d4065672643c7db0aa8febd61c676003b77448423baddf769676480f8b8b`
- **Reviewed paths**: 20
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/review-20260830T072220Z-2548028-packet.json --packet-sha256 68ce56c2b4ef0b80ee14d78367e9ab23e87061cf799b1a65e299658c846a56fd --identity-sha256 e097d4065672643c7db0aa8febd61c676003b77448423baddf769676480f8b8b
```
...
```text
Changed paths for ref `ac6e74a04..f449f4a07`:
- charness-artifacts/critique/review-20260830T064052Z-2042213-packet.json
- charness-artifacts/critique/review-20260830T064052Z-2042213-packet.md
- charness-artifacts/critique/review-20260830T064102Z-2042513-packet.json
- charness-artifacts/critique/review-20260830T064102Z-2042513-packet.md
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/critique_packet_lib.py, scripts/critique_reviewed_input_binding.py, scripts/reviewed_input_identity.py, scripts/reviewed_input_verification.py, scripts/surfaces_lib.py, skills/public/critique/references/prepare-packet.md, skills/public/critique/scripts/verify_packet.py, skills/shared/scripts/reviewer_worker_carrier_support.py
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/critique/references/prepare-packet.md, skills/public/critique/scripts/verify_packet.py, skills/shared/scripts/reviewer_worker_carrier_support.py
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/review-20260830T064052Z-2042213-packet.json, charness-artifacts/critique/review-20260830T064052Z-2042213-packet.md, charness-artifacts/critique/review-20260830T064102Z-2042513-packet.json, charness-artifacts/critique/review-20260830T064102Z-2042513-packet.md
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: scripts/critique_packet_lib.py, scripts/critique_reviewed_input_binding.py, scripts/reviewed_input_identity.py, scripts/reviewed_input_verification.py, scripts/surfaces_lib.py, skills/public/critique/scripts/verify_packet.py
