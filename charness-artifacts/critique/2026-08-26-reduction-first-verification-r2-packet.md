...
- **Generated**: 2026-08-25T22:15:07Z
- **Prepared for**: a7489e180 repaired verification retry surface
- **Substrate mode**: `committed-ref`
- **Changed ref**: `HEAD^..HEAD`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `4aad3ee91ec49f2000196bdb46d6d730a3913e6dd4585a6db6747b2d2725d09d`
- **Reviewed paths**: 12
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/2026-08-26-reduction-first-verification-r2-packet.json --packet-sha256 f7c9c8f0e7089bb34f11ab092226ed2e098cdd88a12708f2233a1f69e55e4526 --identity-sha256 4aad3ee91ec49f2000196bdb46d6d730a3913e6dd4585a6db6747b2d2725d09d
```
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/critique/references/cadence.md, skills/public/critique/scripts/scaffold_critique_artifact.py, skills/public/critique/scripts/verification_retry.py, skills/public/quality/SKILL.md, skills/public/release/SKILL.md
  derived matches: plugins/charness/skills/critique/references/cadence.md, plugins/charness/skills/critique/scripts/scaffold_critique_artifact.py, plugins/charness/skills/critique/scripts/verification_retry.py, plugins/charness/skills/quality/SKILL.md, plugins/charness/skills/release/SKILL.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/test_critique_scaffold.py, tests/test_verification_retry.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: skills/public/critique/scripts/scaffold_critique_artifact.py, skills/public/critique/scripts/verification_retry.py
