...
- **Generated**: 2026-06-20T18:49:13Z
- **Prepared for**: issue-395-dup-ratchet-resolution
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/quality/references/dup-ratchet.md, skills/public/quality/scripts/dup_ratchet_lib.py, skills/public/quality/scripts/nose_baseline_lib.py
  derived matches: plugins/charness/skills/quality/references/dup-ratchet.md, plugins/charness/skills/quality/scripts/dup_ratchet_lib.py, plugins/charness/skills/quality/scripts/nose_baseline_lib.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: skills/public/quality/references/dup-ratchet.md, charness-artifacts/debug/2026-06-21-dup-ratchet-family-id-rotation.md
...
- debug-seam-risk-index: Generated source-linked index over debug artifact seam-risk fields.
  source matches: charness-artifacts/debug/2026-06-21-dup-ratchet-family-id-rotation.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_dup_ratchet.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: skills/public/quality/scripts/dup_ratchet_lib.py, skills/public/quality/scripts/nose_baseline_lib.py
