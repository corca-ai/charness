...
- **Generated**: 2026-09-06T01:55:12Z
- **Prepared for**: corca-ai/charness#803 resolution closeout
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `7318c86f58aabd31c18fa7965ede6d57f80a5dc232e41bd0e136e284798ed013`
- **Reviewed paths**: 12
  ...
  - `charness-artifacts/goal-runs/798/closeouts/issue-803.md`
  - `charness-artifacts/probe/2026-09-06-consumer-journeys/final-negative-branch-proof.json`
  - `charness-artifacts/probe/2026-09-06-v8.4.4-release-observer.json`
...
- charness-artifacts/critique/goal798-issue-800-close-packet.json
- charness-artifacts/critique/goal798-issue-800-close-packet.md
- charness-artifacts/goal-runs/798/closeouts/issue-800.md
- charness-artifacts/goal-runs/798/closeouts/issue-803.md

Owning surfaces:
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/critique/goal798-issue-800-close-packet.md, charness-artifacts/goal-runs/798/closeouts/issue-800.md, charness-artifacts/goal-runs/798/closeouts/issue-803.md
  verify: ./scripts/check-docs.sh, ./scripts/check-secrets.sh
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/goal798-issue-800-close-packet.json, charness-artifacts/critique/goal798-issue-800-close-packet.md
...
- goal-run-evidence: Durable Goal Run provider plans, operations, observations, graph snapshots, and evidence-lineage records.
  source matches: charness-artifacts/goal-runs/798/closeouts/issue-800.md, charness-artifacts/goal-runs/798/closeouts/issue-803.md
