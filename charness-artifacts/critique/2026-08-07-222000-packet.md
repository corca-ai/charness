...
- **Generated**: 2026-08-06T21:50:34Z
- **Prepared for**: unified #514/#515 goal design commit fb706ff5
- **Changed ref**: `fb706ff5`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `c641043c0690de2b62775673413db93355ba9b1aa69f5a4fc51b2daa050c9b1c`
- **Reviewed paths**: 34
- **Sections**: 3
- **Overall ok**: True
...
```text
Changed paths for ref `fb706ff5`:
- charness-artifacts/goals/2026-08-07-repair-evidence-boundary-close-514-515.md
- docs/handoff.md

Owning surfaces:
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/goals/2026-08-07-repair-evidence-boundary-close-514-515.md, docs/handoff.md
