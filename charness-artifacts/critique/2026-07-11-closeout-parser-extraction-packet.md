...
- **Generated**: 2026-07-11T11:59:37Z
- **Prepared for**: Slice D extract closeout parser internal module
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/run_slice_closeout.py, scripts/slice_closeout_parser.py
  derived matches: plugins/charness/scripts/run_slice_closeout.py, plugins/charness/scripts/slice_closeout_parser.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/run_slice_closeout.py, tests/quality_gates/test_slice_closeout_base_range.py, scripts/slice_closeout_parser.py
  derived matches: plugins/charness/scripts/run_slice_closeout.py, plugins/charness/scripts/slice_closeout_parser.py
