...
- **Generated**: 2026-09-11T12:05:30Z
- **Prepared for**: v8.6.2 pre-mutation release safety; version/export/notes are publish-helper and claims-review outputs
- **Prepared targets**: 1
  - `v8.6.2`
- **Substrate mode**: `committed-ref`
- **Changed ref**: `8391a5506dea189f28a46134f04382309d13d67f..c48da5cc1375a0a16a1d302e6a5585a88b64c603`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `86bf857638ce6ec406dfaaf1f298f86b13e3c783db9653350ba0ce0d211fb5e2`
- **Reviewed paths**: 10
  - `charness-artifacts/debug/2026-09-11-quality-catalog-repo-native-default.md`
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/release-8-6-2-followup-packet.json --packet-sha256 4f95739c1336d3688fb581a79c9f4c05b9642431787a455661625928ab5c7c4e --identity-sha256 86bf857638ce6ec406dfaaf1f298f86b13e3c783db9653350ba0ce0d211fb5e2
```
...
```text
Changed paths for ref `8391a5506dea189f28a46134f04382309d13d67f..c48da5cc1375a0a16a1d302e6a5585a88b64c603`:
- charness-artifacts/debug/2026-09-11-quality-catalog-repo-native-default.md
- charness-artifacts/debug/latest.md
- charness-artifacts/debug/seam-risk-index.json
- skills/public/quality/references/adapter-contract.md
...
- materialized-plugin-export: Materialized plugin export and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/quality/references/adapter-contract.md, skills/public/quality/scripts/plan_quality_run.py, skills/public/quality/scripts/quality_catalog_gate_applicability.py, skills/public/quality/scripts/quality_declaration_lifecycle.py, skills/public/quality/scripts/quality_run_plan_render.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/debug/2026-09-11-quality-catalog-repo-native-default.md, charness-artifacts/debug/latest.md, skills/public/quality/references/adapter-contract.md
...
- debug-seam-risk-index: Generated source-linked index over debug artifact seam-risk fields.
  source matches: charness-artifacts/debug/2026-09-11-quality-catalog-repo-native-default.md, charness-artifacts/debug/latest.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_quality_declaration_path_resolution.py, tests/quality_gates/test_quality_run_planner.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: skills/public/quality/scripts/plan_quality_run.py, skills/public/quality/scripts/quality_catalog_gate_applicability.py, skills/public/quality/scripts/quality_declaration_lifecycle.py, skills/public/quality/scripts/quality_run_plan_render.py
