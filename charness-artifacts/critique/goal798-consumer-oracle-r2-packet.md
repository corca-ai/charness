...
- **Generated**: 2026-09-06T00:32:43Z
- **Prepared for**: working tree
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `09e838386924c5a62a33fc5c1f3eef493d9b8c4941674bd715542d3937b69970`
- **Reviewed paths**: 20
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/goal798-consumer-oracle-r2-packet.json --packet-sha256 edc61bbc4d56b18058dfa741a4144ec818d43630fad069906bc441cd9fc7ee2a --identity-sha256 09e838386924c5a62a33fc5c1f3eef493d9b8c4941674bd715542d3937b69970
```
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/probe/2026-09-06-consumer-journeys/protocol.md, evals/fixtures/consumer-journeys/create-cli-refresh/prompts/create-cli.md, evals/fixtures/consumer-journeys/spec-impl-alias/prompts/spec.md, charness-artifacts/critique/goal798-code-contracts-packet.md, charness-artifacts/critique/goal798-consumer-oracle-packet.md
  verify: ./scripts/check-docs.sh, ./scripts/check-secrets.sh
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/goal798-code-contracts-packet.json, charness-artifacts/critique/goal798-code-contracts-packet.md, charness-artifacts/critique/goal798-consumer-oracle-packet.json, charness-artifacts/critique/goal798-consumer-oracle-packet.md, charness-artifacts/critique/workers/goal798-code-contracts/worker-report.yaml
...
- probe-artifacts: Checked-in host/runtime probe JSON artifacts used as closeout evidence.
  source matches: charness-artifacts/probe/2026-09-06-consumer-journeys/freeze.json, charness-artifacts/probe/2026-09-06-consumer-journeys/oracle-review-1.json, charness-artifacts/probe/2026-09-06-consumer-journeys/seed-disconfirmation.json
