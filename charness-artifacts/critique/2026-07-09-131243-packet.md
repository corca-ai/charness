...
- **Generated**: 2026-07-09T13:12:43Z
- **Prepared for**: autonomous-quality-repair
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/run_skill_efficiency_ab.py, skills/support/markdown-preview/scripts/markdown_preview_lib.py
  derived matches: plugins/charness/scripts/run_skill_efficiency_ab.py, plugins/charness/support/markdown-preview/scripts/markdown_preview_lib.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/quality/latest.md, charness-artifacts/quality/2026-07-09-autonomous-quality-repair.md
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/support/markdown-preview/scripts/markdown_preview_lib.py
  derived matches: plugins/charness/support/markdown-preview/scripts/markdown_preview_lib.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/run_skill_efficiency_ab.py, tests/test_markdown_preview_support.py, tests/test_skill_efficiency_ab.py
  derived matches: plugins/charness/scripts/run_skill_efficiency_ab.py
...
- Consumer: scorer fallback, committed efficiency artifacts, and markdown-preview renderer.
