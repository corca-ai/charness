...
- **Generated**: 2026-07-20T11:18:13Z
- **Prepared for**: dup-ratchet scoped rebaseline evaluate-parity fix (#448)
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `a3226858e92d987c058828331c102209dd4b62457600385ba253367c16eb758a`
- **Reviewed paths**: 7
- **Sections**: 2
- **Overall ok**: True
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  ...
  derived matches: plugins/charness/skills/quality/scripts/check_dup_ratchet.py, plugins/charness/skills/quality/scripts/dup_ratchet_lib.py, plugins/charness/skills/quality/scripts/dup_ratchet_scan.py
