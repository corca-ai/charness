...
- **Generated**: 2026-07-18T09:28:09Z
- **Prepared for**: v2.1.1 quality-infrastructure slice
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/mutation_coverage_producer.py, scripts/run_slice_closeout.py, skills/public/quality/scripts/inventory_doc_duplicates.py, skills/public/quality/scripts/inventory_nose_clones.py, skills/public/quality/scripts/nose_report_lib.py, skills/public/quality/scripts/nose_tool_lib.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/mutation_coverage_producer.py, scripts/run_slice_closeout.py, tests/quality_gates/support.py, tests/quality_gates/test_mutation_coverage_producer.py, tests/quality_gates/test_quality_runner.py, tests/test_doc_duplicates_inprocess_coverage.py, tests/test_nose_inprocess_coverage.py
