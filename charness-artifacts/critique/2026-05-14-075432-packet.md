...
- **Generated**: 2026-05-14T07:54:32Z
- **Prepared for**: slice-3-upstream-support-drift-gate
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/check_upstream_support_drift.py
  derived matches: plugins/charness/scripts/check_upstream_support_drift.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/control_plane/test_upstream_support_drift.py
