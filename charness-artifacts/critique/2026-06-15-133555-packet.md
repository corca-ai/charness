...
- **Generated**: 2026-06-15T13:35:55Z
- **Prepared for**: staged-commit-gate-plan-split
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/staged_commit_gate_plan.py, scripts/staged_commit_gate_plan_helpers.py
  derived matches: plugins/charness/scripts/staged_commit_gate_plan.py, plugins/charness/scripts/staged_commit_gate_plan_helpers.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/quality/latest.md
