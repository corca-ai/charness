...
- **Generated**: 2026-06-22T22:38:14Z
- **Prepared for**: quality reference engagement classification
...
- evals/cautilus/quality-claim-fidelity/spec.json

Owning surfaces:
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/spec/2026-06-23-skill-claim-fidelity-doc-philosophy.md
...
- prompt-behavior-proof: Prompt-affecting instruction surfaces must follow deterministic Cautilus validation and on-demand proof policy.
  source matches: evals/cautilus/quality-claim-fidelity/spec.json
