...
- **Generated**: 2026-07-11T10:30:04Z
- **Prepared for**: truthful standing delegation implementation diff
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/setup_agent_docs_fresh_eye_lib.py, skills/public/quality/scripts/skill_text_quality_lib.py, skills/public/setup/references/agent-docs-policy.md
  derived matches: plugins/charness/scripts/setup_agent_docs_fresh_eye_lib.py, plugins/charness/skills/quality/scripts/skill_text_quality_lib.py, plugins/charness/skills/setup/references/agent-docs-policy.md
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: AGENTS.md, docs/operator-progressive-path.md, skills/public/setup/references/agent-docs-policy.md, charness-artifacts/critique/2026-07-11-101842-packet.md
  derived matches: plugins/charness/skills/setup/references/agent-docs-policy.md
...
- prompt-behavior-proof: Prompt-affecting instruction surfaces must follow deterministic Cautilus validation and on-demand proof policy.
  source matches: AGENTS.md, skills/public/setup/references/agent-docs-policy.md
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/quality/scripts/skill_text_quality_lib.py, skills/public/setup/references/agent-docs-policy.md
  derived matches: plugins/charness/skills/quality/scripts/skill_text_quality_lib.py, plugins/charness/skills/setup/references/agent-docs-policy.md
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-07-11-101842-packet.json, charness-artifacts/critique/2026-07-11-101842-packet.md
  verify: python3 scripts/validate_critique_artifacts.py --repo-root . --all
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/setup_agent_docs_fresh_eye_lib.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/setup_agent_docs_fresh_eye_lib.py, tests/quality_gates/test_setup_inspect_policy.py, tests/test_skill_text_quality_lib.py
  derived matches: plugins/charness/scripts/setup_agent_docs_fresh_eye_lib.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: scripts/setup_agent_docs_fresh_eye_lib.py, skills/public/quality/scripts/skill_text_quality_lib.py
