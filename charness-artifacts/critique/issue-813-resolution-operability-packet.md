...
- **Generated**: 2026-09-12T12:25:13Z
- **Prepared for**: working tree
- **Prepared targets**: 1
  - `corca-ai/charness#813`
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `e2903a3d6e63ffaae7abc7cd11e43d69fa9d6b116d9238e83148d9b1e160683e`
- **Reviewed paths**: 11
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/issue-813-resolution-operability-packet.json --packet-sha256 d2a196cffe726c5a0ef04f4da5f5d9912e4dbd414ce7ea76e43552e1f591c93e --identity-sha256 e2903a3d6e63ffaae7abc7cd11e43d69fa9d6b116d9238e83148d9b1e160683e
```
...
- materialized-plugin-export: Materialized plugin export and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/agent-runtime/run-local-eval-test.mjs, scripts/exported-copy-guard.sh, scripts/gates/check_temp_producer_inventory.py, scripts/gates/run_owned_scratch_command.py, scripts/gates/temp_producer_inventory_lib.py, scripts/run_quality_engine_runtime.py
...
- agent-runtime-js: Repo-owned JavaScript agent-runtime modules and their native test command.
  source matches: scripts/agent-runtime/run-local-eval-test.mjs
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/gates/check_temp_producer_inventory.py, scripts/gates/run_owned_scratch_command.py, scripts/gates/temp_producer_inventory_lib.py, scripts/run_quality_engine_runtime.py, tests/test_runtime_scratch.py, tests/test_temp_producer_inventory.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: scripts/gates/check_temp_producer_inventory.py, scripts/gates/run_owned_scratch_command.py, scripts/gates/temp_producer_inventory_lib.py, scripts/run_quality_engine_runtime.py
