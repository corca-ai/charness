...
- **Generated**: 2026-07-10T07:02:55Z
- **Prepared for**: 432-resolution-critique
...
- plugins/charness/skills/hotl/references/proof-rules.md
- plugins/charness/skills/release/scripts/publish_release_plan.py
- plugins/charness/skills/release/scripts/publish_release_preflight.py
- scripts/staged_commit_gate_plan.py
- skills/public/hotl/references/proof-rules.md
...
- plugins/charness/scripts/check_git_identity.py
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/staged_commit_gate_plan.py, skills/public/hotl/references/proof-rules.md, skills/public/release/scripts/publish_release_plan.py, skills/public/release/scripts/publish_release_preflight.py, scripts/check_git_identity.py
  derived matches: plugins/charness/scripts/staged_commit_gate_plan.py, plugins/charness/skills/hotl/references/proof-rules.md, plugins/charness/skills/release/scripts/publish_release_plan.py, plugins/charness/skills/release/scripts/publish_release_preflight.py, plugins/charness/scripts/check_git_identity.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: skills/public/hotl/references/proof-rules.md
  derived matches: plugins/charness/skills/hotl/references/proof-rules.md
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/hotl/references/proof-rules.md, skills/public/release/scripts/publish_release_plan.py, skills/public/release/scripts/publish_release_preflight.py
  derived matches: plugins/charness/skills/hotl/references/proof-rules.md, plugins/charness/skills/release/scripts/publish_release_plan.py, plugins/charness/skills/release/scripts/publish_release_preflight.py
...
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/staged_commit_gate_plan.py, plugins/charness/scripts/check_git_identity.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/staged_commit_gate_plan.py, tests/quality_gates/test_release_publish_resilience.py, tests/quality_gates/test_staged_commit_gate_plan.py, scripts/check_git_identity.py, tests/quality_gates/test_check_git_identity.py
  derived matches: plugins/charness/scripts/staged_commit_gate_plan.py, plugins/charness/scripts/check_git_identity.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: scripts/staged_commit_gate_plan.py, skills/public/release/scripts/publish_release_plan.py, skills/public/release/scripts/publish_release_preflight.py, scripts/check_git_identity.py
...
parent-delegated — the parent consumed this packet, then ran three
independent angle reviewers (problem framing, diagnostic, operational) and a
separate counterweight reviewer over the #432 resolution diff.

## Boundary Ownership

- Producer: the #432 identity-guard diff (commit gate, release preflight,
  hotl rule).
- Consumer: the bounded angle/counterweight reviewers that consumed this
  packet.
- Owning surface: charness-artifacts/critique/2026-07-10-432-resolution-critique.md
  records the reviewed verdict.
