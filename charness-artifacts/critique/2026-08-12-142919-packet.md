...
- **Generated**: 2026-08-12T14:29:19Z
- **Prepared for**: Issue 584 accepted SessionStart routing repair closeout
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `ce2307ae05bb2ccd46ae070bd7441c1a858cead92cde4394756bf96af7827adb`
- **Reviewed paths**: 5
- **Sections**: 3
- **Overall ok**: True
...
- charness-artifacts/critique/2026-08-12-142808-packet.json
- charness-artifacts/critique/2026-08-12-142808-packet.md
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/session_start_routing.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/critique/2026-08-12-142808-packet.md, charness-artifacts/critique/2026-08-12-issue-584-sessionstart-routing-repair-critique.md, charness-artifacts/debug/2026-08-12-issue-584-sessionstart-routing-debug.md, charness-artifacts/debug/latest.md
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-08-12-142808-packet.json, charness-artifacts/critique/2026-08-12-142808-packet.md, charness-artifacts/critique/2026-08-12-issue-584-sessionstart-routing-repair-critique.md
  verify: python3 scripts/validate_critique_artifacts.py --repo-root . --all
- debug-seam-risk-index: Generated source-linked index over debug artifact seam-risk fields.
  source matches: charness-artifacts/debug/2026-08-12-issue-584-sessionstart-routing-debug.md, charness-artifacts/debug/latest.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/session_start_routing.py, tests/test_session_start_routing.py
  derived matches: plugins/charness/scripts/session_start_routing.py
