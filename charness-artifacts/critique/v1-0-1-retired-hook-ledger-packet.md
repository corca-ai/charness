...
- **Prepared for**: v1.0.1 retired hook ledger cleanup
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/host_hook_session_routing.py
  derived matches: plugins/charness/scripts/host_hook_session_routing.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/debug/2026-07-13-debug-review.md, charness-artifacts/debug/latest.md, charness-artifacts/spec/2026-07-13-retired-hook-ledger-cleanup.md
...
- debug-seam-risk-index: Generated source-linked index over debug artifact seam-risk fields.
  source matches: charness-artifacts/debug/2026-07-13-debug-review.md, charness-artifacts/debug/latest.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/host_hook_session_routing.py, tests/test_session_routing_host_hook_reconcile.py
  derived matches: plugins/charness/scripts/host_hook_session_routing.py
