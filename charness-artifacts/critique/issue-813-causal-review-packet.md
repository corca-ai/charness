...
- **Generated**: 2026-09-12T10:45:29Z
- **Prepared for**: issue 813 causal review before design
- **Prepared targets**: 1
  - `https://github.com/corca-ai/charness/issues/813`
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `65c7e5db9265d28776a9e0c01d0281b3452afb6bdd51291b47107dcf46e915b0`
- **Reviewed paths**: 12
  ...
  - `tests/test_runtime_scratch_failures.py`
...
```sh
python3 /home/hwidong/.codex/plugins/cache/local/charness/8.6.3/skills/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/issue-813-causal-review-packet.json --packet-sha256 94a9dbfd918e2bb4d7f180a2bc11585cd17d49787afa2751b9b741a3b7783ec2 --identity-sha256 65c7e5db9265d28776a9e0c01d0281b3452afb6bdd51291b47107dcf46e915b0
```
...
- materialized-plugin-export: Materialized plugin export and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/agent-runtime/run-local-eval-test.mjs, scripts/check-links-external.sh, scripts/check-links-internal.sh, scripts/check-markdown.sh, scripts/check-python-lint.sh, scripts/check-secrets.sh, scripts/check-shell.sh, scripts/runtime_scratch.py, scripts/runtime_scratch_registry.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/runtime_scratch.py, scripts/runtime_scratch_registry.py, tests/test_runtime_scratch.py, tests/test_runtime_scratch_failures.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: scripts/runtime_scratch.py, scripts/runtime_scratch_registry.py
