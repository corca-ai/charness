...
- **Generated**: 2026-07-11T11:50:36Z
- **Prepared for**: Slice C delete superseded release-only regex
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/quality/scripts/surface_marker_lib.py
  derived matches: plugins/charness/skills/quality/scripts/surface_marker_lib.py
