...
- **Generated**: 2026-08-26T00:54:58Z
- **Prepared for**: Codex compact recovery hook
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `a61eff190b87fe30307ad7104647a61da7d92e89b7b8467c133264b7a06d2e56`
- **Reviewed paths**: 5
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/2026-08-26-005458-packet.json --packet-sha256 cae980ddc0ddd63219f2b888fdc02bf9c8459d908a709a1d9189f62e8406e309 --identity-sha256 a61eff190b87fe30307ad7104647a61da7d92e89b7b8467c133264b7a06d2e56
```
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/session_start_routing.py, scripts/session_start_codex_recovery.py
  derived matches: plugins/charness/scripts/session_start_routing.py, plugins/charness/scripts/session_start_codex_recovery.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/session_start_routing.py, tests/test_session_start_routing.py, scripts/session_start_codex_recovery.py
  derived matches: plugins/charness/scripts/session_start_routing.py, plugins/charness/scripts/session_start_codex_recovery.py
