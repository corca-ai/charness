...
charness_exec_owned_scratch check-links-internal "$CHARNESS_GATE_DIR/check-links-internal.sh" "$@"
...
listing_dir="$CHARNESS_OWNED_SCRATCH_ROOT/check-links-internal"
mkdir -p "$listing_dir"
