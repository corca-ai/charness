...
- **Generated**: 2026-09-05T03:44:28Z
- **Prepared for**: e87cb5ecc05641f0d7599d43933ea10e9a51ee70
- **Substrate mode**: `committed-ref`
- **Changed ref**: `e87cb5ecc05641f0d7599d43933ea10e9a51ee70`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `bf1fd273137af32be79b2137db7003263489ffd7d2c709747a037115e63d030b`
- **Reviewed paths**: 14
  - `charness-artifacts/critique/2026-09-05-release-8-4-3.md`
  - `charness-artifacts/critique/release-8-4-3-ops-r2c-dry-packet.json`
  - `charness-artifacts/critique/release-8-4-3-ops-r2c-dry-packet.md`
  - `charness-artifacts/critique/release-8-4-3-surface-r2c-dry-packet.json`
  - `charness-artifacts/critique/release-8-4-3-surface-r2c-dry-packet.md`
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/release-8-4-3-repair-form-dry-packet.json --packet-sha256 4da914801070912223277c91005504ad85b0ebdb01df2cd4861c2b97469708c0 --identity-sha256 bf1fd273137af32be79b2137db7003263489ffd7d2c709747a037115e63d030b
```
...
```text
Changed paths for ref `e87cb5ecc05641f0d7599d43933ea10e9a51ee70`:
- charness-artifacts/critique/2026-09-05-release-8-4-3.md
- charness-artifacts/critique/release-8-4-3-ops-r2c-dry-packet.json
- charness-artifacts/critique/release-8-4-3-ops-r2c-dry-packet.md
- charness-artifacts/critique/release-8-4-3-surface-r2c-dry-packet.json
...
- materialized-plugin-export: Materialized plugin export and root marketplace artifacts derived from repo-owned source paths.
  source matches: integrations/tools/manifest.schema.json, scripts/adapters/control_plane_lifecycle_lib.py, scripts/hooks/check_staged_cheap_owners.py, scripts/install_tools.py, scripts/update_tools.py, skills/public/spec/references/taxonomy-axis-checkpoint.md
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/critique/2026-09-05-release-8-4-3.md, charness-artifacts/critique/release-8-4-3-ops-r2c-dry-packet.md, charness-artifacts/critique/release-8-4-3-surface-r2c-dry-packet.md, docs/validator-timing-layers.md, skills/public/spec/references/taxonomy-axis-checkpoint.md
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/spec/references/taxonomy-axis-checkpoint.md
...
- adapters: Repo-local adapter contracts and adapter helper libraries.
  source matches: scripts/adapters/control_plane_lifecycle_lib.py
  verify: python3 scripts/gates/validate_adapters.py --repo-root .
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-09-05-release-8-4-3.md, charness-artifacts/critique/release-8-4-3-ops-r2c-dry-packet.json, charness-artifacts/critique/release-8-4-3-ops-r2c-dry-packet.md, charness-artifacts/critique/release-8-4-3-surface-r2c-dry-packet.json, charness-artifacts/critique/release-8-4-3-surface-r2c-dry-packet.md
...
- external-tool-control-plane: External tool manifests and install, update, doctor, support-sync, and upstream-release helpers whose behavior depends on host state.
  source matches: integrations/tools/manifest.schema.json, scripts/adapters/control_plane_lifecycle_lib.py, scripts/install_tools.py, scripts/update_tools.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/adapters/control_plane_lifecycle_lib.py, scripts/hooks/check_staged_cheap_owners.py, scripts/install_tools.py, scripts/update_tools.py, tests/control_plane/test_integrations_validation.py, tests/quality_gates/test_staged_cheap_owners.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: scripts/adapters/control_plane_lifecycle_lib.py, scripts/hooks/check_staged_cheap_owners.py, scripts/install_tools.py, scripts/update_tools.py
