...
- **Generated**: 2026-08-05T05:46:52Z
- **Prepared for**: issue-506-resolution-critique
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `f2ac69d10ab1d4d9a9797d554263bd719ed670e61985e80612d7f81d37afb418`
- **Reviewed paths**: 7
- **Sections**: 3
- **Overall ok**: True
...
- charness-artifacts/debug/2026-08-05-debug-review.md
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/shared/scripts/reviewer_boundary_fingerprint.py
  derived matches: plugins/charness/shared/scripts/reviewer_boundary_fingerprint.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/debug/latest.md, docs/conventions/operating-contract.md, charness-artifacts/debug/2026-08-05-debug-review.md
...
- debug-seam-risk-index: Generated source-linked index over debug artifact seam-risk fields.
  source matches: charness-artifacts/debug/latest.md, charness-artifacts/debug/2026-08-05-debug-review.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_parity_harness.py, tests/quality_gates/test_reviewer_boundary_fingerprint.py
