...
- **Generated**: 2026-08-05T07:12:42Z
- **Prepared for**: Issue
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `ef0b193fbc905fa0fd87e11ffedbed33de10485a16dbd2e4a0e8e8af266ee594`
- **Reviewed paths**: 20
- **Sections**: 3
- **Overall ok**: True
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/quality_bootstrap_absence.py, scripts/quality_bootstrap_lib.py, skills/public/quality/SKILL.md, skills/public/quality/references/bootstrap-posture.md, skills/public/quality/scripts/bootstrap_adapter.py, scripts/quality_bootstrap_lifecycle.py
  derived matches: plugins/charness/scripts/quality_bootstrap_absence.py, plugins/charness/scripts/quality_bootstrap_lib.py, plugins/charness/skills/quality/SKILL.md, plugins/charness/skills/quality/references/bootstrap-posture.md, plugins/charness/skills/quality/scripts/bootstrap_adapter.py, plugins/charness/scripts/quality_bootstrap_lifecycle.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/debug/latest.md, charness-artifacts/quality/latest.md, skills/public/quality/SKILL.md, skills/public/quality/references/bootstrap-posture.md, charness-artifacts/debug/2026-08-05-debug-review-followup.md, charness-artifacts/quality/2026-08-05-issue-507-quality-adapter-lifecycle.md, charness-artifacts/spec/2026-08-05-issue-507-quality-adapter-lifecycle.md
...
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/quality_bootstrap_absence.py, plugins/charness/scripts/quality_bootstrap_lib.py, plugins/charness/scripts/quality_bootstrap_lifecycle.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/quality_bootstrap_absence.py, scripts/quality_bootstrap_lib.py, tests/quality_gates/test_quality_bootstrap.py, tests/quality_gates/test_quality_bootstrap_absence.py, scripts/quality_bootstrap_lifecycle.py
  derived matches: plugins/charness/scripts/quality_bootstrap_absence.py, plugins/charness/scripts/quality_bootstrap_lib.py, plugins/charness/scripts/quality_bootstrap_lifecycle.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: scripts/quality_bootstrap_absence.py, scripts/quality_bootstrap_lib.py, skills/public/quality/scripts/bootstrap_adapter.py, scripts/quality_bootstrap_lifecycle.py
