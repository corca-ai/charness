...
- **Generated**: 2026-07-27T11:06:57Z
- **Prepared for**: provenance containment exemption removal (A1/A2) — final
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `5a2b83b8e56777ba17b1d6e4596d15f8753a81ecba9c0cf86ad59071d0c8f622`
- **Reviewed paths**: 8
- **Sections**: 2
- **Overall ok**: True
...
- charness-artifacts/spec/2026-07-27-foreign-copy-write-enforcement.md
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/helper_provenance_lib.py, skills/shared/references/bootstrap-resolution.md
  derived matches: plugins/charness/scripts/helper_provenance_lib.py, plugins/charness/shared/references/bootstrap-resolution.md
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/audit/2026-07-27-evidence-surface-bug-hunt.md, charness-artifacts/critique/2026-07-27-104618-packet.md, charness-artifacts/critique/2026-07-27-provenance-containment-packet.md, charness-artifacts/critique/2026-07-27-provenance-containment.md, charness-artifacts/spec/2026-07-27-foreign-copy-write-enforcement.md, skills/shared/references/bootstrap-resolution.md
...
- prompt-behavior-proof: Prompt-affecting instruction surfaces must follow deterministic Cautilus validation and on-demand proof policy.
  source matches: skills/shared/references/bootstrap-resolution.md
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-07-27-104618-packet.json, charness-artifacts/critique/2026-07-27-104618-packet.md, charness-artifacts/critique/2026-07-27-provenance-containment-packet.json, charness-artifacts/critique/2026-07-27-provenance-containment-packet.md, charness-artifacts/critique/2026-07-27-provenance-containment.md
  verify: python3 scripts/validate_critique_artifacts.py --repo-root . --all
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/helper_provenance_lib.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/helper_provenance_lib.py, tests/quality_gates/test_helper_provenance_guard.py
  derived matches: plugins/charness/scripts/helper_provenance_lib.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: scripts/helper_provenance_lib.py
