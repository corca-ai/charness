...
- **Generated**: 2026-07-14T05:24:32Z
- **Prepared for**: final Claude and Codex reviewer-boundary portability critique
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  ...
  derived matches: plugins/charness/scripts/packaging_lib.py, plugins/charness/shared/references/fresh-eye-subagent-review.md, plugins/charness/agents/bounded-reviewer.md
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/spec/2026-07-14-skill-directory-shell-bootstrap.md, docs/host-packaging.md, skills/shared/references/fresh-eye-subagent-review.md, charness-artifacts/critique/2026-07-14-051911-packet.md
  derived matches: plugins/charness/shared/references/fresh-eye-subagent-review.md, plugins/charness/agents/bounded-reviewer.md
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-07-14-051911-packet.json, charness-artifacts/critique/2026-07-14-051911-packet.md
