...
- **Generated**: 2026-07-15T02:26:04Z
- **Prepared for**: session routing and installed catalog CLI fix
...
- charness-artifacts/debug/2026-07-15-session-routing-catalog-cli-debug.md
- charness-artifacts/retro/2026-07-15-021844-packet.json
- charness-artifacts/retro/2026-07-15-021844-packet.md
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/session_start_routing.py, skills/public/setup/scripts/render_skill_routing.py
  derived matches: plugins/charness/scripts/session_start_routing.py, plugins/charness/skills/setup/scripts/render_skill_routing.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: AGENTS.md, charness-artifacts/debug/latest.md, charness-artifacts/retro/recent-lessons.md, charness-artifacts/debug/2026-07-15-session-routing-catalog-cli-debug.md, charness-artifacts/retro/2026-07-15-021844-packet.md, charness-artifacts/retro/2026-07-15-session-routing-catalog-cli-regression.md
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/setup/scripts/render_skill_routing.py
  derived matches: plugins/charness/skills/setup/scripts/render_skill_routing.py
...
- debug-seam-risk-index: Generated source-linked index over debug artifact seam-risk fields.
  source matches: charness-artifacts/debug/latest.md, charness-artifacts/debug/2026-07-15-session-routing-catalog-cli-debug.md
...
- retro-lesson-selection-index: Durable retro prepare packets and generated advisory index for source-linked retro lesson digest selection.
  source matches: charness-artifacts/retro/recent-lessons.md, charness-artifacts/retro/2026-07-15-021844-packet.json, charness-artifacts/retro/2026-07-15-021844-packet.md, charness-artifacts/retro/2026-07-15-session-routing-catalog-cli-regression.md
...
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/session_start_routing.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: charness, scripts/session_start_routing.py, tests/charness_cli/test_codex_cache_refresh.py, tests/quality_gates/test_setup_render_skill_routing.py, tests/test_session_start_routing.py
  derived matches: plugins/charness/scripts/session_start_routing.py
