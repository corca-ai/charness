...
- **Generated**: 2026-07-18T04:58:13Z
- **Prepared for**: autonomous quality efficiency slice
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/artifact_closeout_lib.py, scripts/capability_catalog.py, scripts/session_start_routing.py, scripts/tool_recommendation_lib.py, skills/public/issue/scripts/issue_verify_closeout_body.py, skills/public/release/scripts/publish_release_post_create.py, skills/public/setup/scripts/render_skill_routing.py
  derived matches: plugins/charness/scripts/artifact_closeout_lib.py, plugins/charness/scripts/capability_catalog.py, plugins/charness/scripts/session_start_routing.py, plugins/charness/scripts/tool_recommendation_lib.py, plugins/charness/skills/issue/scripts/issue_verify_closeout_body.py, plugins/charness/skills/release/scripts/publish_release_post_create.py, plugins/charness/skills/setup/scripts/render_skill_routing.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: AGENTS.md, docs/generated/cli-reference.md
...
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/artifact_closeout_lib.py, plugins/charness/scripts/capability_catalog.py, plugins/charness/scripts/session_start_routing.py, plugins/charness/scripts/tool_recommendation_lib.py
