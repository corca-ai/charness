...
- **Generated**: 2026-07-09T23:53:17Z
- **Prepared for**: plain version read-only behavior in HEAD
- **Changed ref**: `HEAD`
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/critique/2026-07-10-repo-wide-quality-speed-code-critique.md, charness-artifacts/critique/2026-07-10-repo-wide-quality-speed-code-packet.md, charness-artifacts/critique/2026-07-10-repo-wide-quality-speed-plan-critique.md, charness-artifacts/critique/2026-07-10-repo-wide-quality-speed-plan-packet.md, charness-artifacts/goals/2026-07-10-repo-wide-quality-speed-release.md
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-07-10-repo-wide-quality-speed-code-critique.md, charness-artifacts/critique/2026-07-10-repo-wide-quality-speed-code-packet.json, charness-artifacts/critique/2026-07-10-repo-wide-quality-speed-code-packet.md, charness-artifacts/critique/2026-07-10-repo-wide-quality-speed-plan-critique.md, charness-artifacts/critique/2026-07-10-repo-wide-quality-speed-plan-packet.json, charness-artifacts/critique/2026-07-10-repo-wide-quality-speed-plan-packet.md
...
parent-delegated — the parent ran independent CLI-contract and version-state
reviewers plus a separate counterweight pass after this packet was consumed.

## Boundary Ownership

- Producer: root CLI plain and detailed version modes.
- Consumer: operator version probes and version-state/update consumers.
- Owning surface: root `charness` version dispatcher and focused CLI tests.
