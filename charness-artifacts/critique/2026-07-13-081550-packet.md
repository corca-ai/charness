...
- **Generated**: 2026-07-13T08:15:50Z
- **Prepared for**: round-5 capability-catalog invalid repo-root fix
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/debug/latest.md, charness-artifacts/debug/2026-07-13-debug-review-followup-3.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: charness, scripts/capability_catalog.py, tests/charness_cli/test_codex_cache_refresh.py, tests/test_capability_catalog.py
  derived matches: plugins/charness/scripts/capability_catalog.py
