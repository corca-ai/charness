...
- **Generated**: 2026-09-07T22:36:23Z
- **Prepared for**: resolved-debug-risk-lifecycle
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `00759476a90cb6425418d34fd125126765674a9686370d6ba5d2119b1e202498`
- **Reviewed paths**: 8
  - `charness-artifacts/debug/2026-09-08-consumer-path-and-pytest.md`
  - `charness-artifacts/spec/2026-09-08-reference-and-suite.md`
  - `scripts/gates_support/risk_interrupt_lib.py`
  - `skills/public/debug/SKILL.md`
  - `skills/public/debug/scripts/debug_artifact_declarations.py`
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/resolved-debug-risk-operability-20260908-packet.json --packet-sha256 dd1b17f17b97ab1f8fa887c34e542aa8aa7b57af4d5f43f6593d63fb952a0799 --identity-sha256 00759476a90cb6425418d34fd125126765674a9686370d6ba5d2119b1e202498
```
...
- charness-artifacts/critique/.preview-resolved-debug-risk-contract-20260908-packet.json
- charness-artifacts/critique/.preview-resolved-debug-risk-contract-20260908-packet.md

Owning surfaces:
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/critique/.preview-resolved-debug-risk-contract-20260908-packet.md
  verify: ./scripts/check-docs.sh, ./scripts/check-secrets.sh
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/.preview-resolved-debug-risk-contract-20260908-packet.json, charness-artifacts/critique/.preview-resolved-debug-risk-contract-20260908-packet.md
