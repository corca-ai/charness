...
- **Generated**: 2026-08-25T22:07:55Z
- **Prepared for**: 7eaa46939 reduction-first verification
- **Substrate mode**: `committed-ref`
- **Changed ref**: `HEAD^..HEAD`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `2022b6abbdc99400a47ab6427b6a54054f219d1f745c87a4e030af03cb80e8b7`
- **Reviewed paths**: 11
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/2026-08-26-reduction-first-verification-packet.json --packet-sha256 f6e6f5c460fbe300e12d434a60d64bf25aa7d15346470a45adcfd98d7c8cd23a --identity-sha256 2022b6abbdc99400a47ab6427b6a54054f219d1f745c87a4e030af03cb80e8b7
```
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/critique/SKILL.md, skills/public/critique/references/cadence.md, skills/public/critique/scripts/scaffold_critique_artifact.py, skills/public/quality/SKILL.md, skills/public/release/SKILL.md
  derived matches: plugins/charness/skills/critique/SKILL.md, plugins/charness/skills/critique/references/cadence.md, plugins/charness/skills/critique/scripts/scaffold_critique_artifact.py, plugins/charness/skills/quality/SKILL.md, plugins/charness/skills/release/SKILL.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/test_critique_scaffold.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: skills/public/critique/scripts/scaffold_critique_artifact.py
