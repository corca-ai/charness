...
- **Generated**: 2026-08-12T02:51:04Z
- **Prepared for**: shown-set-repaired-surface
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `018aa0c1602c5aca5ef847b822423b368bd6abc0605a04073a59f551e9bab184`
- **Reviewed paths**: 14
- **Sections**: 3
- **Overall ok**: True
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/lesson_ledger_lib.py, scripts/lesson_selection_preview_lib.py, scripts/record_lesson_score.py, scripts/lesson_ledger_writer_lib.py, scripts/record_lesson_session.py
  derived matches: plugins/charness/scripts/lesson_ledger_lib.py, plugins/charness/scripts/lesson_selection_preview_lib.py, plugins/charness/scripts/record_lesson_score.py, plugins/charness/scripts/lesson_ledger_writer_lib.py, plugins/charness/scripts/record_lesson_session.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/goals/2026-08-12-shown-set-session-records.md, docs/development.md
...
- lesson-ledger-and-contract-register: Local cited lesson state and the explicit pre-contract-mutation register probe.
  source matches: charness-artifacts/retro/lesson-ledger.json, scripts/lesson_ledger_lib.py, scripts/record_lesson_score.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/lesson_ledger_lib.py, scripts/lesson_selection_preview_lib.py, scripts/record_lesson_score.py, tests/test_lesson_ledger.py, scripts/lesson_ledger_writer_lib.py, scripts/record_lesson_session.py
  derived matches: plugins/charness/scripts/lesson_ledger_lib.py, plugins/charness/scripts/lesson_selection_preview_lib.py, plugins/charness/scripts/record_lesson_score.py, plugins/charness/scripts/lesson_ledger_writer_lib.py, plugins/charness/scripts/record_lesson_session.py
