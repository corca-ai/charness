...
- **Generated**: 2026-08-29T23:38:05Z
- **Prepared for**: dc77742f2..e59bc71e7
- **Substrate mode**: `committed-ref`
- **Changed ref**: `dc77742f2..e59bc71e7`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `bf941af88820921f83d193827fc5cc72182afc02d51a1a32367dfe982d14272f`
- **Reviewed paths**: 8
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/review-20260830T083804Z-3390404-packet.json --packet-sha256 857c8c54920a9eb94240355d859497831c3b3651acd8edd55c574ff4b21b25ae --identity-sha256 bf941af88820921f83d193827fc5cc72182afc02d51a1a32367dfe982d14272f
```
...
```text
Changed paths for ref `dc77742f2..e59bc71e7`:
- charness-artifacts/critique/review-20260830T082954Z-3258490-packet.json
- charness-artifacts/critique/review-20260830T082954Z-3258490-packet.md
- charness-artifacts/retro/2026-08-30-session-retro.md
- charness-artifacts/retro/lesson-selection-index.json
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/reviewed_input_nonblob.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/critique/review-20260830T082954Z-3258490-packet.md, charness-artifacts/retro/2026-08-30-session-retro.md, charness-artifacts/retro/recent-lessons.md
  verify: ./scripts/check-docs.sh, ./scripts/check-secrets.sh
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/review-20260830T082954Z-3258490-packet.json, charness-artifacts/critique/review-20260830T082954Z-3258490-packet.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/reviewed_input_nonblob.py, tests/test_reviewed_input_identity_binding.py
