...
- **Generated**: 2026-07-13T08:29:43Z
- **Prepared for**: round-5 custom-home Claude subprocess binding
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/debug/2026-07-13-custom-home-claude-state-leakage.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: charness, tests/charness_cli/test_managed_install.py
