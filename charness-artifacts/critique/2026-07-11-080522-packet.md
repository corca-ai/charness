...
- **Generated**: 2026-07-11T08:05:22Z
- **Prepared for**: web-fetch argparse help code review
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/support/web-fetch/scripts/acquire_public_url.py, skills/support/web-fetch/scripts/classify_fetch_response.py, skills/support/web-fetch/scripts/route_public_fetch.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/test_web_fetch_help.py
