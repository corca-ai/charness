...
- **Generated**: 2026-09-14T05:12:55Z
- **Prepared for**: v8.6.5 release critique
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `329366b830f1adc1a7c8f9daa5d5bbd3223b866e50efc7ee7cdc490d12b094c3`
- **Reviewed paths**: 8
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/2026-09-14-v865-release-packet.json --packet-sha256 e131e86af2b75378e2869de68aad85f777b3f5d27e3cf71ca04822e34765cd9f --identity-sha256 329366b830f1adc1a7c8f9daa5d5bbd3223b866e50efc7ee7cdc490d12b094c3
```
...
- materialized-plugin-export: Materialized plugin export and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/core/git_checkout.py, scripts/lessons/lesson_ledger_writer_lib.py, scripts/review/reviewed_input_verification.py, skills/public/critique/scripts/run_review_hold_out.py
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/critique/scripts/run_review_hold_out.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/core/git_checkout.py, scripts/lessons/lesson_ledger_writer_lib.py, scripts/review/reviewed_input_verification.py, tests/test_git_checkout.py, tests/test_lesson_ledger.py, tests/test_reviewed_input_identity_failures.py, tests/test_run_review_declared_path_resolution.py
