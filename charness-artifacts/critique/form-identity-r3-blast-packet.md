...
- **Generated**: 2026-09-05T02:57:43Z
- **Prepared for**: 7a8c303246dff1846eaf4862804ecf69a2a5b3c7
- **Substrate mode**: `committed-ref`
- **Changed ref**: `7a8c303246dff1846eaf4862804ecf69a2a5b3c7`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `b8adaf3966d99ac38fed4aaa31bc465719c957b903b86d0f520d38dfc242d51c`
- **Reviewed paths**: 4
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/form-identity-r3-blast-packet.json --packet-sha256 6865e45e02c83cd36a5c27f4f84f371d8bff35561156add1bfb9a30fc7b5a309 --identity-sha256 b8adaf3966d99ac38fed4aaa31bc465719c957b903b86d0f520d38dfc242d51c
```
...
```text
Changed paths for ref `7a8c303246dff1846eaf4862804ecf69a2a5b3c7`:
- scripts/gates/check_schema_enum_axis.py
- scripts/gates/validate_inventory_consumption.py
- tests/quality_gates/test_inventory_consumption.py
- tests/test_schema_enum_axis.py
...
- materialized-plugin-export: Materialized plugin export and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/gates/check_schema_enum_axis.py, scripts/gates/validate_inventory_consumption.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/gates/check_schema_enum_axis.py, scripts/gates/validate_inventory_consumption.py, tests/quality_gates/test_inventory_consumption.py, tests/test_schema_enum_axis.py
