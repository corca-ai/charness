...
- **Generated**: 2026-09-06T00:59:42Z
- **Prepared for**: working tree
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `58a7a32e44e3157b98239a085ea3c6c9019af5f67ab2ef98ca0ed05e96bbc0a1`
- **Reviewed paths**: 8
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/goal798-final-owner-review-packet.json --packet-sha256 bd6d5b30438fbe20dfc3b55a0f1fbe76e353a50f6b87ea42ed380ddfab228e5b --identity-sha256 58a7a32e44e3157b98239a085ea3c6c9019af5f67ab2ef98ca0ed05e96bbc0a1
```
...
- tests/quality_gates/test_staged_cheap_owners.py
- charness-artifacts/debug/2026-09-06-staged-owner-universe.md
- charness-artifacts/probe/2026-09-06-consumer-journeys/outputs/alias-baseline-catalog.py
- charness-artifacts/probe/2026-09-06-consumer-journeys/outputs/alias-baseline-tests.py
...
- materialized-plugin-export: Materialized plugin export and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/hooks/check_staged_cheap_owners.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/debug/latest.md, charness-artifacts/debug/2026-09-06-staged-owner-universe.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/hooks/check_staged_cheap_owners.py, tests/quality_gates/test_staged_cheap_owners.py
