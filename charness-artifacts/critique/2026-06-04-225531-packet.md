...
- **Generated**: 2026-06-04T22:55:31Z
- **Prepared for**: issue-299-release-only-sentinel-inventory
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/quality/references/inventory-dispatch.md, skills/public/quality/scripts/inventory_release_only_sentinels.py
  derived matches: plugins/charness/skills/quality/references/inventory-dispatch.md, plugins/charness/skills/quality/scripts/inventory_release_only_sentinels.py
...
- public-skill-dogfood: Checked-in consumer dogfood cases for public skills and the validator that keeps them aligned with current skill contracts.
  source matches: docs/public-skill-dogfood.json, skills/public/quality/references/inventory-dispatch.md, skills/public/quality/scripts/inventory_release_only_sentinels.py
  verify: python3 scripts/validate_public_skill_dogfood.py --repo-root .
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_release_only_sentinel_inventory.py
