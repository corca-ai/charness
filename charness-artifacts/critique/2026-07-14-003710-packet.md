...
- **Generated**: 2026-07-14T00:37:10Z
- **Prepared for**: lifecycle feedback and quality truthfulness
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/issue/scripts/issue_close.py, skills/public/release/scripts/publish_release_common.py, scripts/lifecycle_usage_capture.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/quality/2026-07-14-quality-review.md, docs/product-success-metrics.md, charness-artifacts/spec/2026-07-14-lifecycle-feedback-and-quality-truthfulness.md
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/issue/scripts/issue_close.py, skills/public/release/scripts/publish_release_common.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/lifecycle_usage_capture.py, tests/test_lifecycle_usage_capture.py
