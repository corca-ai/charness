...
- **Generated**: 2026-08-05T21:12:05Z
- **Prepared for**: Issue #508/#509 local re-rank claims review v8
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `63c22fe061339e754b12c0aaf3e26019262f9281f1855bdd10b158a694af9233`
- **Reviewed paths**: 7
- **Sections**: 3
- **Overall ok**: True
...
- charness-artifacts/issue/2026-08-06-issue-509-closeout-commit-message.md

Owning surfaces:
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/goals/2026-08-05-close-all-open-issues-generative-sequence.md, docs/handoff.md, charness-artifacts/issue/2026-08-06-issue-509-closeout-commit-message.md
...
- public-skill-dogfood: Checked-in consumer dogfood cases for public skills and the validator that keeps them aligned with current skill contracts.
  source matches: docs/public-skill-dogfood.json
