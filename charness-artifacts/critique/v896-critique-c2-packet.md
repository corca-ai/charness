...
- **Generated**: 2026-09-21T13:28:45Z
- **Prepared for**: 76a3d89463068b031324f1d7c0e31d45c160bc81
- **Substrate mode**: `committed-ref`
- **Changed ref**: `76a3d89463068b031324f1d7c0e31d45c160bc81`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `bf9bcb5c76db92e32d32409cbb3a3d75cf885c18607d1bf93a80bf5a65e82316`
- **Reviewed paths**: 6
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/v896-critique-c2-packet.json --packet-sha256 90def7ab0b7ee10bfcc26951c33b67f6417b5195bcf7d3a8ccaf68fa0ae26c71 --identity-sha256 bf9bcb5c76db92e32d32409cbb3a3d75cf885c18607d1bf93a80bf5a65e82316
```
...
```text
Changed paths for ref `76a3d89463068b031324f1d7c0e31d45c160bc81`:
...
- materialized-plugin-export: Materialized plugin export and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/task_run/task_run_completion.py, scripts/task_run/task_run_lane_runner.py, scripts/task_run/task_run_progress.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/task_run/task_run_completion.py, scripts/task_run/task_run_lane_runner.py, scripts/task_run/task_run_progress.py, tests/charness_cli/test_task_run_completion.py, tests/charness_cli/test_task_run_implementation_lane.py
