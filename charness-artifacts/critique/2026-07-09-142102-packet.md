...
- **Generated**: 2026-07-09T14:21:02Z
- **Prepared for**: markdown-preview argparse help repair
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/support/markdown-preview/scripts/render_markdown_preview.py
  derived matches: plugins/charness/support/markdown-preview/scripts/render_markdown_preview.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/test_markdown_preview_support.py
