...
- **Generated**: 2026-08-12T17:39:48Z
- **Prepared for**: Issue 588 final policy-absent public dogfood repair
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `3fc13c694ebb70ef7ad5d7e0a550496cc1a5b733eca5d421ec7f017dffa10906`
- **Reviewed paths**: 11
- **Sections**: 3
- **Overall ok**: True
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/public_skill_dogfood_lib.py, scripts/suggest_public_skill_dogfood.py, skills/public/quality/scripts/suggest_public_skill_dogfood.py
  derived matches: plugins/charness/scripts/public_skill_dogfood_lib.py, plugins/charness/scripts/suggest_public_skill_dogfood.py, plugins/charness/skills/quality/scripts/suggest_public_skill_dogfood.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/critique/2026-08-12-173729-packet.md, charness-artifacts/critique/2026-08-12-173751-packet.md, charness-artifacts/critique/2026-08-13-issue-588-policy-absent-dogfood-resolution.md, charness-artifacts/debug/2026-08-13-issue-588-policy-absent-dogfood.md
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/quality/scripts/suggest_public_skill_dogfood.py
  derived matches: plugins/charness/skills/quality/scripts/suggest_public_skill_dogfood.py
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-08-12-173729-packet.json, charness-artifacts/critique/2026-08-12-173729-packet.md, charness-artifacts/critique/2026-08-12-173751-packet.json, charness-artifacts/critique/2026-08-12-173751-packet.md, charness-artifacts/critique/2026-08-13-issue-588-policy-absent-dogfood-resolution.md
  verify: python3 scripts/validate_critique_artifacts.py --repo-root . --all
- debug-seam-risk-index: Generated source-linked index over debug artifact seam-risk fields.
  source matches: charness-artifacts/debug/2026-08-13-issue-588-policy-absent-dogfood.md
...
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/public_skill_dogfood_lib.py, plugins/charness/scripts/suggest_public_skill_dogfood.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/public_skill_dogfood_lib.py, scripts/suggest_public_skill_dogfood.py, tests/quality_gates/test_public_skill_dogfood.py, tests/test_public_skill_dogfood.py
  derived matches: plugins/charness/scripts/public_skill_dogfood_lib.py, plugins/charness/scripts/suggest_public_skill_dogfood.py
