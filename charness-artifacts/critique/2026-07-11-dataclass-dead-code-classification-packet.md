...
- **Generated**: 2026-07-11T12:12:14Z
- **Prepared for**: Slice E classify dataclass dead-code findings structurally
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/quality/scripts/run_dead_code_advisory.py
  derived matches: plugins/charness/skills/quality/scripts/run_dead_code_advisory.py
