...
- **Reviewed input identity**: `5946c2bfcbb577b6b939d82f50697d92733228436fd17d9b6095c3b84dc719f0`
- **Reviewed paths**: 645
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/2026-09-02-769-boundary-packet.json --packet-sha256 968d9d235c0c0b07d885b64eb1f7a4d6befcfbd79a3d07c85b32f50e9515e67e --identity-sha256 5946c2bfcbb577b6b939d82f50697d92733228436fd17d9b6095c3b84dc719f0
```
...
10 of 645 changed path(s) were DELETED in the ref `a5002ffc9..HEAD`. Their pre-image bytes are bound in the reviewed-input identity, so what was removed is recoverable.
...
- profiles-and-presets: Profile and preset bundles that define packaged defaults.
  ...
  verify: python3 -m tools.validate_profiles --repo-root ., python3 -m tools.validate_presets --repo-root .
