...
- **Generated**: 2026-08-12T15:14:34Z
- **Prepared for**: issue #589 repaired verdict-surface review
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `ebf0b721fc51fb3d49545cd5e46520045ae77187ad0629475d349cf2ac07372a`
- **Reviewed paths**: 11
- **Sections**: 3
- **Overall ok**: True
...
- charness-artifacts/critique/2026-08-12-150907-packet.json
- charness-artifacts/critique/2026-08-12-150907-packet.md
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/validate_presets.py, skills/public/quality/scripts/quality_declaration_lifecycle.py, skills/public/quality/scripts/quality_run_plan_render.py
  derived matches: plugins/charness/scripts/validate_presets.py, plugins/charness/skills/quality/scripts/quality_declaration_lifecycle.py, plugins/charness/skills/quality/scripts/quality_run_plan_render.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/debug/latest.md, charness-artifacts/critique/2026-08-12-150907-packet.md, charness-artifacts/debug/2026-08-13-issue-589-preset-reconciliation-debug.md
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/quality/scripts/quality_declaration_lifecycle.py, skills/public/quality/scripts/quality_run_plan_render.py
  derived matches: plugins/charness/skills/quality/scripts/quality_declaration_lifecycle.py, plugins/charness/skills/quality/scripts/quality_run_plan_render.py
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-08-12-150907-packet.json, charness-artifacts/critique/2026-08-12-150907-packet.md
