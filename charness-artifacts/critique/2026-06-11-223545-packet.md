...
- **Generated**: 2026-06-11T22:35:45Z
- **Prepared for**: surface manifest fixture helper split
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_run_slice_closeout_surface_obligations.py
