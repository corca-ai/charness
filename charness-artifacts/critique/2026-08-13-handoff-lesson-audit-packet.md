...
- **Generated**: 2026-08-13T09:43:16Z
- **Prepared for**: final handoff link ownership and lesson-evaluation continuity readback
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `96b7ae670c6bc87f339dfb973000f3d20fddfefb3d73257c4b1473acd7582122`
- **Reviewed paths**: 7
- **Sections**: 3
- **Overall ok**: True
...
- charness-artifacts/critique/handoff-lesson-audit-packet-packet.json
- charness-artifacts/critique/handoff-lesson-audit-packet-packet.md
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/handoff/scripts/plan_handoff_run.py, skills/public/handoff/SKILL.md, skills/public/handoff/references/spill-targets.md, skills/public/retro/SKILL.md, skills/public/retro/references/adapter-contract.md, skills/public/retro/references/lesson-evaluation.md, skills/public/retro/scripts/plan_retro_run.py, skills/public/handoff/scripts/handoff_authoring_preflight.py
  derived matches: plugins/charness/skills/handoff/scripts/plan_handoff_run.py, plugins/charness/skills/handoff/SKILL.md, plugins/charness/skills/handoff/references/spill-targets.md, plugins/charness/skills/retro/SKILL.md, plugins/charness/skills/retro/references/adapter-contract.md, plugins/charness/skills/retro/references/lesson-evaluation.md, plugins/charness/skills/retro/scripts/plan_retro_run.py, plugins/charness/skills/handoff/scripts/handoff_authoring_preflight.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/create-skill/2026-08-13-handoff-retro-feedback-loop-brief.md, charness-artifacts/critique/2026-08-13-handoff-lesson-audit-packet.md, charness-artifacts/critique/2026-08-13-handoff-lesson-evaluation-continuity.md, charness-artifacts/critique/2026-08-13-handoff-retro-skill-feedback-loop.md, charness-artifacts/retro/2026-08-13-issue-615-memory-audit-packet.md, charness-artifacts/retro/2026-08-13-session-retro.md, charness-artifacts/retro/recent-lessons.md, docs/development.md, docs/handoff.md, skills/public/handoff/SKILL.md, skills/public/handoff/references/spill-targets.md, skills/public/retro/SKILL.md, skills/public/retro/references/adapter-contract.md, skills/public/retro/references/lesson-evaluation.md, charness-artifacts/critique/handoff-lesson-audit-packet-packet.md
...
- public-skill-dogfood: Checked-in consumer dogfood cases for public skills and the validator that keeps them aligned with current skill contracts.
  source matches: skills/public/handoff/scripts/plan_handoff_run.py, docs/public-skill-dogfood.json, skills/public/handoff/SKILL.md, skills/public/handoff/references/spill-targets.md, skills/public/retro/SKILL.md, skills/public/retro/references/adapter-contract.md, skills/public/retro/references/lesson-evaluation.md, skills/public/retro/scripts/plan_retro_run.py, skills/public/handoff/scripts/handoff_authoring_preflight.py
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-08-13-handoff-lesson-audit-packet.json, charness-artifacts/critique/2026-08-13-handoff-lesson-audit-packet.md, charness-artifacts/critique/2026-08-13-handoff-lesson-evaluation-continuity.md, charness-artifacts/critique/2026-08-13-handoff-retro-skill-feedback-loop.md, charness-artifacts/critique/handoff-lesson-audit-packet-packet.json, charness-artifacts/critique/handoff-lesson-audit-packet-packet.md
...
- retro-lesson-selection-index: Durable retro prepare packets and generated advisory index for source-linked retro lesson digest selection.
  source matches: charness-artifacts/retro/2026-08-13-issue-615-memory-audit-packet.json, charness-artifacts/retro/2026-08-13-issue-615-memory-audit-packet.md, charness-artifacts/retro/2026-08-13-session-retro.md, charness-artifacts/retro/recent-lessons.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_handoff_skill.py, tests/quality_gates/test_retro_skill.py, tests/test_handoff_plan.py, tests/test_retro_plan.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: skills/public/handoff/scripts/plan_handoff_run.py, skills/public/retro/scripts/plan_retro_run.py, skills/public/handoff/scripts/handoff_authoring_preflight.py
