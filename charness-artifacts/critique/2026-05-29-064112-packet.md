...
- **Generated**: 2026-05-29T06:41:12Z
- **Prepared for**: issue-247-goal-pursue-design
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/achieve/SKILL.md, skills/public/achieve/references/lifecycle.md, skills/public/achieve/scripts/check_goal_artifact.py, skills/public/achieve/scripts/goal_artifact_lib.py
  derived matches: plugins/charness/skills/achieve/SKILL.md, plugins/charness/skills/achieve/references/lifecycle.md, plugins/charness/skills/achieve/scripts/check_goal_artifact.py, plugins/charness/skills/achieve/scripts/goal_artifact_lib.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_achieve_before_activation.py, tests/quality_gates/test_goal_artifact_lib.py
