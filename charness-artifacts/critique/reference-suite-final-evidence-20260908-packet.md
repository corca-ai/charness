...
- **Generated**: 2026-09-07T21:59:46Z
- **Prepared for**: reference-suite repaired source and completed evidence
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `ab765b387630f20999936b3196c0f36141c3297873099b1536fa586b6983fac9`
- **Reviewed paths**: 11
  - `.agents/quality-gates.yaml`
  - `charness-artifacts/probe/2026-09-08-literal-reference-consumer.json`
  - `charness-artifacts/probe/2026-09-08-literal-reference-trace.md`
  - `charness-artifacts/probe/2026-09-08-reference-and-suite-diagnosis.json`
  - `charness-artifacts/probe/2026-09-08-reference-suite-final-verification.json`
  ...
  - `tests/quality_gates/test_standing_pytest_run_mirror.py`
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/reference-suite-final-evidence-20260908-packet.json --packet-sha256 e918a28a61004533245edb8b7df719258078e3fe382ed2ec485bd4fdea3fdb5b --identity-sha256 ab765b387630f20999936b3196c0f36141c3297873099b1536fa586b6983fac9
```
...
- charness-artifacts/probe/2026-09-08-reference-suite-final-verification.json
- charness-artifacts/probe/2026-09-08-reference-suite-results.md

Owning surfaces:
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/probe/2026-09-08-reference-suite-results.md
...
- probe-artifacts: Checked-in host/runtime probe JSON artifacts used as closeout evidence.
  source matches: charness-artifacts/probe/2026-09-08-reference-suite-final-verification.json
