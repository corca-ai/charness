...
- **Generated**: 2026-09-04T00:13:29Z
- **Prepared for**: impl-debug-route-and-verifier-candidate-2
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `016b31974c218992879d81eae53e63bb3e9d5d090706080f29d026c33a8c804d`
- **Reviewed paths**: 3
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/impl-debug-route-final-3-packet.json --packet-sha256 50d28c55f4ebde222bdaf0b9b66ba448be65958fe8f80b640b843cf6a9bfdd35 --identity-sha256 016b31974c218992879d81eae53e63bb3e9d5d090706080f29d026c33a8c804d
```
...
- materialized-plugin-export: Materialized plugin export and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/debug/SKILL.md, skills/public/debug/references/detection-gap.md
