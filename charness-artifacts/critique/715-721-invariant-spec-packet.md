...
- **Generated**: 2026-08-25T05:24:48Z
- **Prepared for**: consumer boundary invariant hardening spec
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `55d6f3ea380a4df9b7eb3d421c948a94bfa9a55c8922c9ee4b5808347b3f59e2`
- **Reviewed paths**: 4
  - `charness-artifacts/debug/2026-08-25-debug-review.md`
  - `charness-artifacts/retro/lesson-ledger.json`
  - `charness-artifacts/retro/lesson-session-receipts/2026-08-25-715-721-5whys.json`
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/715-721-invariant-spec-packet.json --packet-sha256 877c26896bf881bc0ba6df53f10fb5f747191973bce873b9ab24299514d4e177 --identity-sha256 55d6f3ea380a4df9b7eb3d421c948a94bfa9a55c8922c9ee4b5808347b3f59e2
```
...
- charness-artifacts/debug/2026-08-25-debug-review.md
- charness-artifacts/retro/lesson-session-receipts/2026-08-25-715-721-5whys.json
- charness-artifacts/retro/lesson-session-receipts/2026-08-25-715-721-5whys.md
- charness-artifacts/spec/2026-08-25-consumer-boundary-invariants.md

Owning surfaces:
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/debug/latest.md, charness-artifacts/debug/2026-08-25-debug-review.md, charness-artifacts/retro/lesson-session-receipts/2026-08-25-715-721-5whys.md, charness-artifacts/spec/2026-08-25-consumer-boundary-invariants.md
...
- debug-seam-risk-index: Generated source-linked index over debug artifact seam-risk fields.
  source matches: charness-artifacts/debug/latest.md, charness-artifacts/debug/2026-08-25-debug-review.md
...
- retro-lesson-selection-index: Durable retro prepare packets and generated advisory index for source-linked retro lesson digest selection.
  source matches: charness-artifacts/retro/lesson-session-receipts/2026-08-25-715-721-5whys.md
...
- lesson-ledger-and-contract-register: Local cited lesson state and the explicit pre-contract-mutation register probe.
  source matches: charness-artifacts/retro/lesson-ledger.json, charness-artifacts/retro/lesson-session-receipts/2026-08-25-715-721-5whys.json
