...
- **Generated**: 2026-05-14T07:24:39Z
- **Prepared for**: slice-1-cautilus-provenance-a-c
...
- plugins/charness/scripts/run_cautilus_eval.py
...
- tests/quality_gates/test_run_cautilus_eval.py
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/run_cautilus_eval.py, skills/public/quality/references/inventory-consumer-fields.json
  derived matches: plugins/charness/scripts/run_cautilus_eval.py, plugins/charness/skills/quality/references/inventory-consumer-fields.json
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/quality/references/inventory-consumer-fields.json
  derived matches: plugins/charness/skills/quality/references/inventory-consumer-fields.json
...
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/run_cautilus_eval.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_run_cautilus_eval.py
