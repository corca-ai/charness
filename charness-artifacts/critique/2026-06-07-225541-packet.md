...
- **Generated**: 2026-06-07T22:55:41Z
- **Prepared for**: run_slice_closeout reporting-block extraction
...
- charness-artifacts/goals/2026-06-08-run-slice-closeout-module-split.md
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/run_slice_closeout.py, scripts/slice_closeout_reporting.py
  derived matches: plugins/charness/scripts/run_slice_closeout.py, plugins/charness/scripts/slice_closeout_reporting.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/goals/2026-06-08-run-slice-closeout-module-split.md
