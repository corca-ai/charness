...
- **Generated**: 2026-05-21T11:44:02Z
- **Prepared for**: product-success-ai-ml-baseline
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: docs/handoff.md, docs/ai-ml-engineering-patterns.md, docs/product-success-metrics.md
