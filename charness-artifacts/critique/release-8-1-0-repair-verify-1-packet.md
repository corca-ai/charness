...
- **Generated**: 2026-09-03T22:01:05Z
- **Prepared for**: release-8-1-0-repair-verify
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `f016d601cbf3738e2f26cec8c5fc704d0158bd6439e4384c2594427350d50835`
- **Reviewed paths**: 7
  - `docs/development.md`
  - `docs/implementation-discipline.md`
  - `scripts/gates/check_docs_length.py`
  - `scripts/lessons/lesson_ledger_lib.py`
  - `skills/shared/references/bootstrap-resolution.md`
  - `skills/shared/references/lesson-graduation.md`
  - `tests/test_docs_length_gate.py`
...
- charness-artifacts/critique/2026-09-04-release-8-1-0-reviewed-paths.txt
- charness-artifacts/critique/release-8-1-0-gawande-1-packet.json
- charness-artifacts/critique/release-8-1-0-gawande-1-packet.md
- charness-artifacts/critique/release-8-1-0-minto-raskin-1-packet.json
- charness-artifacts/critique/release-8-1-0-minto-raskin-1-packet.md
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/critique/release-8-1-0-gawande-1-packet.md, charness-artifacts/critique/release-8-1-0-minto-raskin-1-packet.md, charness-artifacts/release/2026-09-04-v8.1.0-install-update-rehearsal.md, charness-artifacts/release/v8.1.0-notes.md
...
- operational-evidence-records: Durable issue, quality, and release evidence attachments produced by local planning and closeout workflows.
  source matches: charness-artifacts/release/2026-09-04-v8.1.0-install-update-rehearsal.md, charness-artifacts/release/v8.1.0-notes.md
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-09-04-release-8-1-0-reviewed-paths.txt, charness-artifacts/critique/release-8-1-0-gawande-1-packet.json, charness-artifacts/critique/release-8-1-0-gawande-1-packet.md, charness-artifacts/critique/release-8-1-0-minto-raskin-1-packet.json, charness-artifacts/critique/release-8-1-0-minto-raskin-1-packet.md
