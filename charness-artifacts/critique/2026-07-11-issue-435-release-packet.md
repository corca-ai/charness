...
- **Generated**: 2026-07-11T02:47:00Z
- **Prepared for**: issue #435 patch release v0.66.1
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/issue/SKILL.md, skills/public/issue/references/issue-backend.md, skills/public/issue/scripts/issue_create.py, skills/public/quality/references/attention-state-visibility.json
  derived matches: plugins/charness/skills/issue/SKILL.md, plugins/charness/skills/issue/references/issue-backend.md, plugins/charness/skills/issue/scripts/issue_create.py, plugins/charness/skills/quality/references/attention-state-visibility.json
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: skills/public/issue/SKILL.md, skills/public/issue/references/issue-backend.md
  derived matches: plugins/charness/skills/issue/SKILL.md, plugins/charness/skills/issue/references/issue-backend.md
...
- prompt-behavior-proof: Prompt-affecting instruction surfaces must follow deterministic Cautilus validation and on-demand proof policy.
  source matches: skills/public/issue/SKILL.md, skills/public/issue/references/issue-backend.md, skills/public/quality/references/attention-state-visibility.json
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_issue_create.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: skills/public/issue/scripts/issue_create.py
...
parent-delegated — three distinct release/resolution angles and a separate
...
- Producer: the public issue-create helper produces the external mutation and
  readback ledger.
- Consumer: the issue closeout workflow and downstream operator consume the
  ledger before treating creation as verified.
- Owning surface: public issue skill plus synchronized plugin export; release
  publication remains release-helper-owned.
