...
- **Generated**: 2026-07-13T06:57:00Z
- **Prepared for**: v1.0.2 release candidate
- **Changed ref**: `009d56aa..HEAD`
...
```text
Changed paths for ref `009d56aa..HEAD`:
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/issue/scripts/issue_plan.py
  derived matches: plugins/charness/skills/issue/scripts/issue_plan.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/critique/2026-07-13-issue-resolve-preflight-ordering-code-critique.md, charness-artifacts/critique/2026-07-13-round4-goal-plan-packet.md, charness-artifacts/critique/2026-07-13-round4-issue-preflight-packet.md, charness-artifacts/debug/2026-07-13-debug-review-followup-2.md, charness-artifacts/debug/2026-07-13-debug-review-followup.md, charness-artifacts/debug/latest.md, charness-artifacts/goals/2026-07-13-north-star-autonomous-two-hour-release-round-4.md, charness-artifacts/quality/2026-07-13-round4-v1-0-2-release-readiness.md, charness-artifacts/quality/latest.md
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-07-13-issue-resolve-preflight-ordering-code-critique.md, charness-artifacts/critique/2026-07-13-round4-goal-plan-packet.json, charness-artifacts/critique/2026-07-13-round4-goal-plan-packet.md, charness-artifacts/critique/2026-07-13-round4-issue-preflight-packet.json, charness-artifacts/critique/2026-07-13-round4-issue-preflight-packet.md
  verify: python3 scripts/validate_critique_artifacts.py --repo-root . --all
- debug-seam-risk-index: Generated source-linked index over debug artifact seam-risk fields.
  source matches: charness-artifacts/debug/2026-07-13-debug-review-followup-2.md, charness-artifacts/debug/2026-07-13-debug-review-followup.md, charness-artifacts/debug/latest.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/charness_cli/test_codex_cache_refresh.py, tests/quality_gates/test_issue_skill.py, tests/quality_gates/test_issue_tool_runners.py, tests/quality_gates/test_quality_runner_runtime_aggregate.py
