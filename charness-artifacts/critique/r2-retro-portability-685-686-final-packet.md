...
- **Generated**: 2026-08-21T03:54:33Z
- **Prepared for**: retro portability and fresh-eye report identity boundary
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `3b6fc03f414bbecbba923082c4bedda56df87c58def556fe3d09328b32ab02d4`
- **Reviewed paths**: 14
- **Sections**: 3
- **Overall ok**: True
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/critique_reviewer_evidence.py, scripts/retro_persistence_lib.py, skills/public/critique/scripts/scaffold_critique_artifact.py, skills/public/retro/scripts/plan_retro_run.py
  derived matches: plugins/charness/scripts/critique_reviewer_evidence.py, plugins/charness/scripts/retro_persistence_lib.py, plugins/charness/skills/critique/scripts/scaffold_critique_artifact.py, plugins/charness/skills/retro/scripts/plan_retro_run.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/goals/2026-08-20-repairs-that-carry-their-class.md, charness-artifacts/critique/2026-08-21-retro-portability-685-686-r2.md, charness-artifacts/critique/r2-retro-portability-685-686-packet.md, charness-artifacts/critique/r2-retro-portability-685-686-readiness-packet.md, charness-artifacts/critique/rounds/2026-08-21-r2-retro-portability-operator-retry-20260821.md, charness-artifacts/critique/rounds/2026-08-21-r2-retro-portability-ownership-20260821.md, charness-artifacts/debug/2026-08-21-retro-portability-boundary-685-686.md
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/critique/scripts/scaffold_critique_artifact.py, skills/public/retro/scripts/plan_retro_run.py
  derived matches: plugins/charness/skills/critique/scripts/scaffold_critique_artifact.py, plugins/charness/skills/retro/scripts/plan_retro_run.py
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-08-21-retro-portability-685-686-r2.md, charness-artifacts/critique/r2-retro-portability-685-686-packet.json, charness-artifacts/critique/r2-retro-portability-685-686-packet.md, charness-artifacts/critique/r2-retro-portability-685-686-readiness-packet.json, charness-artifacts/critique/r2-retro-portability-685-686-readiness-packet.md, charness-artifacts/critique/rounds/2026-08-21-r2-retro-portability-operator-retry-20260821-worker-report.yaml, charness-artifacts/critique/rounds/2026-08-21-r2-retro-portability-operator-retry-20260821.md, charness-artifacts/critique/rounds/2026-08-21-r2-retro-portability-ownership-20260821.md
...
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/critique_reviewer_evidence.py, plugins/charness/scripts/retro_persistence_lib.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/critique_reviewer_evidence.py, scripts/retro_persistence_lib.py, tests/quality_gates/test_critique_enforcement_scope.py, tests/quality_gates/test_retro_persistence.py, tests/quality_gates/test_retro_installed_plan_path.py
  derived matches: plugins/charness/scripts/critique_reviewer_evidence.py, plugins/charness/scripts/retro_persistence_lib.py
