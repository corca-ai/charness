...
- **Generated**: 2026-05-31T12:02:38Z
- **Prepared for**: issue-269-achieve-head-freshness
...
- plugins/charness/skills/achieve/scripts/goal_artifact_head_freshness.py
- skills/public/achieve/scripts/goal_artifact_head_freshness.py
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/achieve/SKILL.md, skills/public/achieve/references/lifecycle.md, skills/public/achieve/scripts/check_goal_artifact.py, skills/public/achieve/scripts/goal_artifact_head_freshness.py
  derived matches: plugins/charness/skills/achieve/SKILL.md, plugins/charness/skills/achieve/references/lifecycle.md, plugins/charness/skills/achieve/scripts/check_goal_artifact.py, plugins/charness/skills/achieve/scripts/goal_artifact_head_freshness.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/find-skills/latest.md, skills/public/achieve/SKILL.md, skills/public/achieve/references/lifecycle.md
...
- prompt-behavior-proof: Prompt-affecting instruction surfaces must follow deterministic Cautilus validation and on-demand proof policy.
  source matches: skills/public/achieve/SKILL.md, skills/public/achieve/references/lifecycle.md
...
- public-skill-dogfood: Checked-in consumer dogfood cases for public skills and the validator that keeps them aligned with current skill contracts.
  source matches: docs/public-skill-dogfood.json, skills/public/achieve/SKILL.md, skills/public/achieve/references/lifecycle.md, skills/public/achieve/scripts/check_goal_artifact.py, skills/public/achieve/scripts/goal_artifact_head_freshness.py
  verify: python3 scripts/validate_public_skill_dogfood.py --repo-root .
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_goal_head_freshness.py
