...
- **Generated**: 2026-07-14T05:19:11Z
- **Prepared for**: Claude and Codex reviewer-boundary portability
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/spec/2026-07-14-skill-directory-shell-bootstrap.md, docs/host-packaging.md, skills/shared/references/fresh-eye-subagent-review.md
