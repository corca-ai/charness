...
- **Generated**: 2026-06-13T09:15:05Z
- **Prepared for**: achieve-efficiency Slice 1 impl diff
...
- plugins/charness/skills/retro/references/section-guide.md
...
- tests/quality_gates/test_slice_closeout_gate_runtime_advisory.py
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/run_slice_closeout.py, scripts/slice_closeout_advisories.py, skills/public/achieve/SKILL.md, skills/public/achieve/references/lifecycle.md, skills/public/retro/references/phase-aware-efficiency.md, skills/public/retro/references/section-guide.md
  derived matches: plugins/charness/scripts/run_slice_closeout.py, plugins/charness/scripts/slice_closeout_advisories.py, plugins/charness/skills/achieve/SKILL.md, plugins/charness/skills/achieve/references/lifecycle.md, plugins/charness/skills/retro/references/phase-aware-efficiency.md, plugins/charness/skills/retro/references/section-guide.md
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/spec/achieve-efficiency-improvements.md, skills/public/achieve/SKILL.md, skills/public/achieve/references/lifecycle.md, skills/public/retro/references/phase-aware-efficiency.md, skills/public/retro/references/section-guide.md
  derived matches: plugins/charness/skills/achieve/SKILL.md, plugins/charness/skills/achieve/references/lifecycle.md, plugins/charness/skills/retro/references/phase-aware-efficiency.md, plugins/charness/skills/retro/references/section-guide.md
...
- prompt-behavior-proof: Prompt-affecting instruction surfaces must follow deterministic Cautilus validation and on-demand proof policy.
  source matches: skills/public/achieve/SKILL.md, skills/public/achieve/references/lifecycle.md, skills/public/retro/references/phase-aware-efficiency.md, skills/public/retro/references/section-guide.md
...
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/run_slice_closeout.py, plugins/charness/scripts/slice_closeout_advisories.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/run_slice_closeout.py, scripts/slice_closeout_advisories.py, tests/quality_gates/test_slice_closeout_gate_runtime_advisory.py
  derived matches: plugins/charness/scripts/run_slice_closeout.py, plugins/charness/scripts/slice_closeout_advisories.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: scripts/run_slice_closeout.py, scripts/slice_closeout_advisories.py
