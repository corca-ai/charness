...
- **Generated**: 2026-08-09T07:58:45Z
- **Prepared for**: remote-ci-changed-line-round1
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `82e43476e29925b605ea083eefa288f46226da3c13e17748d1dc193667913ef9`
- **Identity-bound reviewed paths**: 6
- **Changed surface paths**: 7 (the `debug/latest.md` current pointer is listed
  below but excluded from content identity)
- **Sections**: 3
- **Overall ok**: True
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/suggest_mutation_coverage_command.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/debug/latest.md, charness-artifacts/goals/2026-08-09-refuse-the-verdict-a-surface-never-earned.md, charness-artifacts/debug/2026-08-09-remote-ci-changed-line-reconciliation-debug.md, charness-artifacts/spec/2026-08-09-remote-ci-changed-line-reconciliation-contract.md
...
- debug-seam-risk-index: Generated source-linked index over debug artifact seam-risk fields.
  source matches: charness-artifacts/debug/latest.md, charness-artifacts/debug/2026-08-09-remote-ci-changed-line-reconciliation-debug.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/suggest_mutation_coverage_command.py, tests/quality_gates/test_regenerable_facts.py, tests/quality_gates/test_suggest_mutation_coverage_command.py
