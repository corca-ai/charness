...
- **Generated**: 2026-07-14T10:32:52Z
- **Prepared for**: Codex V2 Terra-medium subagent default rollout
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/critique_adapter_lib.py, scripts/templates/agents_subagent_delegation.txt, skills/public/critique/adapter.example.yaml, skills/public/critique/references/adapter-contract.md, skills/public/critique/scripts/templates/critique_adapter.yaml, skills/public/setup/references/agent-docs-policy.md, skills/public/setup/references/default-surfaces.md
  derived matches: plugins/charness/scripts/critique_adapter_lib.py, plugins/charness/scripts/templates/agents_subagent_delegation.txt, plugins/charness/skills/critique/adapter.example.yaml, plugins/charness/skills/critique/references/adapter-contract.md, plugins/charness/skills/critique/scripts/templates/critique_adapter.yaml, plugins/charness/skills/setup/references/agent-docs-policy.md, plugins/charness/skills/setup/references/default-surfaces.md
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: AGENTS.md, skills/public/critique/references/adapter-contract.md, skills/public/setup/references/agent-docs-policy.md, skills/public/setup/references/default-surfaces.md
...
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/critique_adapter_lib.py, plugins/charness/scripts/templates/agents_subagent_delegation.txt
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: scripts/critique_adapter_lib.py
