...
- **Generated**: 2026-07-18T17:41:44Z
- **Prepared for**: critique scaffold binding opt-in fix
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `051e7fffce45618145f148f11271975da9b6579989f5783540a5fecdf4453632`
- **Reviewed paths**: 3
- **Sections**: 2
- **Overall ok**: True
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  ...
  derived matches: plugins/charness/skills/critique/scripts/scaffold_critique_artifact.py
