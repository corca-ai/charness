...
- **Generated**: 2026-05-19T08:58:48Z
- **Prepared for**: final-post-fix-recritique
...
- docs/handoff.md
- plugins/charness/scripts/check_premortem_rename.allowlist.txt
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/check_premortem_rename.allowlist.txt, scripts/validate_critique_artifacts.py, skills/public/issue/scripts/issue_verify_closeout.py, skills/public/release/scripts/publish_release_cli.py, skills/public/release/scripts/publish_release_helpers.py
  derived matches: plugins/charness/scripts/check_premortem_rename.allowlist.txt, plugins/charness/scripts/validate_critique_artifacts.py, plugins/charness/skills/issue/scripts/issue_verify_closeout.py, plugins/charness/skills/release/scripts/publish_release_cli.py, plugins/charness/skills/release/scripts/publish_release_helpers.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/release/latest.md, docs/handoff.md
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/issue/scripts/issue_verify_closeout.py, skills/public/release/scripts/publish_release_cli.py, skills/public/release/scripts/publish_release_helpers.py
  derived matches: plugins/charness/skills/issue/scripts/issue_verify_closeout.py, plugins/charness/skills/release/scripts/publish_release_cli.py, plugins/charness/skills/release/scripts/publish_release_helpers.py
...
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/check_premortem_rename.allowlist.txt, plugins/charness/scripts/validate_critique_artifacts.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_critique_skill.py, tests/quality_gates/test_issue_closeout_verifier.py, tests/quality_gates/test_release_publish.py
