...
- **Generated**: 2026-07-10T23:33:07Z
- **Prepared for**: issue 434 and v0.66.0 release
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/achieve/adapter.example.yaml, skills/public/achieve/references/adapter-contract.md, skills/public/achieve/scripts/achieve_adapter_policy.py, skills/public/achieve/scripts/goal_artifact_lib.py, skills/public/achieve/scripts/goal_artifact_scaffold.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  ...
  derived matches: plugins/charness/skills/achieve/references/adapter-contract.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_goal_artifact_scaffold.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: skills/public/achieve/scripts/achieve_adapter_policy.py, skills/public/achieve/scripts/goal_artifact_lib.py, skills/public/achieve/scripts/goal_artifact_scaffold.py
...
reviewer consumed this packet. Their consolidated disposition is recorded in
`charness-artifacts/critique/2026-07-11-434-release-critique.md`.

## Boundary Ownership

- Producer: the public `achieve` adapter policy validates the repo-owned path.
- Consumer: newly scaffolded `achieve` goal artifacts render the pointer.
- Owning surface: public `achieve` adapter and scaffold.
