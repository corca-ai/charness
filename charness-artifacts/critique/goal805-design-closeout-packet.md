...
- **Prepared for**: corca-ai/charness#810 design
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `091ffec47b0c797c7912d2f3962bd15965160c283273f2f7944aefe48e158480`
- **Reviewed paths**: 4
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/goal805-design-closeout-packet.json --packet-sha256 d8f7af8d142a087af2edfd7be2f2091e33571c43714bede7cade2a5e033802e4 --identity-sha256 091ffec47b0c797c7912d2f3962bd15965160c283273f2f7944aefe48e158480
```
