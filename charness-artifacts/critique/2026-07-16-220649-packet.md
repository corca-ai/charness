...
- **Generated**: 2026-07-16T22:06:49Z
- **Prepared for**: issue-444-resolution-critique
...
- plugins/charness/skills/issue/references/resolution-brief.md
- scripts/check_issue_closeout_commit_msg.py
- skills/public/issue/references/resolution-brief.md
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/check_issue_closeout_commit_msg.py, skills/public/issue/references/resolution-brief.md
  derived matches: plugins/charness/scripts/check_issue_closeout_commit_msg.py, plugins/charness/skills/issue/references/resolution-brief.md
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: skills/public/issue/references/resolution-brief.md, charness-artifacts/issue/2026-07-17-issue-444-causal-review.md
  derived matches: plugins/charness/skills/issue/references/resolution-brief.md
...
- prompt-behavior-proof: Prompt-affecting instruction surfaces must follow deterministic Cautilus validation and on-demand proof policy.
  source matches: skills/public/issue/references/resolution-brief.md
...
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/check_issue_closeout_commit_msg.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/check_issue_closeout_commit_msg.py, tests/quality_gates/test_issue_closeout_commit_msg_hook.py, tests/test_check_issue_closeout_commit_msg_inprocess.py
  derived matches: plugins/charness/scripts/check_issue_closeout_commit_msg.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: scripts/check_issue_closeout_commit_msg.py
