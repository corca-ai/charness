...
- **Generated**: 2026-08-06T14:13:36Z
- **Prepared for**: pre-release critique for Charness 3.4.0 after release-surface repairs
- **Changed ref**: `d9a6baa4`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `6b5a41fd1e0d82f3f105808dbdf375260556f9dc5ed89f24fbb140a0f7a2d9db`
- **Reviewed paths**: 26
- **Sections**: 3
- **Overall ok**: True
...
```text
Changed paths for ref `d9a6baa4`:
- .agents/release-adapter.yaml
- charness-artifacts/release/v3.4.0-notes.md
- docs/development.md
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/closeout_bundle.py
  derived matches: plugins/charness/scripts/closeout_bundle.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/release/v3.4.0-notes.md, docs/development.md
