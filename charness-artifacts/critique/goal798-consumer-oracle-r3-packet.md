...
- **Generated**: 2026-09-06T00:35:30Z
- **Prepared for**: working tree
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `fbc91580936d0d01c5f4974b0076952d83dc748698e4f331a426dab63469a287`
- **Reviewed paths**: 20
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/goal798-consumer-oracle-r3-packet.json --packet-sha256 e9535152433e9a0274c170544c5552cc7bfb5ee42ace4e7c6e3e979a1304b1c2 --identity-sha256 fbc91580936d0d01c5f4974b0076952d83dc748698e4f331a426dab63469a287
```
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/probe/2026-09-06-consumer-journeys/protocol.md, evals/fixtures/consumer-journeys/create-cli-refresh/prompts/create-cli.md, evals/fixtures/consumer-journeys/spec-impl-alias/prompts/spec.md, charness-artifacts/critique/goal798-code-contracts-packet.md, charness-artifacts/critique/goal798-consumer-oracle-packet.md, charness-artifacts/critique/goal798-consumer-oracle-r2-packet.md
  verify: ./scripts/check-docs.sh, ./scripts/check-secrets.sh
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/goal798-code-contracts-packet.json, charness-artifacts/critique/goal798-code-contracts-packet.md, charness-artifacts/critique/goal798-consumer-oracle-packet.json, charness-artifacts/critique/goal798-consumer-oracle-packet.md, charness-artifacts/critique/goal798-consumer-oracle-r2-packet.json, charness-artifacts/critique/goal798-consumer-oracle-r2-packet.md, charness-artifacts/critique/workers/goal798-code-contracts/worker-report.yaml
...
- probe-artifacts: Checked-in host/runtime probe JSON artifacts used as closeout evidence.
  source matches: charness-artifacts/probe/2026-09-06-consumer-journeys/freeze.json, charness-artifacts/probe/2026-09-06-consumer-journeys/oracle-review-1.json, charness-artifacts/probe/2026-09-06-consumer-journeys/oracle-review-2.json, charness-artifacts/probe/2026-09-06-consumer-journeys/seed-disconfirmation.json
  verify: for path in charness-artifacts/probe/*.json; do python3 -m json.tool "$path" >/dev/null || exit $?; done
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_semantic_review_command.py
