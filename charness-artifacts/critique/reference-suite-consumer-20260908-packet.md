...
- **Generated**: 2026-09-07T21:47:35Z
- **Prepared for**: reference and authoring-suite local repair
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `362e1031a891d7f4a4c0b48da6c4d93c8f20c3abfcca8396a7642daea6934358`
- **Reviewed paths**: 8
  - `.agents/quality-gates.yaml`
  - `charness-artifacts/probe/2026-09-08-reference-and-suite-plan.md`
  - `docs/development.md`
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/reference-suite-consumer-20260908-packet.json --packet-sha256 399e94964aad08bb8a62dff58d315646f35226b5180737d80f62ca3b99a56fce --identity-sha256 362e1031a891d7f4a4c0b48da6c4d93c8f20c3abfcca8396a7642daea6934358
```
...
- charness-artifacts/critique/reference-suite-causal-20260908-packet.json
- charness-artifacts/critique/reference-suite-causal-20260908-packet.md
- charness-artifacts/debug/2026-09-08-consumer-path-and-pytest.md
- charness-artifacts/probe/2026-09-08-reference-and-suite-plan.md

Owning surfaces:
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/debug/latest.md, charness-artifacts/critique/reference-suite-causal-20260908-packet.md, charness-artifacts/debug/2026-09-08-consumer-path-and-pytest.md, charness-artifacts/probe/2026-09-08-reference-and-suite-plan.md
  verify: ./scripts/check-docs.sh, ./scripts/check-secrets.sh
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/reference-suite-causal-20260908-packet.json, charness-artifacts/critique/reference-suite-causal-20260908-packet.md
...
- debug-seam-risk-index: Generated source-linked index over debug artifact seam-risk fields.
  source matches: charness-artifacts/debug/latest.md, charness-artifacts/debug/2026-09-08-consumer-path-and-pytest.md
