...
- **Generated**: 2026-06-11T22:48:40Z
- **Prepared for**: web-fetch acquisition policy helper split
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/support/web-fetch/scripts/acquire_public_url.py, skills/support/web-fetch/scripts/acquire_public_url_policy.py
  derived matches: plugins/charness/support/web-fetch/scripts/acquire_public_url.py, plugins/charness/support/web-fetch/scripts/acquire_public_url_policy.py
