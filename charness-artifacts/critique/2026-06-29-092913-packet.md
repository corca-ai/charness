...
- **Generated**: 2026-06-29T09:29:13Z
- **Prepared for**: outcome-grader A/B wiring + validator
...
- plugins/charness/scripts/validate_outcome_assertions.py
...
- plugins/charness/scripts/skill_outcome_wiring.py
- scripts/skill_outcome_wiring.py
- tests/test_skill_efficiency_ab.py
- tests/test_skill_outcome_wiring.py
- tests/test_validate_outcome_assertions.py
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/run_skill_efficiency_ab.py, scripts/validate_outcome_assertions.py, skills/public/quality/references/attention-state-visibility.json, scripts/skill_outcome_wiring.py
  derived matches: plugins/charness/scripts/run_skill_efficiency_ab.py, plugins/charness/scripts/validate_outcome_assertions.py, plugins/charness/skills/quality/references/attention-state-visibility.json, plugins/charness/scripts/skill_outcome_wiring.py
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/quality/references/attention-state-visibility.json
  derived matches: plugins/charness/skills/quality/references/attention-state-visibility.json, charness-artifacts/find-skills/latest.json, charness-artifacts/find-skills/latest.md
...
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/run_skill_efficiency_ab.py, plugins/charness/scripts/validate_outcome_assertions.py, plugins/charness/scripts/skill_outcome_wiring.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/run_skill_efficiency_ab.py, scripts/validate_outcome_assertions.py, scripts/skill_outcome_wiring.py, tests/test_skill_efficiency_ab.py, tests/test_skill_outcome_wiring.py, tests/test_validate_outcome_assertions.py
  derived matches: plugins/charness/scripts/run_skill_efficiency_ab.py, plugins/charness/scripts/validate_outcome_assertions.py, plugins/charness/scripts/skill_outcome_wiring.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: scripts/run_skill_efficiency_ab.py, scripts/validate_outcome_assertions.py, scripts/skill_outcome_wiring.py
