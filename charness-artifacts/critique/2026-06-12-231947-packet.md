...
- **Generated**: 2026-06-12T23:19:47Z
- **Prepared for**: issue-359-resolution-critique
...
- plugins/charness/skills/achieve/scripts/goal_artifact_section_placeholders.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_goal_disposition_gate.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: skills/public/achieve/scripts/check_goal_artifact.py, skills/public/achieve/scripts/goal_artifact_closeout_evidence.py, skills/public/achieve/scripts/goal_artifact_lib.py, skills/public/achieve/scripts/goal_artifact_section_placeholders.py
