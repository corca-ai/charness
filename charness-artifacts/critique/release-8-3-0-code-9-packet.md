...
- **Generated**: 2026-09-04T02:39:50Z
- **Prepared for**: e191e89d4..5a332d7e8
- **Substrate mode**: `committed-ref`
- **Changed ref**: `e191e89d4..5a332d7e8`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `328112bdceb433b006e880638a0e1d0ca2f38e108ea4a3d150600441d958a9b1`
- **Reviewed paths**: 42
  ...
  - `charness-artifacts/critique/release-8-3-0-code-3-packet.json`
  - `charness-artifacts/critique/release-8-3-0-code-3-packet.md`
  - `charness-artifacts/critique/release-8-3-0-code-4-packet.json`
  - `charness-artifacts/critique/release-8-3-0-code-4-packet.md`
  - `charness-artifacts/critique/release-8-3-0-code-5-packet.json`
  - `charness-artifacts/critique/release-8-3-0-code-5-packet.md`
  - `charness-artifacts/critique/release-8-3-0-code-6-packet.json`
  - `charness-artifacts/critique/release-8-3-0-code-6-packet.md`
  - `charness-artifacts/critique/release-8-3-0-code-7-packet.json`
  - `charness-artifacts/critique/release-8-3-0-code-7-packet.md`
  ...
  - `tests/charness_cli/test_worktree_dependency_reuse.py`
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/release-8-3-0-code-9-packet.json --packet-sha256 aa257fac51e9a200bce6cae7f0b9a1363725af7a03559153162eb5461e6974cb --identity-sha256 328112bdceb433b006e880638a0e1d0ca2f38e108ea4a3d150600441d958a9b1
```
...
```text
Changed paths for ref `e191e89d4..5a332d7e8`:
- .agents/worktree-adapter.yaml
- .charness/792-reviewed-paths.txt
- charness
- charness-artifacts/critique/2026-09-04-worktree-dependency-reuse-792-release-8-3-0-critique.md
...
- materialized-plugin-export: Materialized plugin export and root marketplace artifacts derived from repo-owned source paths.
  source matches: integrations/worktree/adapter.example.yaml, integrations/worktree/manifest.schema.json, scripts/task_run/task_run.py, scripts/task_run/task_run_changed_line.py, scripts/task_run/task_run_completion.py, scripts/task_run/task_run_evidence.py, scripts/task_run/task_run_plan.py, scripts/task_run/task_run_scope.py, scripts/task_run/task_run_state.py, scripts/task_run/task_run_support.py, scripts/worktree/worktree_create_lib.py, scripts/worktree/worktree_dependency_reuse.py, scripts/worktree/worktree_doctor_lib.py, scripts/worktree/worktree_prepare.py, scripts/worktree/worktree_prepare_lib.py, skills/public/quality/references/attention-state-visibility.json, skills/public/setup/scripts/seed_worktree_adapter_lib.py, skills/public/setup/scripts/templates/worktree_adapter.yaml.txt, skills/public/setup/scripts/templates/worktree_dependency_reuse.yaml.txt
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/quality/references/attention-state-visibility.json, skills/public/setup/scripts/seed_worktree_adapter_lib.py, skills/public/setup/scripts/templates/worktree_adapter.yaml.txt, skills/public/setup/scripts/templates/worktree_dependency_reuse.yaml.txt
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-09-04-worktree-dependency-reuse-792-release-8-3-0-critique.md, charness-artifacts/critique/release-8-3-0-code-2-packet.json, charness-artifacts/critique/release-8-3-0-code-2-packet.md, charness-artifacts/critique/release-8-3-0-code-3-packet.json, charness-artifacts/critique/release-8-3-0-code-3-packet.md, charness-artifacts/critique/release-8-3-0-code-4-packet.json, charness-artifacts/critique/release-8-3-0-code-4-packet.md, charness-artifacts/critique/release-8-3-0-code-5-packet.json, charness-artifacts/critique/release-8-3-0-code-5-packet.md, charness-artifacts/critique/release-8-3-0-code-6-packet.json, charness-artifacts/critique/release-8-3-0-code-6-packet.md, charness-artifacts/critique/release-8-3-0-code-7-packet.json, charness-artifacts/critique/release-8-3-0-code-7-packet.md, charness-artifacts/critique/release-8-3-0-surface-1-packet.json, charness-artifacts/critique/release-8-3-0-surface-1-packet.md
