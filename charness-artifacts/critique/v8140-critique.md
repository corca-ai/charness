# Release Critique — charness v8.14.0 (minor)

- **Kind**: `charness.release-critique` (v1)
- **Prepared for**: v8.14.0-release (supersedes v8130-critique.md: v8.13.0 tag taken)
...
Note: v8.13.0 was first assumed, but that tag already exists on origin
(pointing at 8885601c3, the #866-869 batch; no GitHub release attached),
so this batch ships as v8.14.0. The reviewed delta is unchanged.
