...
- **Generated**: 2026-08-05T23:13:30Z
- **Prepared for**: issue-513-hook-failure-visibility-final-final
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `7dbbc644b15f00fe9a8a7411e12df8bf514baa7e057c47d0b8e550c170659ead`
- **Reviewed paths**: 8
- **Sections**: 3
- **Overall ok**: True
...
- charness-artifacts/critique/2026-08-06-issue-513-hook-failure-visibility-closeout-packet.json
- charness-artifacts/critique/2026-08-06-issue-513-hook-failure-visibility-closeout-packet.md
- charness-artifacts/critique/2026-08-06-issue-513-hook-failure-visibility-resolution-critique.md
- charness-artifacts/issue/2026-08-06-issue-513-closeout-commit-message.md
...
- plugins/charness/skills/setup/references/hook-failure-visibility.md
- skills/public/setup/SKILL.md
- skills/public/setup/references/bootstrap-seams.md
- skills/public/setup/references/hook-failure-visibility.md
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/setup/SKILL.md, skills/public/setup/references/bootstrap-seams.md, skills/public/setup/references/hook-failure-visibility.md
  derived matches: plugins/charness/skills/setup/SKILL.md, plugins/charness/skills/setup/references/bootstrap-seams.md, plugins/charness/skills/setup/references/hook-failure-visibility.md
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/critique/2026-08-06-issue-513-hook-failure-visibility-closeout-packet.md, charness-artifacts/critique/2026-08-06-issue-513-hook-failure-visibility-resolution-critique.md, charness-artifacts/issue/2026-08-06-issue-513-closeout-commit-message.md, docs/worktree-prepare.md, skills/public/setup/SKILL.md, skills/public/setup/references/bootstrap-seams.md, skills/public/setup/references/hook-failure-visibility.md
  derived matches: plugins/charness/skills/setup/SKILL.md, plugins/charness/skills/setup/references/bootstrap-seams.md, plugins/charness/skills/setup/references/hook-failure-visibility.md
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-08-06-issue-513-hook-failure-visibility-closeout-packet.json, charness-artifacts/critique/2026-08-06-issue-513-hook-failure-visibility-closeout-packet.md, charness-artifacts/critique/2026-08-06-issue-513-hook-failure-visibility-resolution-critique.md
  verify: python3 scripts/validate_critique_artifacts.py --repo-root . --all
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_setup_hook_failure_guidance.py
