...
- **Generated**: 2026-09-21T10:06:58Z
- **Prepared for**: working tree
- **Prepared targets**: 6
  - `task-run-persist-scope`
  - `release-resume-notes-placeholder`
  - `staged-eviction-owner`
  - `worker-expected-targets`
  - `prepared-target-worker-wiring`
  - `lane-target-declaration`
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `61980aa61e018101fb70232df87fea73a8a46e7fde7183a960ab68164cb6e20f`
- **Reviewed paths**: 22
  - `.githooks/pre-commit`
  ...
  - `skills/public/critique/scripts/run_review_invocation.py`
  ...
  - `tests/quality_gates/test_module_eviction_form_gate.py`
  - `tests/quality_gates/test_release_run_planner_prepared_stop.py`
  - `tests/quality_gates/test_review_target_coverage_floor.py`
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/v895-release-critique-b2-packet.json --packet-sha256 cfdc66e1ebdbab061d27fc4e8c5b0147ea7d3ce7f3efb097e21f9bb3d40d7d60 --identity-sha256 61980aa61e018101fb70232df87fea73a8a46e7fde7183a960ab68164cb6e20f
```
...
- materialized-plugin-export: Materialized plugin export and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/gates/check_module_eviction_form.py, scripts/hooks/check_staged_cheap_owners.py, scripts/task_run/task_run_completion.py, scripts/task_run/task_run_git.py, scripts/task_run/task_run_lane_runner.py, skills/public/critique/references/prepare-packet.md, skills/public/critique/scripts/run_review.py, skills/public/critique/scripts/run_review_execution.py, skills/public/critique/scripts/run_review_invocation.py, skills/public/critique/scripts/run_review_packet.py, skills/public/release/scripts/plan_release_run_packets.py, skills/shared/scripts/reviewer_result_contract.py, skills/shared/scripts/reviewer_worker_runner_support.py, skills/shared/scripts/run_reviewer_worker.py
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/critique/references/prepare-packet.md, skills/public/critique/scripts/run_review.py, skills/public/critique/scripts/run_review_execution.py, skills/public/critique/scripts/run_review_invocation.py, skills/public/critique/scripts/run_review_packet.py, skills/public/release/scripts/plan_release_run_packets.py, skills/shared/scripts/reviewer_result_contract.py, skills/shared/scripts/reviewer_worker_runner_support.py, skills/shared/scripts/run_reviewer_worker.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/gates/check_module_eviction_form.py, scripts/hooks/check_staged_cheap_owners.py, scripts/task_run/task_run_completion.py, scripts/task_run/task_run_git.py, scripts/task_run/task_run_lane_runner.py, tests/charness_cli/test_task_run_completion.py, tests/quality_gates/test_module_eviction_form_gate.py, tests/quality_gates/test_release_run_planner_prepared_stop.py, tests/quality_gates/test_review_target_coverage_floor.py, tests/quality_gates/test_reviewer_runner.py, tests/quality_gates/test_semantic_review_command.py, tests/quality_gates/test_staged_cheap_owners.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: scripts/gates/check_module_eviction_form.py, scripts/hooks/check_staged_cheap_owners.py, scripts/task_run/task_run_completion.py, scripts/task_run/task_run_git.py, scripts/task_run/task_run_lane_runner.py, skills/public/critique/scripts/run_review.py, skills/public/critique/scripts/run_review_execution.py, skills/public/critique/scripts/run_review_invocation.py, skills/public/critique/scripts/run_review_packet.py, skills/public/release/scripts/plan_release_run_packets.py
