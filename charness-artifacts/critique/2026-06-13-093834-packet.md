...
- **Generated**: 2026-06-13T09:38:34Z
- **Prepared for**: achieve-efficiency Slice 2 (B) diff
...
- tests/quality_gates/test_slice_closeout_overslice_advisory.py
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/run_slice_closeout.py, scripts/slice_closeout_advisories.py, skills/public/achieve/references/goal-artifact.md, skills/public/achieve/references/lifecycle.md, skills/public/achieve/scripts/goal_artifact_template.md, skills/public/critique/references/cadence.md, skills/shared/references/meaningful-slice-cadence.md
  derived matches: plugins/charness/scripts/run_slice_closeout.py, plugins/charness/scripts/slice_closeout_advisories.py, plugins/charness/shared/references/meaningful-slice-cadence.md, plugins/charness/skills/achieve/references/goal-artifact.md, plugins/charness/skills/achieve/references/lifecycle.md, plugins/charness/skills/achieve/scripts/goal_artifact_template.md, plugins/charness/skills/critique/references/cadence.md
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/spec/achieve-efficiency-improvements.md, skills/public/achieve/references/goal-artifact.md, skills/public/achieve/references/lifecycle.md, skills/public/achieve/scripts/goal_artifact_template.md, skills/public/critique/references/cadence.md, skills/shared/references/meaningful-slice-cadence.md
...
- prompt-behavior-proof: Prompt-affecting instruction surfaces must follow deterministic Cautilus validation and on-demand proof policy.
  source matches: skills/public/achieve/references/goal-artifact.md, skills/public/achieve/references/lifecycle.md, skills/public/critique/references/cadence.md, skills/shared/references/meaningful-slice-cadence.md
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/achieve/references/goal-artifact.md, skills/public/achieve/references/lifecycle.md, skills/public/achieve/scripts/goal_artifact_template.md, skills/public/critique/references/cadence.md, skills/shared/references/meaningful-slice-cadence.md
  derived matches: plugins/charness/shared/references/meaningful-slice-cadence.md, plugins/charness/skills/achieve/references/goal-artifact.md, plugins/charness/skills/achieve/references/lifecycle.md, plugins/charness/skills/achieve/scripts/goal_artifact_template.md, plugins/charness/skills/critique/references/cadence.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/run_slice_closeout.py, scripts/slice_closeout_advisories.py, tests/quality_gates/test_slice_closeout_overslice_advisory.py
  derived matches: plugins/charness/scripts/run_slice_closeout.py, plugins/charness/scripts/slice_closeout_advisories.py
