...
- **Generated**: 2026-07-11T08:25:41Z
- **Prepared for**: retro argparse help code review
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/retro/scripts/mine_closeout_telemetry.py, skills/public/retro/scripts/plan_retro_run.py, skills/public/retro/scripts/prepare_packet.py
  derived matches: plugins/charness/skills/retro/scripts/mine_closeout_telemetry.py, plugins/charness/skills/retro/scripts/plan_retro_run.py, plugins/charness/skills/retro/scripts/prepare_packet.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/test_retro_help.py
