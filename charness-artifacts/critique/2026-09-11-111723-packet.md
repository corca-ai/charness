...
- **Generated**: 2026-09-11T11:17:23Z
- **Prepared for**: bd1272ac81fcbe6d1b27bb3a8d5e9370ab7f7ecb
- **Substrate mode**: `committed-ref`
- **Changed ref**: `bd1272ac81fcbe6d1b27bb3a8d5e9370ab7f7ecb`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `458aa368238c94c7aeedde6c738c1a13817b8301ab6af6bb6c321a8940426a8e`
- **Reviewed paths**: 6
  - `docs/public-skill-dogfood.json`
  - `skills/public/achieve/SKILL.md`
  - `skills/public/achieve/references/coordination.md`
  - `skills/shared/references/generative-sequence.md`
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/2026-09-11-111723-packet.json --packet-sha256 ba4aa76661eb16dba726a4f0f14b94f886c1289ac19459182e040062f4bff1f5 --identity-sha256 458aa368238c94c7aeedde6c738c1a13817b8301ab6af6bb6c321a8940426a8e
```
...
```text
Changed paths for ref `bd1272ac81fcbe6d1b27bb3a8d5e9370ab7f7ecb`:
- docs/public-skill-dogfood.json
- skills/public/achieve/SKILL.md
- skills/public/achieve/references/coordination.md
- skills/shared/references/generative-sequence.md
...
- materialized-plugin-export: Materialized plugin export and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/achieve/SKILL.md, skills/public/achieve/references/coordination.md, skills/shared/references/generative-sequence.md
...
- public-skill-dogfood: Checked-in consumer dogfood cases for public skills and the validator that keeps them aligned with current skill contracts.
  source matches: docs/public-skill-dogfood.json, skills/public/achieve/SKILL.md, skills/public/achieve/references/coordination.md, skills/shared/references/generative-sequence.md
