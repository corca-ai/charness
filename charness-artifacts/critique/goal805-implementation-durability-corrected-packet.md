...
- **Generated**: 2026-09-06T07:47:16Z
- **Prepared for**: Goal 805 durability follow-up for implementation closeout
- **Prepared targets**: 5
...
- **Reviewed input identity**: `6d3c0aca5df65fb268cb77d82deff51858237644c8e20d40c407243c451522ef`
- **Reviewed paths**: 5
  - `charness-artifacts/critique/workers/goal805-implementation-closeout-scope-correction/worker-report.yaml`
  - `charness-artifacts/goal-runs/805/reviews/durability-input-comparison-corrected.json`
  - `charness-artifacts/goal-runs/805/reviews/implementation-closeout-scope-correction.json`
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/goal805-implementation-durability-corrected-packet.json --packet-sha256 f10e367247f3dc21f38d4cf46ccffcafd6e5c99467b1486a55a0641aefd449f7 --identity-sha256 6d3c0aca5df65fb268cb77d82deff51858237644c8e20d40c407243c451522ef
```
...
- charness-artifacts/probe/2026-09-06-release-scheduling/observations.md
- charness-artifacts/critique/goal805-implementation-durability-followup-packet.json
- charness-artifacts/critique/goal805-implementation-durability-followup-packet.md
- charness-artifacts/goal-runs/805/reviews/durability-input-comparison-corrected.json
- charness-artifacts/goal-runs/805/reviews/durability-input-comparison.json
- charness-artifacts/probe/2026-09-06-release-scheduling/runtime-rows.json

Owning surfaces:
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/probe/2026-09-06-release-scheduling/observations.md, charness-artifacts/critique/goal805-implementation-durability-followup-packet.md
  verify: ./scripts/check-docs.sh, ./scripts/check-secrets.sh
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/goal805-implementation-durability-followup-packet.json, charness-artifacts/critique/goal805-implementation-durability-followup-packet.md
...
- probe-artifacts: Checked-in host/runtime probe JSON artifacts used as closeout evidence.
  source matches: charness-artifacts/probe/2026-09-06-release-scheduling/runtime-rows.json
...
- goal-run-evidence: Durable Goal Run provider plans, operations, observations, graph snapshots, and evidence-lineage records.
  source matches: charness-artifacts/goal-runs/805/reviews/durability-input-comparison-corrected.json, charness-artifacts/goal-runs/805/reviews/durability-input-comparison.json
