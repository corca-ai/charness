...
- **Generated**: 2026-06-12T00:43:17Z
- **Prepared for**: goal-closeout stub roundtrip slice post-fix
...
- charness-artifacts/critique/2026-06-12-003935-packet.json
- charness-artifacts/critique/2026-06-12-003935-packet.md
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/check_artifact_surface_preflight.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/goals/2026-06-12-quality-cadence-duplicate-followup.md, docs/conventions/authoring-preflight.md, charness-artifacts/critique/2026-06-12-003935-packet.md
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-06-12-003935-packet.json, charness-artifacts/critique/2026-06-12-003935-packet.md
  verify: python3 scripts/validate_critique_artifacts.py --repo-root . --all
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/check_artifact_surface_preflight.py, tests/quality_gates/test_check_artifact_surface_preflight.py
