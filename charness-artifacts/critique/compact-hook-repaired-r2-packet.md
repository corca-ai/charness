...
- **Generated**: 2026-08-26T01:08:36Z
- **Prepared for**: Codex compact recovery hook repaired surface
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `8b02479f85024aae9061fa1cbe4679307145da24f18e78f2dcb24032e724dc9f`
- **Reviewed paths**: 8
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/compact-hook-repaired-r2-packet.json --packet-sha256 b6e9f2dcafc7289c54975ae4007966ee45780607628e8009ba1f749f0900c88d --identity-sha256 8b02479f85024aae9061fa1cbe4679307145da24f18e78f2dcb24032e724dc9f
```
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/host_hook_session_routing.py, scripts/session_start_routing.py, scripts/session_start_codex_recovery.py
  derived matches: plugins/charness/scripts/host_hook_session_routing.py, plugins/charness/scripts/session_start_routing.py, plugins/charness/scripts/session_start_codex_recovery.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/host_hook_session_routing.py, scripts/session_start_routing.py, tests/test_session_routing_host_hook_reconcile.py, tests/test_session_start_routing.py, scripts/session_start_codex_recovery.py
  derived matches: plugins/charness/scripts/host_hook_session_routing.py, plugins/charness/scripts/session_start_routing.py, plugins/charness/scripts/session_start_codex_recovery.py
