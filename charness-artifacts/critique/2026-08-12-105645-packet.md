...
- **Generated**: 2026-08-12T10:56:45Z
- **Prepared for**: issue-594-closeout-draft-scope
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `4012dea3a058cf243888527a9c86c5492c0ace35253ff059c7e4e8a2ee2e038a`
- **Reviewed paths**: 15
- **Sections**: 3
- **Overall ok**: True
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/issue/scripts/describe_closeout_draft_shape.py, skills/public/issue/scripts/issue_close_comment_floor.py, skills/public/issue/scripts/issue_closeout_classification_ledger.py, skills/public/issue/scripts/issue_verify_closeout.py, skills/public/issue/scripts/issue_verify_closeout_body.py
  derived matches: plugins/charness/skills/issue/scripts/describe_closeout_draft_shape.py, plugins/charness/skills/issue/scripts/issue_close_comment_floor.py, plugins/charness/skills/issue/scripts/issue_closeout_classification_ledger.py, plugins/charness/skills/issue/scripts/issue_verify_closeout.py, plugins/charness/skills/issue/scripts/issue_verify_closeout_body.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/debug/2026-08-12-issue-594-closeout-draft-scope-debug.md, charness-artifacts/quality/2026-08-12-issue-594-closeout-draft-scope.md
...
- debug-seam-risk-index: Generated source-linked index over debug artifact seam-risk fields.
  source matches: charness-artifacts/debug/2026-08-12-issue-594-closeout-draft-scope-debug.md
...
- closeout-floor-matrix: Declared floor x classification x carrier matrix for issue closeout, and the behavioral probe that re-derives it from the real carriers.
  source matches: skills/public/issue/scripts/issue_close_comment_floor.py, skills/public/issue/scripts/issue_closeout_classification_ledger.py, skills/public/issue/scripts/issue_verify_closeout.py, skills/public/issue/scripts/issue_verify_closeout_body.py
