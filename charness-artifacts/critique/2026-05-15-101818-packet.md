...
- **Generated**: 2026-05-15T10:18:18Z
- **Prepared for**: mutmut removal cosmic ray migration
...
- charness-artifacts/quality/history/2026-05-14-mutation-testing-dogfood.md
- docs/handoff.md
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/check_mutation_score.py, skills/public/quality/references/adapter-contract.md, skills/public/quality/references/mutation-testing.md, scripts/run_cosmic_ray_mutation.py, scripts/sample_mutation_files.py
  derived matches: plugins/charness/scripts/check_mutation_score.py, plugins/charness/skills/quality/references/adapter-contract.md, plugins/charness/skills/quality/references/mutation-testing.md, plugins/charness/scripts/run_cosmic_ray_mutation.py, plugins/charness/scripts/sample_mutation_files.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/find-skills/latest.md, charness-artifacts/quality/history/2026-05-14-mutation-testing-dogfood.md, docs/handoff.md, skills/public/quality/references/adapter-contract.md, skills/public/quality/references/mutation-testing.md
  derived matches: plugins/charness/skills/quality/references/adapter-contract.md, plugins/charness/skills/quality/references/mutation-testing.md
...
- prompt-behavior-proof: Prompt-affecting instruction surfaces must follow deterministic Cautilus validation and on-demand proof policy.
  source matches: .agents/quality-adapter.yaml, skills/public/quality/references/adapter-contract.md, skills/public/quality/references/mutation-testing.md
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/quality/references/adapter-contract.md, skills/public/quality/references/mutation-testing.md
  derived matches: charness-artifacts/find-skills/latest.json, charness-artifacts/find-skills/latest.md, plugins/charness/skills/quality/references/adapter-contract.md, plugins/charness/skills/quality/references/mutation-testing.md
...
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/check_mutation_score.py, plugins/charness/scripts/run_cosmic_ray_mutation.py, plugins/charness/scripts/sample_mutation_files.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: pyproject.toml, tests/quality_gates/test_quality_mutation_testing.py
