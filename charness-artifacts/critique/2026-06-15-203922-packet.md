...
- **Generated**: 2026-06-15T20:39:22Z
- **Prepared for**: check-coverage runtime reduction
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/check_coverage.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/check_coverage.py, tests/quality_gates/test_check_coverage_inventory.py, tests/quality_gates/test_repo_copy_invariants.py, tests/repo_copy.py
