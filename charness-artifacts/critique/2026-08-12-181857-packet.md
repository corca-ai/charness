...
- **Generated**: 2026-08-12T18:18:57Z
- **Prepared for**: 5.1.0 release notes and decision
- **Changed ref**: `v5.0.1..HEAD`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `0330562a08235a97250e42587d1fe3f8b9632def9809477906fe8e8d0af2c315`
- **Reviewed paths**: 1
- **Sections**: 3
- **Overall ok**: True
...
```text
Changed paths for ref `v5.0.1..HEAD`:
...
- charness-artifacts/probe/2026-08-12-v5.0.1-release-observer.json
...
- retro-lesson-selection-index: Durable retro prepare packets and generated advisory index for source-linked retro lesson digest selection.
  source matches: charness-artifacts/retro/2026-08-12-180732-packet.json, charness-artifacts/retro/2026-08-12-180732-packet.md, charness-artifacts/retro/2026-08-12-session-release-closeout-packet.json, charness-artifacts/retro/2026-08-12-session-release-closeout-packet.md, charness-artifacts/retro/2026-08-12-session-retro.md, charness-artifacts/retro/2026-08-13-session-retro.md, charness-artifacts/retro/recent-lessons.md
...
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/boundary-bypass-baseline.json, plugins/charness/scripts/boundary_bypass_ratchet_lib.py, plugins/charness/scripts/check_boundary_bypass_ratchet.py, plugins/charness/scripts/check_quality_tool_fixtures.py, plugins/charness/scripts/evidence_boundary_crosswalk.py, plugins/charness/scripts/public_skill_dogfood_lib.py, plugins/charness/scripts/readme_proof_ledger_lib.py, plugins/charness/scripts/run-quality.sh, plugins/charness/scripts/session_start_routing.py, plugins/charness/scripts/suggest_public_skill_dogfood.py, plugins/charness/scripts/validate_presets.py
