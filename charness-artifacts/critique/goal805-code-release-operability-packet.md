...
- **Generated**: 2026-09-06T04:19:27Z
- **Prepared for**: Goal 805 release scheduling code; design pass is not code approval
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `0578880a0b7a90a9e2e0315817cd0bc73479a2448338bc8ce77a6e040b573436`
- **Reviewed paths**: 17
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/goal805-code-release-operability-packet.json --packet-sha256 435f50d4c04b84011e235b27555679dac7749304965f297adba9257a07ea9aa7 --identity-sha256 0578880a0b7a90a9e2e0315817cd0bc73479a2448338bc8ce77a6e040b573436
```
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/goals/2026-09-06-long-term-delegation-net-value-items/release-reuse.md, docs/development.md, skills/public/release/references/adapter-contract.md, charness-artifacts/critique/goal805-code-release-integrity-packet.md, charness-artifacts/critique/goal805-design-release-repair-packet.md, charness-artifacts/probe/2026-09-06-release-scheduling/observations.md
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/goal805-code-release-integrity-packet.json, charness-artifacts/critique/goal805-code-release-integrity-packet.md, charness-artifacts/critique/goal805-design-release-repair-packet.json, charness-artifacts/critique/goal805-design-release-repair-packet.md, charness-artifacts/critique/workers/goal805-design-release-repair/worker-report.yaml
