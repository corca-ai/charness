...
- **Generated**: 2026-06-16T00:42:28Z
- **Prepared for**: issue-375-achieve-scaffold-adapter
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: skills/public/achieve/references/adapter-contract.md, skills/public/achieve/scripts/goal_artifact_template.md
  derived matches: plugins/charness/skills/achieve/references/adapter-contract.md, plugins/charness/skills/achieve/scripts/goal_artifact_template.md
...
- prompt-behavior-proof: Prompt-affecting instruction surfaces must follow deterministic Cautilus validation and on-demand proof policy.
  source matches: skills/public/achieve/references/adapter-contract.md
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_achieve_adapter_policy.py, tests/quality_gates/test_goal_artifact_scaffold.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: skills/public/achieve/scripts/achieve_adapter_policy.py, skills/public/achieve/scripts/goal_artifact_lib.py, skills/public/achieve/scripts/init_adapter.py, skills/public/achieve/scripts/goal_artifact_scaffold.py
