...
- **Generated**: 2026-06-04T11:52:08Z
- **Prepared for**: issue-298-handoff-publication-closeout
...
- plugins/charness/skills/handoff/scripts/chunked_routing_agentic.py
...
- skills/public/handoff/scripts/chunked_routing_agentic.py
...
- plugins/charness/skills/handoff/scripts/chunked_routing_agentic_facts.py
- skills/public/handoff/scripts/chunked_routing_agentic_facts.py
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/achieve/references/lifecycle.md, skills/public/handoff/scripts/chunked_routing_agentic.py, skills/public/issue/references/closeout-discipline.md, skills/public/retro/references/phase-aware-efficiency.md, skills/public/handoff/scripts/chunked_routing_agentic_facts.py
  derived matches: plugins/charness/skills/achieve/references/lifecycle.md, plugins/charness/skills/handoff/scripts/chunked_routing_agentic.py, plugins/charness/skills/issue/references/closeout-discipline.md, plugins/charness/skills/retro/references/phase-aware-efficiency.md, plugins/charness/skills/handoff/scripts/chunked_routing_agentic_facts.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: skills/public/achieve/references/lifecycle.md, skills/public/issue/references/closeout-discipline.md, skills/public/retro/references/phase-aware-efficiency.md
  derived matches: plugins/charness/skills/achieve/references/lifecycle.md, plugins/charness/skills/issue/references/closeout-discipline.md, plugins/charness/skills/retro/references/phase-aware-efficiency.md
...
- public-skill-dogfood: Checked-in consumer dogfood cases for public skills and the validator that keeps them aligned with current skill contracts.
  source matches: docs/public-skill-dogfood.json, skills/public/achieve/references/lifecycle.md, skills/public/handoff/scripts/chunked_routing_agentic.py, skills/public/issue/references/closeout-discipline.md, skills/public/retro/references/phase-aware-efficiency.md, skills/public/handoff/scripts/chunked_routing_agentic_facts.py
  verify: python3 scripts/validate_public_skill_dogfood.py --repo-root .
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_issue_closeout_discipline.py, tests/quality_gates/test_retro_skill.py, tests/test_handoff_chunker_agentic_packages.py
