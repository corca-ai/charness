...
- **Generated**: 2026-08-21T10:22:22Z
- **Prepared for**: R3 exact semantic candidate: delivery provenance, same-version content readback, scoped recovery, and failure-aware init/update
- **Changed ref**: `f98a4e8e2936ab60870018ec1b3722d475a458e7..7676ec51aeed99e215106dd8490332e57db80d07`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `21b105b641d5f5aabfe7c02469b7daf531676bdb8cc17ab63814c631cec4bc79`
- **Reviewed paths**: 3
- **Sections**: 3
...
```text
Changed paths for ref `f98a4e8e2936ab60870018ec1b3722d475a458e7..7676ec51aeed99e215106dd8490332e57db80d07`:
- charness
...
- charness-artifacts/critique/2026-08-21-r3-integrated-semantic-candidate-full-packet.json
- charness-artifacts/critique/2026-08-21-r3-integrated-semantic-candidate-full-packet.md
- charness-artifacts/critique/2026-08-21-r3-integrated-semantic-candidate-review.md
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/critique/2026-08-06-041231-packet.md, charness-artifacts/critique/2026-08-06-slice-3-final-bundle-contract.md, charness-artifacts/critique/2026-08-21-r3-integrated-semantic-candidate-full-packet.md, charness-artifacts/critique/2026-08-21-r3-integrated-semantic-candidate-review.md
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-08-06-041231-packet.md, charness-artifacts/critique/2026-08-06-slice-3-final-bundle-contract.md, charness-artifacts/critique/2026-08-21-r3-integrated-semantic-candidate-full-packet.json, charness-artifacts/critique/2026-08-21-r3-integrated-semantic-candidate-full-packet.md, charness-artifacts/critique/2026-08-21-r3-integrated-semantic-candidate-review.md
  verify: python3 scripts/validate_critique_artifacts.py --repo-root . --all
- repo-python: Repo-owned Python code and tests.
  source matches: charness, tests/charness_cli/test_codex_cache_refresh.py, tests/charness_cli/test_yaml_output_branch_coverage.py
