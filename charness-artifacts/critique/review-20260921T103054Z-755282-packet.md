...
- **Generated**: 2026-09-21T01:30:54Z
- **Prepared for**: working tree
- **Prepared targets**: 1
  - `corca-ai/charness#764`
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `2e3d02537fda51d4b1ece7fc324ebf7f39dfa9c1f4ab14e95cfa0c6af0b5a594`
- **Reviewed paths**: 4
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/review-20260921T103054Z-755282-packet.json --packet-sha256 609fbefe91e6e7711ea7181a92156e62bd678cb22fb3f8c4384dd8ffe4e72f3f --identity-sha256 2e3d02537fda51d4b1ece7fc324ebf7f39dfa9c1f4ab14e95cfa0c6af0b5a594
```
...
- materialized-plugin-export: Materialized plugin export and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/mutation/mutate_and_restore.py, scripts/mutation/mutation_expected_failure.py, scripts/mutation/mutation_test_reporters.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/mutation/mutate_and_restore.py, scripts/mutation/mutation_expected_failure.py, scripts/mutation/mutation_test_reporters.py, tests/quality_gates/test_mutation_test_reporters.py
