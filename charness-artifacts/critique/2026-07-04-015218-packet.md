...
- **Generated**: 2026-07-04T01:52:18Z
- **Prepared for**: achieve phase-brief demote slice
...
- plugins/charness/skills/achieve/scripts/goal_artifact_phase_brief.py
- skills/public/achieve/scripts/goal_artifact_phase_brief.py
- tests/quality_gates/test_achieve_phase_brief.py
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/achieve/SKILL.md, skills/public/achieve/scripts/check_goal_artifact.py, skills/public/achieve/scripts/goal_artifact_phase_brief.py
  derived matches: plugins/charness/skills/achieve/SKILL.md, plugins/charness/skills/achieve/scripts/check_goal_artifact.py, plugins/charness/skills/achieve/scripts/goal_artifact_phase_brief.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: skills/public/achieve/SKILL.md
  derived matches: plugins/charness/skills/achieve/SKILL.md
...
- claim-fidelity-specs: Per-skill Cautilus claim-fidelity specs and registry: each public skill's reference-engagement classification proving a real /charness:<skill> run honors its own reference routing.
  source matches: evals/cautilus/achieve-claim-fidelity/spec.json
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/quality_gates/test_achieve_phase_brief.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: skills/public/achieve/scripts/check_goal_artifact.py, skills/public/achieve/scripts/goal_artifact_phase_brief.py
