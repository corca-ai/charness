...
- **Generated**: 2026-05-29T03:41:33Z
- **Prepared for**: issue-246-resolution-critique
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/handoff/references/chunked-routing.md, skills/public/handoff/scripts/draft_goal_from_chunk.py
  derived matches: plugins/charness/skills/handoff/references/chunked-routing.md, plugins/charness/skills/handoff/scripts/draft_goal_from_chunk.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: docs/handoff-chunked-routing.md, skills/public/handoff/references/chunked-routing.md
