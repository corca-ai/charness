...
- **Generated**: 2026-05-26T11:58:38Z
- **Prepared for**: issue-220-find-skills-public-skill-recommendations
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: skills/public/find-skills/SKILL.md, skills/public/find-skills/scripts/inventory_artifact.py, skills/public/find-skills/scripts/list_capabilities.py, skills/public/find-skills/scripts/list_capabilities_lib.py, skills/public/find-skills/scripts/public_skill_recommendations.py
  derived matches: plugins/charness/skills/find-skills/SKILL.md, plugins/charness/skills/find-skills/scripts/inventory_artifact.py, plugins/charness/skills/find-skills/scripts/list_capabilities.py, plugins/charness/skills/find-skills/scripts/list_capabilities_lib.py, plugins/charness/skills/find-skills/scripts/public_skill_recommendations.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/find-skills/latest.md, skills/public/find-skills/SKILL.md
  derived matches: plugins/charness/skills/find-skills/SKILL.md
...
- prompt-behavior-proof: Prompt-affecting instruction surfaces must follow deterministic Cautilus validation and on-demand proof policy.
  source matches: skills/public/find-skills/SKILL.md
...
- skill-packages: Public and support skill packages plus their helper scripts.
  source matches: skills/public/find-skills/SKILL.md, skills/public/find-skills/scripts/inventory_artifact.py, skills/public/find-skills/scripts/list_capabilities.py, skills/public/find-skills/scripts/list_capabilities_lib.py, skills/public/find-skills/scripts/public_skill_recommendations.py
  derived matches: charness-artifacts/find-skills/latest.json, charness-artifacts/find-skills/latest.md, plugins/charness/skills/find-skills/SKILL.md, plugins/charness/skills/find-skills/scripts/inventory_artifact.py, plugins/charness/skills/find-skills/scripts/list_capabilities.py, plugins/charness/skills/find-skills/scripts/list_capabilities_lib.py, plugins/charness/skills/find-skills/scripts/public_skill_recommendations.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: tests/test_find_skills_task_recommendations.py
