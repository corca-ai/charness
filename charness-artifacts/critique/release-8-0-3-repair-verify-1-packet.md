...
- **Generated**: 2026-09-03T09:50:55Z
- **Prepared for**: release 8.0.3 lock-in, repaired tree
- **Substrate mode**: `working-tree`
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `97791ed64da4582894d15ed346e16188ec19178d6eca129e6299ebd8b1749219`
- **Reviewed paths**: 54
...
```sh
python3 skills/public/critique/scripts/verify_packet.py --repo-root . --packet-path charness-artifacts/critique/release-8-0-3-repair-verify-1-packet.json --packet-sha256 6b534daa2a258cf59353893ab207cc8d395217b57ebab35b7d3d70fa0d097c60 --identity-sha256 97791ed64da4582894d15ed346e16188ec19178d6eca129e6299ebd8b1749219
```
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/release/v8.0.3-notes.md, charness-artifacts/critique/release-8-0-3-critique.md
...
- operational-evidence-records: Durable issue, quality, and release evidence attachments produced by local planning and closeout workflows.
  source matches: charness-artifacts/release/v8.0.3-notes.md
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/release-8-0-3-critique.md
