...
- **Generated**: 2026-08-24T10:34:33Z
- **Prepared for**: issue-713 implementation candidate
- **Adapter**: `.agents/critique-adapter.yaml`
- **Reviewed input identity**: `eccbd039fc9ba9ddbb60773300430a011d994b21de4380a1d848e58d32a7ea95`
- **Reviewed paths**: 8
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/check_skill_contracts.py, scripts/run_slice_closeout.py, skills/public/impl/SKILL.md
  derived matches: plugins/charness/scripts/check_skill_contracts.py, plugins/charness/scripts/run_slice_closeout.py, plugins/charness/skills/impl/SKILL.md
...
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/check_skill_contracts.py, plugins/charness/scripts/run_slice_closeout.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/check_skill_contracts.py, scripts/run_slice_closeout.py, tests/quality_gates/test_run_slice_closeout_review_obligations.py, tests/quality_gates/test_skill_docs_contracts.py
  derived matches: plugins/charness/scripts/check_skill_contracts.py, plugins/charness/scripts/run_slice_closeout.py
...
- python-scan-hygiene: Repo and skill Python that traverses the filesystem must stay gitignore-aware, so a committed non-gitignore-aware scanner does not ship latent until the next push.
  source matches: scripts/check_skill_contracts.py, scripts/run_slice_closeout.py
