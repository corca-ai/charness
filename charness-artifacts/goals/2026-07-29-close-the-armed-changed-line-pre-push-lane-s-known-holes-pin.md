...
### Slice 4: Slice 4 — the publish refusal stops passing on what it could not read

- Objective: Split unreadable from absent in the release publish refusal, so a directory nobody could list stops reading as 'this repo drafts no notes'.
