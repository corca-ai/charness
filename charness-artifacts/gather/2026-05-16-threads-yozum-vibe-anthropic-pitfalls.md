...
- Source: https://www.threads.com/@yozum.vibe/post/DYWfaTiifEs
...
```json
{
  "source_url": "https://www.threads.com/@yozum.vibe/post/DYWfaTiifEs",
  "route": {
    "input_url": "https://www.threads.com/@yozum.vibe/post/DYWfaTiifEs",
    "normalized_host": "threads.com",
  ...
  "attempts": [
    {
      ...
      "classification": {
        ...
        "proof": [
          {
            "type": "regex",
            "value": "Anthropic|Haiku|Sonnet|idempotency|529|prompt caching"
          }
        ],
        "proof_errors": [],
        "fallback_candidates": [
    ...
    },
    {
      ...
      "classification": {
        ...
        "text_length": 4398,
        "matched_signals": [
          "regex:Anthropic|Haiku|Sonnet|idempotency|529|prompt caching"
        ],
        "signals": [
          "positive-proof"
        ],
