...
## Goal Run proof-policy amendment (2026-08-30)

Operator approval in session `goal-744-2026-08-30` removes hosted Mutation Tests and mutation-score evidence from this Goal Run's child-close and parent-close proof policy. #758 closes as `decision-needed` / `not planned` without any successful-mutation or behavioral-fix claim. A current successful Quality Core run remains required after final material integration. No membership, identity, order, other completion criterion, or release policy changes.

Durable record: `charness-artifacts/goal-runs/744/amendments/2026-08-30-ignore-mutation-test-proof.md` at provider-main commit `9c38ef7ae1524ecc0c01839cc176085d04cdfcac`.
...
<!-- charness-goal-run:v1
{
  ...
  "progress": {
    ...
    "next": {
      "key": "issue-758-mutation-main",
      "number": 758,
      "repo": "corca-ai/charness",
      "state": "OPEN",
      "url": "https://github.com/corca-ai/charness/issues/758"
    },
    "open": 13,
    "revision": 1,
