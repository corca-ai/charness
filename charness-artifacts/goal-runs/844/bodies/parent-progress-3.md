...
WI-1 (#845), WI-2 (#846), WI-3 (#847), WI-4 (#848), WI-8a (#852), WI-8b (#853), WI-10a (#855), and WI-10b (#856) are landed and verified closed. WI-7 self-review lane running (attempt 4, full activation scope; landing-trigger half deferred until WI-9 lands, routing via ledger plus injection, never pickup). WI-5 launch-hygiene lane running (attempt 2, stacked-base scope set from inspected evidence: `run_task` already honors `base`, DAG-only change). WI-11 deferred until WI-6/WI-7/WI-9 land (friction producers distributed across six modules; one informed scope). Open: #849 WI-5, #850 WI-6, #851 WI-7, #854 WI-9, #857 WI-11, #858 WI-12.
