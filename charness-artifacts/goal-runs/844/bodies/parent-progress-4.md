...
WI-1 (#845), WI-2 (#846), WI-3 (#847), WI-4 (#848), WI-5 (#849), WI-8a (#852), WI-8b (#853), WI-10a (#855), and WI-10b (#856) are landed and verified closed. WI-7 phase 1 (self-review) merged as d6f9211f3; #851 stays open for the landing-trigger half, now unblocked by WI-8a. WI-6 (#850) attempt 1 returned premise-BLOCKED with no change: the validated ledger exposes recurrence-class IDs and source-retro paths but no code-scope tags, so deterministic scope/tag matching needs an out-of-scope ledger change or a heuristic the brief forbids; operator amendment pending. WI-9 (#854) and WI-7-trigger lanes in exec. WI-11 (#857) deferred until WI-6 resolves (it consumes the prompt-assembly shape). Open: #850 WI-6, #851 WI-7, #854 WI-9, #857 WI-11, #858 WI-12.
...
<!-- charness-goal-run:v1
{
  ...
  "progress": {
    ...
    "next": {
      ...
      "repo": "corca-ai/charness",
      "number": 851,
      "url": "https://github.com/corca-ai/charness/issues/851",
      "state": "OPEN"
    }
  }
}
