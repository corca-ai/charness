# Retro: Release Auto-Retro Trigger v3.2.0
Date: 2026-08-04
Mode: release-trigger

## Context

Release publish triggered a configured automatic session retro for `v3.2.0`.
...
- Path hits: `skills/support/markdown-preview/scripts/markdown_preview_render.py`.
...
Persisted: yes: charness-artifacts/retro/2026-08-04-v3-2-0-release-auto-retro.md
