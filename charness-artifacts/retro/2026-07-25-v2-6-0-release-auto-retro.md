# Retro: Release Auto-Retro Trigger v2.6.0
Date: 2026-07-25
Mode: session

## Context

Release publish triggered a configured automatic session retro for `v2.6.0`.
...
- Path hits: `skills/public/release/scripts/check_real_host_proof.py`.
...
Persisted: yes: charness-artifacts/retro/2026-07-25-v2-6-0-release-auto-retro.md
