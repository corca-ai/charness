# Host Log Probe — goal 2026-06-10-342-343-adapter-schema-hook-lifecycle-deferred-proofs

Goal: charness-artifacts/goals/2026-06-10-342-343-adapter-schema-hook-lifecycle-deferred-proofs.md
Probe scope: thread-wide (no per-goal `Host metric window:` line exists on this Claude host); signals are thread-wide pressure, not a per-goal total.
