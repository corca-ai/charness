...
- **Generated**: 2026-07-18T13:43:03Z
- **Prepared for**: dead-code advisory signal and release readiness
...
- plugins/charness/scripts/prompt_mutation_bundle_lib.py
...
- scripts/prompt_mutation_bundle_lib.py
...
- checked-in-plugin-export: Checked-in plugin install surface and root marketplace artifacts derived from repo-owned source paths.
  source matches: scripts/prompt_mutation_bundle_lib.py, scripts/setup_agent_docs_lib.py, scripts/tool_recommendation_lib.py, skills/public/quality/scripts/run_dead_code_advisory.py
  derived matches: plugins/charness/scripts/prompt_mutation_bundle_lib.py, plugins/charness/scripts/setup_agent_docs_lib.py, plugins/charness/scripts/tool_recommendation_lib.py, plugins/charness/skills/quality/scripts/run_dead_code_advisory.py
...
- repo-markdown: Repo-owned markdown docs and generated markdown copies that need link, lint, and secret checks.
  source matches: charness-artifacts/quality/latest.md, charness-artifacts/critique/2026-07-18-133327-packet.md, charness-artifacts/critique/2026-07-18-dead-code-advisory-signal.md, charness-artifacts/quality/2026-07-18-autonomous-release-readiness.md
...
- critique-artifacts: Checked-in critique records and prepare packets for task-completing repo work.
  source matches: charness-artifacts/critique/2026-07-18-133327-packet.json, charness-artifacts/critique/2026-07-18-133327-packet.md, charness-artifacts/critique/2026-07-18-dead-code-advisory-signal.md
  verify: python3 scripts/validate_critique_artifacts.py --repo-root . --all
- integrations-and-control-plane: Integration manifests and control-plane helper scripts.
  derived matches: plugins/charness/scripts/prompt_mutation_bundle_lib.py, plugins/charness/scripts/setup_agent_docs_lib.py, plugins/charness/scripts/tool_recommendation_lib.py
...
- repo-python: Repo-owned Python code and tests.
  source matches: scripts/prompt_mutation_bundle_lib.py, scripts/setup_agent_docs_lib.py, scripts/tool_recommendation_lib.py, tests/quality_gates/test_quality_dead_code_advisory.py
  derived matches: plugins/charness/scripts/prompt_mutation_bundle_lib.py, plugins/charness/scripts/setup_agent_docs_lib.py, plugins/charness/scripts/tool_recommendation_lib.py
