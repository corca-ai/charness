# Retro: Release Auto-Retro Trigger v5.1.0
Date: 2026-08-12
Mode: release-trigger

## Context

Release publish triggered a configured automatic session retro for `v5.1.0`.
...
- Path hits: `skills/public/release/scripts/publish_release_artifact.py`, `skills/public/release/scripts/publish_release_artifact_sections.py`, `skills/public/release/scripts/publish_release_claims_review.py`, `skills/public/release/scripts/publish_release_cli.py`, `skills/public/release/scripts/publish_release_execute.py`, `skills/public/release/scripts/publish_release_resume.py`, `skills/public/release/scripts/publish_release_resume_closeout.py`, `skills/public/release/scripts/publish_release_resume_publish.py`.
...
Persisted: yes: charness-artifacts/retro/2026-08-12-v5-1-0-release-auto-retro.md
