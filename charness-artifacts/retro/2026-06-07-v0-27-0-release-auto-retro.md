# Retro: Release Auto-Retro Trigger v0.27.0
Date: 2026-06-07
Mode: session

## Context

Release publish triggered a configured automatic session retro for `v0.27.0`.
...
- Path hits: `skills/public/find-skills/references/discovery-order.md`, `skills/public/find-skills/scripts/list_capabilities.py`, `skills/public/find-skills/scripts/list_capabilities_lib.py`.
...
Persisted: yes `charness-artifacts/retro/2026-06-07-v0-27-0-release-auto-retro.md`
