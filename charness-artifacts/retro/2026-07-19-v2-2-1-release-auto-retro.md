# Retro: Release Auto-Retro Trigger v2.2.1
Date: 2026-07-19
Mode: session

## Context

Release publish triggered a configured automatic session retro for `v2.2.1`.
...
- Path hits: `skills/public/release/scripts/publish_release_cli.py`, `skills/public/release/scripts/publish_release_runtime.py`.
...
Persisted: yes: charness-artifacts/retro/2026-07-19-v2-2-1-release-auto-retro.md
