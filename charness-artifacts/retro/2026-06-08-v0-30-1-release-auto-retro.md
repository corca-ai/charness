# Retro: Release Auto-Retro Trigger v0.30.1
Date: 2026-06-08
Mode: session

## Context

Release publish triggered a configured automatic session retro for `v0.30.1`.
...
- Path hits: `skills/public/release/SKILL.md`, `skills/public/release/references/install-surface.md`, `skills/public/release/scripts/publish_release_cli.py`, `skills/public/release/scripts/publish_release_post_create.py`, `skills/public/release/scripts/publish_release_resume.py`, `skills/public/release/scripts/resolve_adapter.py`.
...
Persisted: yes `charness-artifacts/retro/2026-06-08-v0-30-1-release-auto-retro.md`
