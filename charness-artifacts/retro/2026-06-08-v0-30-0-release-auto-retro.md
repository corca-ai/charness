# Retro: Release Auto-Retro Trigger v0.30.0
Date: 2026-06-08
Mode: session

## Context

Release publish triggered a configured automatic session retro for `v0.30.0`.
...
- Path hits: `skills/public/release/references/closeout-critique-gate.md`, `skills/public/release/scripts/publish_release_cli.py`, `skills/public/release/scripts/publish_release_preflight.py`.
...
Persisted: yes `charness-artifacts/retro/2026-06-08-v0-30-0-release-auto-retro.md`
