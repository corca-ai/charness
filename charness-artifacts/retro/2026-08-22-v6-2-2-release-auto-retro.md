# Retro: Release Auto-Retro Trigger v6.2.2
Date: 2026-08-22
Mode: release-trigger

## Context

Release publish triggered a configured automatic session retro for `v6.2.2`.
...
Persisted: yes: charness-artifacts/retro/2026-08-22-v6-2-2-release-auto-retro.md
