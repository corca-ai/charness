# Retro: Release Auto-Retro Trigger v3.1.1
Date: 2026-08-03
Mode: release-trigger

## Context

Release publish triggered a configured automatic session retro for `v3.1.1`.
...
Persisted: yes: charness-artifacts/retro/2026-08-03-v3-1-1-release-auto-retro.md
