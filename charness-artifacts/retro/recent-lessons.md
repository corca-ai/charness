...
- slice 1 (`b92dd9f9`, `Close #319`): a changed-file-scoped commit-boundary **ratchet** for the SKILL.md `core_nonempty` ≥4 headroom buffer; (source: `charness-artifacts/retro/2026-06-06-318-319-closeout.md`)
