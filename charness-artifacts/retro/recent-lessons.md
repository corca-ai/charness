...
- **memory:** Fold "delayed/batched tool delivery ≠ outage; do not flush-flood; one probe then wait-or-stop; erroring call cancels its parallel batch" into `recent-lessons.md` so the next session does not relearn it. (source: `charness-artifacts/retro/2026-05-30-258-staged-reversion-echo-flood.md`)
