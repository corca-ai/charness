# Retro: Release Auto-Retro Trigger v2.3.1
Date: 2026-07-20
Mode: session

## Context

Release publish triggered a configured automatic session retro for `v2.3.1`.
...
- Path hits: `scripts/capability_catalog_resolver.py`, `skills/public/release/scripts/publish_release_runtime.py`.
...
Persisted: yes: charness-artifacts/retro/2026-07-20-v2-3-1-release-auto-retro.md
