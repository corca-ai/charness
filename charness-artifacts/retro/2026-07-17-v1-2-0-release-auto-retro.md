# Retro: Release Auto-Retro Trigger v1.2.0
Date: 2026-07-17
Mode: session

## Context

Release publish triggered a configured automatic session retro for `v1.2.0`.
...
- Path hits: `skills/public/release/references/publication-boundary.md`.
...
Persisted: yes: charness-artifacts/retro/2026-07-17-v1-2-0-release-auto-retro.md
