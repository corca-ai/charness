# Retro: Release Auto-Retro Trigger v6.4.0
Date: 2026-08-23
Mode: release-trigger

## Context

Release publish triggered a configured automatic session retro for `v6.4.0`.
...
- Path hits: `skills/public/release/scripts/plan_release_run.py`.
...
Persisted: yes: charness-artifacts/retro/2026-08-23-v6-4-0-release-auto-retro.md
