# Retro: Release Auto-Retro Trigger v2.11.3
Date: 2026-07-27
Mode: release-trigger

## Context

Release publish triggered a configured automatic session retro for `v2.11.3`.
...
- Path hits: `skills/public/release/scripts/publish_release.py`.
...
Persisted: yes: charness-artifacts/retro/2026-07-27-v2-11-3-release-auto-retro.md
