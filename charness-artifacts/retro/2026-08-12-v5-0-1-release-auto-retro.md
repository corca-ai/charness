# Retro: Release Auto-Retro Trigger v5.0.1
Date: 2026-08-12
Mode: release-trigger

## Context

Release publish triggered a configured automatic session retro for `v5.0.1`.
...
Persisted: yes: charness-artifacts/retro/2026-08-12-v5-0-1-release-auto-retro.md
