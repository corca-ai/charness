# Retro: Release Auto-Retro Trigger v2.2.0
Date: 2026-07-19
Mode: session

## Context

Release publish triggered a configured automatic session retro for `v2.2.0`.
...
- Path hits: `skills/public/release/scripts/publish_release_helpers.py`, `skills/public/release/scripts/publish_release_resume.py`, `skills/public/release/scripts/release_tag_identity.py`.
...
Persisted: yes: charness-artifacts/retro/2026-07-19-v2-2-0-release-auto-retro.md
