# Retro: Release Auto-Retro Trigger v0.61.0
Date: 2026-07-04
Mode: session

## Context

Release publish triggered a configured automatic session retro for `v0.61.0`.
...
- Path hits: `skills/public/find-skills/SKILL.md`, `skills/public/find-skills/references/session-start-routing.md`.
...
Persisted: yes: charness-artifacts/retro/2026-07-04-v0-61-0-release-auto-retro.md
