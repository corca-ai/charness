# Retro: Release Auto-Retro Trigger v4.2.0
Date: 2026-08-09
Mode: release-trigger

## Context

Release publish triggered a configured automatic session retro for `v4.2.0`.
...
- Path hits: `skills/public/release/scripts/publish_release_cli.py`, `skills/public/release/scripts/release_issue_closeout_message.py`.
...
Persisted: yes: charness-artifacts/retro/2026-08-09-v4-2-0-release-auto-retro.md
