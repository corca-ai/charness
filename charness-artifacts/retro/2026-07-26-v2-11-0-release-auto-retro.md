...
Release publish triggered a configured automatic session retro for `v2.11.0`.
...
Persisted: yes: charness-artifacts/retro/2026-07-26-v2-11-0-release-auto-retro.md
