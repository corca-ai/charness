# Retro: Release Auto-Retro Trigger v0.17.0
Date: 2026-06-03
Mode: session

## Context

Release publish triggered a configured automatic session retro for `v0.17.0`.
...
- Path hits: `skills/public/find-skills/scripts/list_capabilities.py`, `skills/public/find-skills/scripts/public_skill_recommendations.py`.
...
Persisted: yes `charness-artifacts/retro/2026-06-03-v0-17-0-release-auto-retro.md`
