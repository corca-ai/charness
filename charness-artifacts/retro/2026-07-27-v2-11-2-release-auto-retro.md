# Retro: Release Auto-Retro Trigger v2.11.2
Date: 2026-07-27
Mode: release-trigger

## Context

Release publish triggered a configured automatic session retro for `v2.11.2`.
...
Persisted: yes: charness-artifacts/retro/2026-07-27-v2-11-2-release-auto-retro.md
