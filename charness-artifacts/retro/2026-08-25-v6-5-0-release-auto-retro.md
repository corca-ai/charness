# Retro: Release Auto-Retro Trigger v6.5.0
Date: 2026-08-25
Mode: release-trigger

## Context

Release publish triggered a configured automatic session retro for `v6.5.0`.
...
Persisted: yes: charness-artifacts/retro/2026-08-25-v6-5-0-release-auto-retro.md
