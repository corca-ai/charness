# Retro: Release Auto-Retro Trigger v2.1.0
Date: 2026-07-18
Mode: session

## Context

Release publish triggered a configured automatic session retro for `v2.1.0`.
...
- Path hits: `scripts/capability_catalog.py`, `skills/public/release/SKILL.md`, `skills/public/release/references/index.md`, `skills/public/release/scripts/plan_release_run.py`, `skills/public/release/scripts/publish_release_post_create.py`.
...
Persisted: yes: charness-artifacts/retro/2026-07-18-v2-1-0-release-auto-retro.md
