# Retro: Release Auto-Retro Trigger v3.3.0
Date: 2026-08-06
Mode: release-trigger

## Context

Release publish triggered a configured automatic session retro for `v3.3.0`.
...
- Path hits: `skills/support/web-fetch/scripts/acquire_public_url.py`, `skills/support/web-fetch/scripts/acquire_public_url_io.py`, `skills/support/web-fetch/scripts/classify_fetch_response.py`, `skills/support/web-fetch/scripts/markdown_negotiation_stage.py`, `skills/support/web-fetch/scripts/route_public_fetch.py`, `skills/support/web-fetch/scripts/route_stage_catalog.py`.
...
Persisted: yes: charness-artifacts/retro/2026-08-06-v3-3-0-release-auto-retro.md
