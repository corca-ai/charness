# Retro: Release Auto-Retro Trigger v0.56.6
Date: 2026-06-27
Mode: session

## Context

Release publish triggered a configured automatic session retro for `v0.56.6`.
...
- Path hits: `skills/support/gather-notion/SKILL.md`, `skills/support/gather-notion/references/provenance.md`, `skills/support/gather-slack/SKILL.md`, `skills/support/gather-slack/references/provenance.md`, `skills/support/markdown-preview/SKILL.md`, `skills/support/web-fetch/SKILL.md`.
...
Persisted: yes: charness-artifacts/retro/2026-06-27-v0-56-6-release-auto-retro.md
