# Retro: Release Auto-Retro Trigger v0.33.0
Date: 2026-06-09
Mode: session

## Context

Release publish triggered a configured automatic session retro for `v0.33.0`.
...
- Path hits: `skills/public/find-skills/scripts/capability_sources.py`, `skills/public/find-skills/scripts/list_capabilities.py`, `skills/public/find-skills/scripts/list_capabilities_lib.py`.
...
Persisted: yes `charness-artifacts/retro/2026-06-09-v0-33-0-release-auto-retro.md`
