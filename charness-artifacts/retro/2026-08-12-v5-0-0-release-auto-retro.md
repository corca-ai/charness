# Retro: Release Auto-Retro Trigger v5.0.0
Date: 2026-08-12
Mode: release-trigger

## Context

Release publish triggered a configured automatic session retro for `v5.0.0`.
...
- Path hits: `skills/public/release/scripts/release_issue_closeout.py`.
...
Persisted: yes: charness-artifacts/retro/2026-08-12-v5-0-0-release-auto-retro.md
