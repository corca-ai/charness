# Retro: Release Auto-Retro Trigger v6.0.1
Date: 2026-08-17
Mode: release-trigger

## Context

Release publish triggered a configured automatic session retro for `v6.0.1`.
...
Persisted: yes: charness-artifacts/retro/2026-08-17-v6-0-1-release-auto-retro.md
