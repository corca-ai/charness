# Retro: Release Auto-Retro Trigger v4.1.0
Date: 2026-08-09
Mode: release-trigger

## Context

Release publish triggered a configured automatic session retro for `v4.1.0`.
...
- Path hits: `scripts/capability_catalog_sources.py`.
...
Persisted: yes: charness-artifacts/retro/2026-08-09-v4-1-0-release-auto-retro.md
