# Retro: Release Auto-Retro Trigger v3.4.0
Date: 2026-08-06
Mode: release-trigger

## Context

Release publish triggered a configured automatic session retro for `v3.4.0`.
...
Persisted: yes: charness-artifacts/retro/2026-08-06-v3-4-0-release-auto-retro.md
