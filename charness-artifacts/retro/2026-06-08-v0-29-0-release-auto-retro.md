# Retro: Release Auto-Retro Trigger v0.29.0
Date: 2026-06-08
Mode: session

## Context

Release publish triggered a configured automatic session retro for `v0.29.0`.
...
- Path hits: `docs/host-packaging.md`, `skills/public/release/SKILL.md`, `skills/public/release/references/install-surface.md`.
...
Persisted: yes `charness-artifacts/retro/2026-06-08-v0-29-0-release-auto-retro.md`
