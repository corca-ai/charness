# Retro: Release Auto-Retro Trigger v4.0.0
Date: 2026-08-08
Mode: release-trigger

## Context

Release publish triggered a configured automatic session retro for `v4.0.0`.
...
- Path hits: `README.md`, `skills/public/release/references/adapter-contract.md`, `skills/public/release/scripts/publish_release_helpers.py`, `skills/public/release/scripts/release_issue_closeout_message.py`.
...
Persisted: yes: charness-artifacts/retro/2026-08-08-v4-0-0-release-auto-retro.md
