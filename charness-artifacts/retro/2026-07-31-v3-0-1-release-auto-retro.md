# Retro: Release Auto-Retro Trigger v3.0.1
Date: 2026-07-31
Mode: release-trigger

## Context

Release publish triggered a configured automatic session retro for `v3.0.1`.
...
Persisted: yes: charness-artifacts/retro/2026-07-31-v3-0-1-release-auto-retro.md
