...
- runtime source: structured metrics from `.charness/quality/runtime-signals.json` <!-- reproduction-source -->
  rendered by
  [render_runtime_summary.py](../../../skills/public/quality/scripts/render_runtime_summary.py)
  and recorded by [record_quality_runtime.py](../../../scripts/record_quality_runtime.py).
...
- [run_slice_closeout.py](../../../scripts/run_slice_closeout.py) remains in the advisory length band at 465
  Python code lines.
...
- [2026-06-11 quality review](./2026-06-11-quality-review.md)
