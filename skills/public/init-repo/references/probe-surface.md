...
This is not a demand for giant command taxonomies or mandatory `INSTALL.md`
...
- keep the repo story and high-level pointer in `README.md`
- put the fuller install and probe semantics in `INSTALL.md` when the repo
  genuinely needs one
- keep `docs/operator-acceptance.md` focused on takeover and acceptance, not as
...
- duplicating conflicting install or probe guidance across `README.md` and
  `INSTALL.md`
