...
| --- | --- |
| `ideation` | own concept shape and direction-level uncertainty, including whether and how reality contact is needed |
| `spec` | turn the settled or honestly dispositioned concept into a contract and keep mechanism uncertainty as a `Probe Question` |
