...
QUALITY_UNESTABLISHED_STATUS = "quality unestablished: no observed quality receipt/status"
...
def write_release_artifact(
    ...
    *,
    ...
    prepush_quality_receipt: str | None = None,
    prepush_quality_receipt_sha256: str | None = None,
    ...
    lines = [
        ...
        *(
            [
                f"- pre-push quality receipt: `{prepush_quality_receipt}` "
...
def write_current_artifact(
    ...
    *,
    ...
    quality_status = quality_status or payload.get("quality_status") or QUALITY_UNESTABLISHED_STATUS
    return write_release_artifact(
        ...
        prepush_quality_receipt=payload.get("prepush_quality_receipt"),
        prepush_quality_receipt_sha256=payload.get("prepush_quality_receipt_sha256"),
