...
def _is_dated_narrative(path: str) -> bool:
    ...
    the repo:
      ...
      `charness-artifacts/retro/recent-lessons.md` -- the rolling digest CLAUDE.md
          requires reading before any contract change, regenerated by
          `refresh_recent_lessons`.
