...
4. adapter-configured official skill roots
...
- external integrations may require install/update/doctor flows that are not yet
  active
- official skill roots are host-trusted extension surfaces, not local product
  ownership

When more than one match exists:

- prefer the most direct public concept
- prefer local public skills over official-root skills unless the host adapter
  says otherwise
