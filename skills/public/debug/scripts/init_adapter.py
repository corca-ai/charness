...
def main() -> None:
    ...
    run_init_adapter(default_output=Path(".agents/debug-adapter.yaml"), build_items=lambda repo_name, _args: base_adapter_items(repo_name, "charness-artifacts/debug"))
