#!/usr/bin/env python3
"""Layout-independent entrypoint for `<authoring-repo>/scripts/check_title_slug_drift.py` (#478 sites 1 and 2).

Reachable as `$SKILL_DIR/../../shared/scripts/check_title_slug_drift.py` from any skill package, in
