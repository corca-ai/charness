...
def parser() -> argparse.ArgumentParser:
    ...
    result.add_argument("--parent-lesson-bundle", type=Path)
    result.add_argument("--lesson-session-id")
    result.add_argument("--lesson-lane-id")
    result.add_argument("--lesson-owner-id")
    result.add_argument("--lesson-lane-receipt", type=Path)
