...
- if agents run bounded repo work, prefer one direct execution command and one
  status view over a claim/submit/review state machine; add scheduler lifecycle
  only when an actual scheduler consumes it
