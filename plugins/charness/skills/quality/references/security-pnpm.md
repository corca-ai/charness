...
[`scripts/check_supply_chain.py`](../../../../scripts/check_supply_chain.py) enforces the root-level alignment piece. It is
...
- run pnpm's audit flow only where the team is prepared to triage advisory
  output; [`scripts/check_supply_chain_online.py`](../../../../scripts/check_supply_chain_online.py) now wraps that path
