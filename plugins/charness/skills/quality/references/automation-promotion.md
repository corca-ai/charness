...
- a broken markdown link already caught by [`check-doc-links.py`](../../../../scripts/check-doc-links.py)
- a backtick-wrapped file reference that would silently rot on rename, already
  caught by the same [`check-doc-links.py`](../../../../scripts/check-doc-links.py) rule that rejects path-like
...
- malformed skill frontmatter already caught by [`validate-skills.py`](../../../../scripts/validate-skills.py)
