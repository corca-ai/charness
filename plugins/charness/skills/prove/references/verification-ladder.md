...
installed skill metadata/model judgment before improvising local search or stopping at tests; consult `charness catalog list --repo-root .` only for hidden availability.
