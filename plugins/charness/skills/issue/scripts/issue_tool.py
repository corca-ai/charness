...
def build_parser() -> argparse.ArgumentParser:
    ...
    preflight.add_argument("--repo-root", type=Path, default=cwd_default, help="Repository root used to resolve the issue adapter")
    preflight.set_defaults(func=command_preflight)

    target = subparsers.add_parser("resolve-target")
    target.add_argument("--repo-root", type=Path, default=cwd_default, help="Repository root used to resolve the issue adapter")
    ...
    invocation.add_argument("--repo-root", type=Path, default=cwd_default, help="Repository root used to resolve the issue adapter")
    ...
    select.add_argument("--repo-root", type=Path, default=cwd_default, help="Repository root used to resolve the issue adapter")
    ...
    close.add_argument("--repo-root", type=Path, default=cwd_default, help="Repository root used to resolve the issue adapter")
    ...
    verify.add_argument("--repo-root", type=Path, default=cwd_default, help="Repository root used to resolve the issue adapter")
    ...
    brief.add_argument("--repo-root", type=Path, default=cwd_default, help="Repository root used to resolve the issue adapter")
