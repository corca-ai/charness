...
SCENARIOS = (
    ...
    Scenario("setup-compact-skill-routing-discoverability", "setup compact routing makes startup find-skills bootstrap explicit without copying a long skill catalog"),
